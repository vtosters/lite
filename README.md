...
* О найденных багах приложения следует сообщать в [Issues](https://github.com/vtosters/lite/issues)
<sup><sub>(просьба не плодить дубликаты, воспользуйтесь **поиском** перед созданием нового issue)</sub></sup>
...
Сразу после нажатия на запись приложение начнет записывать **все ваши действия** по пути `/VK/logs/com.vtosters.lite`
