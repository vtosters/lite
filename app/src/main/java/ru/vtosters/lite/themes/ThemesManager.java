...
public class ThemesManager {
    ...
    private final static int[] ACCENT_COLORS = {
            ...
            R.color.black_blue45_alpha10,
            R.color.music_check_button_bg_checked,
            R.color.vk_black_blue45_alpha10,
            R.color.black_blue30_alpha66,
            R.color.vk_black_blue30_alpha66,
            R.color.attachpicker_item_background,
            R.color.black_blue24_alpha8,
            R.color.music_placeholder_artist_bg,
            R.color.black_blue24_alpha24,
            R.color.vk_black_blue24_alpha24,
