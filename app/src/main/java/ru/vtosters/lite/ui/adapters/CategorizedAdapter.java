...
public class CategorizedAdapter< T > extends RecyclerView.Adapter< CategorizedAdapter.CategorizedViewHolder > implements IItemMovingListener {
    ...
    private View newMovingItem() {
        var container = new LinearLayout(getGlobalContext());
        ...
        container.setLayoutParams(LayoutUtils.createLinear(-1, dp2px(48)));
        container.setVisibility(View.INVISIBLE);

        var icon = new ImageView(getGlobalContext());
        ...
        var name = new TextView(getGlobalContext());
    ...
    private View newCategoryTitle() {
        ...
        var title = new TextView(getGlobalContext());
