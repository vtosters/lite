...
public abstract class IMProcessor {
    ...
    @NonNull
    protected abstract String encodeInternal(@NonNull String source, @Nullable byte[] key);

    @NonNull
    protected abstract String decodeInternal(@NonNull String source, @Nullable byte[] key);
