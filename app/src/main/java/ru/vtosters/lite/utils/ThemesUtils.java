...
public class ThemesUtils {
    // temporary added colors with prefix "ff" for testing
    public static List<Integer> accentColors = Arrays.asList(
            Color.parseColor("#2688eb"),
            Color.parseColor("#ff2688eb"),
            Color.parseColor("#529ef4"),
            Color.parseColor("#ff529ef4"),
            Color.parseColor("#2d81e0"),
            Color.parseColor("#ff2d81e0"),
            Color.parseColor("#2975cc"),
            Color.parseColor("#ff2975cc"),
            Color.parseColor("#3f8ae0"),
            Color.parseColor("#ff3f8ae0"),
            Color.parseColor("#5692d7"),
            Color.parseColor("#ff5692d7"),
            Color.parseColor("#528bcc"),
            Color.parseColor("#ff528bcc"),
            Color.parseColor("#7aa0cc"),
            Color.parseColor("#ff7aa0cc"),
            Color.parseColor("#518bcc"),
            Color.parseColor("#ff518bcc"),
            Color.parseColor("#6296d0"),
            Color.parseColor("#ff6296d0"),
            Color.parseColor("#2f68aa"),
            Color.parseColor("#ff2f68aa"),
            Color.parseColor("#638ebf"),
            Color.parseColor("#ff638ebf"),
            Color.parseColor("#5181b8"),
            Color.parseColor("#ff5181b8"),
            Color.parseColor("#71aaeb"),
            Color.parseColor("#ff71aaeb"),
            Color.parseColor("#4774a8"),
            Color.parseColor("#ff4774a8"),
            Color.parseColor("#5baaf4"),
            Color.parseColor("#ff5baaf4"),
            Color.parseColor("#4186c8"),
            Color.parseColor("#ff4186c8"),
            Color.parseColor("#add3ff"),
            Color.parseColor("#ffadd3ff"),
            Color.parseColor("#718198"),
            Color.parseColor("#ff718198"),
            Color.parseColor("#5a9eff"),
            Color.parseColor("#ff5a9eff"),
            Color.parseColor("#99a2ad"),
            Color.parseColor("#ff99a2ad"),
            Color.parseColor("#74a2d6"),
            Color.parseColor("#ff74a2d6"),
            Color.parseColor("#e9eef3"),
            Color.parseColor("#ffe9eef3"),
            Color.parseColor("#dfe3e7"),
            Color.parseColor("#ffdfe3e7"),
            Color.parseColor("#eff1f3"),
            Color.parseColor("#ffeff1f3"),
            Color.parseColor("#5c9ce6"),
            Color.parseColor("#ff5c9ce6"),
            Color.parseColor("#4986cc"),
            Color.parseColor("#ff4986cc"),
            Color.parseColor("#4680c2"),
            Color.parseColor("#ff4680c2")
    );
