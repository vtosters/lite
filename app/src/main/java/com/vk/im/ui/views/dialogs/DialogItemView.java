...
public final class DialogItemView extends ViewGroup {
    ...
    public DialogItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f15757J = obtainStyledAttributes.getDimensionPixelSize(o.DialogItemView_vkim_avatar_size, Screen.a(64));
        obtainStyledAttributes.recycle();
        this.K = new AvatarView(context, null, 6);
        this.K.setViewSize(this.f15757J);
    ...
    public final void setHasStories(boolean z) {
        ...
        if (z) {
            ...
            this.K.setViewSize(this.f15757J - (borderWidth * 2));
