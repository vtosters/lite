...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v7/widget/GapWorker$a;,
        Landroid/support/v7/widget/GapWorker$b;
    }
.end annotation
...
.method private a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$x;
    ...
    .line 281
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/RecyclerView$p;
    ...
    .line 289
    invoke-virtual {p2}, Landroid/support/v7/widget/RecyclerView$x;->q()Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-virtual {p2}, Landroid/support/v7/widget/RecyclerView$x;->o()Z
...
.method private a()V
    ...
    .line 217
    iget-object v4, p0, Landroid/support/v7/widget/GapWorker;->b:Ljava/util/ArrayList;
    ...
    .line 219
    iget-object v5, v4, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/GapWorker$a;

    invoke-virtual {v5, v4, v1}, Landroid/support/v7/widget/GapWorker$a;->a(Landroid/support/v7/widget/RecyclerView;Z)V

    .line 220
    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/GapWorker$a;

    iget v4, v4, Landroid/support/v7/widget/GapWorker$a;->d:I
    ...
    .line 235
    iget v6, v5, Landroid/support/v7/widget/GapWorker$a;->a:I

    invoke-static {v6}, Ljava/lang/Math;->abs(I)I

    move-result v6

    iget v7, v5, Landroid/support/v7/widget/GapWorker$a;->b:I
    ...
    .line 237
    :goto_2
    iget v8, v5, Landroid/support/v7/widget/GapWorker$a;->d:I
    ...
    .line 239
    iget-object v8, p0, Landroid/support/v7/widget/GapWorker;->f:Ljava/util/ArrayList;
    ...
    .line 240
    new-instance v8, Landroid/support/v7/widget/GapWorker$b;

    invoke-direct {v8}, Landroid/support/v7/widget/GapWorker$b;-><init>()V

    .line 241
    iget-object v9, p0, Landroid/support/v7/widget/GapWorker;->f:Ljava/util/ArrayList;
    ...
    check-cast v8, Landroid/support/v7/widget/GapWorker$b;

    .line 245
    :goto_3
    iget-object v9, v5, Landroid/support/v7/widget/GapWorker$a;->c:[I
    ...
    .line 247
    :goto_4
    iput-boolean v10, v8, Landroid/support/v7/widget/GapWorker$b;->a:Z

    .line 248
    iput v6, v8, Landroid/support/v7/widget/GapWorker$b;->b:I

    .line 249
    iput v9, v8, Landroid/support/v7/widget/GapWorker$b;->c:I

    .line 250
    iput-object v4, v8, Landroid/support/v7/widget/GapWorker$b;->d:Landroid/support/v7/widget/RecyclerView;
    ...
    iput v9, v8, Landroid/support/v7/widget/GapWorker$b;->e:I
...
.method private a(Landroid/support/v7/widget/GapWorker$b;J)V
    .locals 3

    .line 341
    iget-boolean v0, p1, Landroid/support/v7/widget/GapWorker$b;->a:Z
    ...
    .line 342
    :goto_0
    iget-object v2, p1, Landroid/support/v7/widget/GapWorker$b;->d:Landroid/support/v7/widget/RecyclerView;

    iget p1, p1, Landroid/support/v7/widget/GapWorker$b;->e:I

    invoke-direct {p0, v2, p1, v0, v1}, Landroid/support/v7/widget/GapWorker;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$x;
    ...
    .line 344
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$x;->b:Ljava/lang/ref/WeakReference;
    ...
    .line 348
    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView$x;->b:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/GapWorker;->a(Landroid/support/v7/widget/RecyclerView;J)V
...
.method private a(Landroid/support/v7/widget/RecyclerView;J)V
    ...
    .line 321
    :cond_1
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/GapWorker$a;

    const/4 v1, 0x1

    .line 322
    invoke-virtual {v0, p1, v1}, Landroid/support/v7/widget/GapWorker$a;->a(Landroid/support/v7/widget/RecyclerView;Z)V

    .line 324
    iget v1, v0, Landroid/support/v7/widget/GapWorker$a;->d:I
    ...
    .line 326
    invoke-static {v1}, Landroid/support/v4/os/TraceCompat;->a(Ljava/lang/String;)V

    .line 327
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->C:Landroid/support/v7/widget/RecyclerView$u;
    ...
    .line 328
    :goto_0
    iget v2, v0, Landroid/support/v7/widget/GapWorker$a;->d:I
    ...
    .line 331
    iget-object v2, v0, Landroid/support/v7/widget/GapWorker$a;->c:[I

    aget v2, v2, v1

    .line 332
    invoke-direct {p0, p1, v2, p2, p3}, Landroid/support/v7/widget/GapWorker;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$x;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private b(J)V
    ...
    check-cast v1, Landroid/support/v7/widget/GapWorker$b;

    .line 355
    iget-object v2, v1, Landroid/support/v7/widget/GapWorker$b;->d:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 358
    :cond_0
    invoke-direct {p0, v1, p1, p2}, Landroid/support/v7/widget/GapWorker;->a(Landroid/support/v7/widget/GapWorker$b;J)V

    .line 359
    invoke-virtual {v1}, Landroid/support/v7/widget/GapWorker$b;->a()V
...
.method a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 184
    :cond_0
    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView;->B:Landroid/support/v7/widget/GapWorker$a;

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/GapWorker$a;->a(II)V
...
.method public run()V
    ...
    .line 383
    iget-object v6, p0, Landroid/support/v7/widget/GapWorker;->b:Ljava/util/ArrayList;
    ...
    .line 396
    invoke-virtual {p0, v6, v7}, Landroid/support/v7/widget/GapWorker;->a(J)V
    :try_end_2
