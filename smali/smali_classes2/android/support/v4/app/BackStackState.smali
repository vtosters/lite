...
.method public constructor <init>(Landroid/support/v4/app/BackStackRecord;)V
    ...
    .line 56
    iget-object v3, p1, Landroid/support/v4/app/BackStackRecord;->b:Ljava/util/ArrayList;
    ...
    iget v6, v3, Landroid/support/v4/app/BackStackRecord$a;->a:I
    ...
    iget-object v6, v3, Landroid/support/v4/app/BackStackRecord$a;->b:Landroid/support/v4/app/Fragment;
    ...
    iget v6, v3, Landroid/support/v4/app/BackStackRecord$a;->c:I
    ...
    iget v6, v3, Landroid/support/v4/app/BackStackRecord$a;->d:I
    ...
    iget v6, v3, Landroid/support/v4/app/BackStackRecord$a;->e:I
    ...
    iget v3, v3, Landroid/support/v4/app/BackStackRecord$a;->f:I
    ...
    .line 74
    iget-boolean p1, p1, Landroid/support/v4/app/BackStackRecord;->t:Z
...
# virtual methods
.method public a(Landroid/support/v4/app/FragmentManager1;)Landroid/support/v4/app/BackStackRecord;
    .locals 7

    .line 93
    new-instance v0, Landroid/support/v4/app/BackStackRecord;

    invoke-direct {v0, p1}, Landroid/support/v4/app/BackStackRecord;-><init>(Landroid/support/v4/app/FragmentManager1;)V
    ...
    invoke-direct {v3}, Landroid/support/v4/app/BackStackRecord$a;-><init>()V
    ...
    iput v1, v3, Landroid/support/v4/app/BackStackRecord$a;->a:I
    ...
    .line 103
    iget-object v5, p1, Landroid/support/v4/app/FragmentManager1;->f:Landroid/util/SparseArray;
    ...
    .line 104
    iput-object v1, v3, Landroid/support/v4/app/BackStackRecord$a;->b:Landroid/support/v4/app/Fragment;
    ...
    iput v1, v3, Landroid/support/v4/app/BackStackRecord$a;->c:I
    ...
    iput v1, v3, Landroid/support/v4/app/BackStackRecord$a;->d:I
    ...
    iput v1, v3, Landroid/support/v4/app/BackStackRecord$a;->e:I
    ...
    iput v1, v3, Landroid/support/v4/app/BackStackRecord$a;->f:I

    .line 112
    iget v1, v3, Landroid/support/v4/app/BackStackRecord$a;->c:I

    iput v1, v0, Landroid/support/v4/app/BackStackRecord;->c:I

    .line 113
    iget v1, v3, Landroid/support/v4/app/BackStackRecord$a;->d:I

    iput v1, v0, Landroid/support/v4/app/BackStackRecord;->d:I

    .line 114
    iget v1, v3, Landroid/support/v4/app/BackStackRecord$a;->e:I

    iput v1, v0, Landroid/support/v4/app/BackStackRecord;->e:I

    .line 115
    iget v1, v3, Landroid/support/v4/app/BackStackRecord$a;->f:I

    iput v1, v0, Landroid/support/v4/app/BackStackRecord;->f:I

    .line 116
    invoke-virtual {v0, v3}, Landroid/support/v4/app/BackStackRecord;->a(Landroid/support/v4/app/BackStackRecord$a;)V
    ...
    iput p1, v0, Landroid/support/v4/app/BackStackRecord;->g:I

    .line 120
    iget p1, p0, Landroid/support/v4/app/BackStackState;->c:I

    iput p1, v0, Landroid/support/v4/app/BackStackRecord;->h:I

    .line 121
    iget-object p1, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object p1, v0, Landroid/support/v4/app/BackStackRecord;->k:Ljava/lang/String;

    .line 122
    iget p1, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput p1, v0, Landroid/support/v4/app/BackStackRecord;->m:I

    const/4 p1, 0x1

    .line 123
    iput-boolean p1, v0, Landroid/support/v4/app/BackStackRecord;->i:Z

    .line 124
    iget v1, p0, Landroid/support/v4/app/BackStackState;->f:I

    iput v1, v0, Landroid/support/v4/app/BackStackRecord;->n:I

    .line 125
    iget-object v1, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iput-object v1, v0, Landroid/support/v4/app/BackStackRecord;->o:Ljava/lang/CharSequence;

    .line 126
    iget v1, p0, Landroid/support/v4/app/BackStackState;->h:I

    iput v1, v0, Landroid/support/v4/app/BackStackRecord;->p:I

    .line 127
    iget-object v1, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iput-object v1, v0, Landroid/support/v4/app/BackStackRecord;->q:Ljava/lang/CharSequence;

    .line 128
    iget-object v1, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iput-object v1, v0, Landroid/support/v4/app/BackStackRecord;->r:Ljava/util/ArrayList;

    .line 129
    iget-object v1, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    iput-object v1, v0, Landroid/support/v4/app/BackStackRecord;->s:Ljava/util/ArrayList;

    .line 130
    iget-boolean v1, p0, Landroid/support/v4/app/BackStackState;->l:Z

    iput-boolean v1, v0, Landroid/support/v4/app/BackStackRecord;->t:Z
