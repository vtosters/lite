...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lb/h/f/b/a$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lb/h/f/b/a$a;-><init>(Lkotlin/jvm/internal/i;)V
...
.method public static final synthetic a(Lb/h/f/b/a;Ljava/lang/String;IZ)Lc/a/m;
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lb/h/f/b/a;->a(Ljava/lang/String;IZ)Lc/a/m;
...
.method private final a(Ljava/lang/String;IZ)Lc/a/m;
    .locals 2
    ...
    invoke-direct {v0, p1, p2, v1}, Lcom/vk/api/users/j;-><init>(Ljava/lang/String;II)V
    ...
    .line 10
    new-instance v0, Lb/h/f/b/a$g;

    invoke-direct {v0, p0, p2}, Lb/h/f/b/a$g;-><init>(Lb/h/f/b/a;I)V
    ...
    .line 11
    sget-object p2, Lb/h/f/b/a$f;->a:Lb/h/f/b/a$f;
...
.method public static final synthetic a(Lb/h/f/b/a;Ljava/util/List;Lcom/vk/catalog2/core/api/dto/CatalogExtendedData;)Lcom/vk/catalog2/core/api/dto/d;
    .locals 0

    .line 3
    invoke-direct {p0, p1, p2}, Lb/h/f/b/a;->a(Ljava/util/List;Lcom/vk/catalog2/core/api/dto/CatalogExtendedData;)Lcom/vk/catalog2/core/api/dto/d;
...
.method private final a(Ljava/util/List;Lcom/vk/catalog2/core/api/dto/CatalogExtendedData;)Lcom/vk/catalog2/core/api/dto/d;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 54
    new-instance p1, Lcom/vk/catalog2/core/api/dto/d;

    invoke-direct {p1, v0, p2}, Lcom/vk/catalog2/core/api/dto/d;-><init>(Ljava/lang/Object;Lcom/vk/catalog2/core/api/dto/CatalogExtendedData;)V
...
.method public static final synthetic a(Lb/h/f/b/a;Ljava/lang/String;Ljava/util/List;I)Lkotlin/Pair;
    .locals 0

    .line 2
    invoke-direct {p0, p1, p2, p3}, Lb/h/f/b/a;->a(Ljava/lang/String;Ljava/util/List;I)Lkotlin/Pair;
...
.method private final a(Ljava/lang/String;Ljava/util/List;I)Lkotlin/Pair;
    ...
    .line 17
    invoke-direct/range {p0 .. p0}, Lb/h/f/b/a;->d()Lcom/vk/catalog2/core/api/dto/CatalogBlock;
    ...
    invoke-direct {v10, v5}, Lb/h/f/b/a;->a(I)Ljava/lang/String;
    ...
    invoke-direct/range {v18 .. v35}, Lcom/vk/catalog2/core/api/dto/CatalogExtendedData;-><init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;ILkotlin/jvm/internal/i;)V
...
.method protected a(Ljava/lang/String;Ljava/lang/String;)Lc/a/m;
    ...
    .line 6
    :cond_0
    iget-object p2, p0, Lb/h/f/b/a;->d:Ljava/lang/String;

    invoke-direct {p0, p2, p1, v0}, Lb/h/f/b/a;->a(Ljava/lang/String;IZ)Lc/a/m;

    move-result-object p1

    .line 7
    new-instance p2, Lb/h/f/b/a$b;

    invoke-direct {p2, p0}, Lb/h/f/b/a$b;-><init>(Lb/h/f/b/a;)V
...
.method public b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;)Lc/a/m;
    ...
    .line 1
    iput-object p1, p0, Lb/h/f/b/a;->d:Ljava/lang/String;

    .line 2
    new-instance p2, Lb/h/f/b/a$d;

    invoke-direct {p2, p1}, Lb/h/f/b/a$d;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p3}, Lcom/vk/core/concurrent/VkExecutors;->f()Lc/a/s;

    move-result-object p3

    invoke-virtual {p2, p3}, Lc/a/m;->b(Lc/a/s;)Lc/a/m;

    move-result-object p2

    .line 4
    new-instance p3, Lb/h/f/b/a$e;

    invoke-direct {p3, p0}, Lb/h/f/b/a$e;-><init>(Lb/h/f/b/a;)V
    ...
    .line 5
    new-instance p3, Lb/h/f/b/a$c;

    invoke-direct {p3, p0, p1}, Lb/h/f/b/a$c;-><init>(Lb/h/f/b/a;Ljava/lang/String;)V

    invoke-virtual {p2, p3}, Lc/a/m;->c(Lc/a/z/j;)Lc/a/m;
