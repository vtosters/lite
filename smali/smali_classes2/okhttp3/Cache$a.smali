...
# interfaces
.implements Lokhttp3/internal/a/CacheRequest;
...
.field private final c:Lokhttp3/internal/a/DiskLruCache$a;
...
# direct methods
.method constructor <init>(Lokhttp3/Cache;Lokhttp3/internal/a/DiskLruCache$a;)V
    .locals 2
    ...
    .line 437
    iput-object p2, p0, Lokhttp3/Cache$a;->c:Lokhttp3/internal/a/DiskLruCache$a;

    const/4 v0, 0x1

    .line 438
    invoke-virtual {p2, v0}, Lokhttp3/internal/a/DiskLruCache$a;->a(I)Lokio/Sink;
    ...
    invoke-direct {v0, p0, v1, p1, p2}, Lokhttp3/Cache$a$1;-><init>(Lokhttp3/Cache$a;Lokio/Sink;Lokhttp3/Cache;Lokhttp3/internal/a/DiskLruCache$a;)V
...
.method public a()V
    ...
    .line 464
    :try_start_1
    iget-object v0, p0, Lokhttp3/Cache$a;->c:Lokhttp3/internal/a/DiskLruCache$a;

    invoke-virtual {v0}, Lokhttp3/internal/a/DiskLruCache$a;->c()V
    :try_end_1
