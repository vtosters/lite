.class public Lcom/my/target/HttpStatRequest;
...
.method private a(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    .line 2
    iget v0, p0, Lcom/my/target/HttpStatRequest;->e:I
    ...
    invoke-static {p1}, Lcom/my/target/UrlResolver;->c(Ljava/lang/String;)Z
...
.method public static d()Lcom/my/target/HttpStatRequest;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    .line 1
    new-instance v0, Lcom/my/target/HttpStatRequest;

    invoke-direct {v0}, Lcom/my/target/HttpStatRequest;-><init>()V
...
.method private d(Ljava/lang/String;Landroid/content/Context;)V
    ...
    .line 4
    :try_start_0
    invoke-static {p2}, Lcom/my/target/MyTargetCookieManager;->a(Landroid/content/Context;)Lcom/my/target/MyTargetCookieManager;
    ...
    .line 14
    invoke-virtual {v1, p1}, Lcom/my/target/MyTargetCookieManager;->b(Ljava/net/URLConnection;)V
    ...
    iput v3, p0, Lcom/my/target/HttpRequest;->b:I
    ...
    .line 18
    :cond_1
    iget v3, p0, Lcom/my/target/HttpRequest;->b:I
    ...
    .line 20
    :cond_3
    iget v1, p0, Lcom/my/target/HttpStatRequest;->e:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/my/target/HttpStatRequest;->e:I

    .line 21
    invoke-direct {p0, p1}, Lcom/my/target/HttpStatRequest;->a(Ljava/net/HttpURLConnection;)Ljava/lang/String;
    ...
    .line 22
    invoke-virtual {v1, p1}, Lcom/my/target/MyTargetCookieManager;->a(Ljava/net/URLConnection;)V
    :try_end_2
    ...
    .line 23
    :goto_2
    iput-boolean v2, p0, Lcom/my/target/HttpRequest;->a:Z
    ...
    iput-object v1, p0, Lcom/my/target/HttpRequest;->d:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/my/target/HttpRequest;->d:Ljava/lang/String;
    ...
    .line 28
    invoke-direct {p0, v0, p2}, Lcom/my/target/HttpStatRequest;->d(Ljava/lang/String;Landroid/content/Context;)V
...
.method protected synthetic a(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/my/target/HttpStatRequest;->c(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
...
.method protected c(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 1
    iput v0, p0, Lcom/my/target/HttpStatRequest;->e:I

    .line 2
    invoke-direct {p0, p1, p2}, Lcom/my/target/HttpStatRequest;->d(Ljava/lang/String;Landroid/content/Context;)V
