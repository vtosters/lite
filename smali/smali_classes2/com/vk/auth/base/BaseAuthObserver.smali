...
# direct methods
.method public constructor <init>(Lkotlin/jvm/b/a;Lkotlin/jvm/b/a;Lkotlin/jvm/b/a;Lkotlin/jvm/b/a;Lio/reactivex/disposables/a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0}, Lcom/vk/auth/base/g;-><init>()V

    iput-object p1, p0, Lcom/vk/auth/base/BaseAuthObserver;->b:Lkotlin/jvm/b/a;

    iput-object p2, p0, Lcom/vk/auth/base/BaseAuthObserver;->c:Lkotlin/jvm/b/a;

    iput-object p3, p0, Lcom/vk/auth/base/BaseAuthObserver;->d:Lkotlin/jvm/b/a;

    iput-object p4, p0, Lcom/vk/auth/base/BaseAuthObserver;->e:Lkotlin/jvm/b/a;

    iput-object p5, p0, Lcom/vk/auth/base/BaseAuthObserver;->f:Lio/reactivex/disposables/a;

    return-void
.end method

.method public static final synthetic a(Lcom/vk/auth/base/BaseAuthObserver;)Lcom/vk/auth/main/g;
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/vk/auth/base/BaseAuthObserver;->f()Lcom/vk/auth/main/g;
...
.method private final b(Lcom/vk/auth/main/VkAuthState;Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/b/a;Z)Lc/a/z/g;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v6}, Lcom/vk/auth/base/BaseAuthObserver$a;-><init>(Lcom/vk/auth/base/BaseAuthObserver;Lkotlin/jvm/b/a;Lcom/vk/auth/main/VkAuthState;Ljava/lang/String;Ljava/lang/String;Z)V
...
.method private final b(J)Lcom/vk/auth/verification/base/CodeState$SmsWait;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/vk/auth/verification/base/CodeState$SmsWait;-><init>(JJIILkotlin/jvm/internal/i;)V
...
.method private final d()Lcom/vk/auth/main/f;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/vk/auth/base/BaseAuthObserver;->c:Lkotlin/jvm/b/a;

    invoke-interface {v0}, Lkotlin/jvm/b/a;->invoke()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/vk/auth/main/f;

    return-object v0
.end method

.method private final f()Lcom/vk/auth/main/g;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/vk/auth/base/BaseAuthObserver;->b:Lkotlin/jvm/b/a;

    invoke-interface {v0}, Lkotlin/jvm/b/a;->invoke()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/vk/auth/main/g;

    return-object v0
.end method

.method private final g()Lcom/vk/auth/t/b;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/vk/auth/base/BaseAuthObserver;->d:Lkotlin/jvm/b/a;

    invoke-interface {v0}, Lkotlin/jvm/b/a;->invoke()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/vk/auth/t/b;
...
.method private final h()Lcom/vk/auth/main/AuthStatSender;
    ...
    .line 1
    iget-object v0, p0, Lcom/vk/auth/base/BaseAuthObserver;->e:Lkotlin/jvm/b/a;
...
.method public a(Lcom/vk/auth/api/models/AuthResult;)V
    ...
    invoke-direct {p0}, Lcom/vk/auth/base/BaseAuthObserver;->g()Lcom/vk/auth/t/b;

    move-result-object v0

    invoke-interface {v0, p1}, Lcom/vk/auth/t/b;->b(Lcom/vk/auth/api/models/AuthCredentials;)V
...
.method protected a(Lcom/vk/auth/api/models/BanInfo;)V
    ...
    invoke-interface {v0, p1}, Lcom/vk/auth/main/g;->a(Lcom/vk/auth/api/models/BanInfo;)V

    return-void
.end method

.method protected a(Lcom/vk/auth/api/models/a;Lcom/vk/auth/main/VkAuthState;)V
    .locals 9

    .line 4
    invoke-virtual {p1}, Lcom/vk/auth/api/models/a;->r()Lcom/vk/auth/api/models/ValidationType;
    ...
    invoke-virtual {p1}, Lcom/vk/auth/api/models/a;->j()Ljava/lang/String;

    move-result-object v1

    invoke-interface {v0, p2, v1}, Lcom/vk/auth/main/g;->a(Lcom/vk/auth/main/VkAuthState;Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/vk/auth/api/models/a;->q()Ljava/lang/String;

    move-result-object v1

    invoke-interface {v0, p2, v1}, Lcom/vk/auth/main/g;->b(Lcom/vk/auth/main/VkAuthState;Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/vk/auth/api/models/a;->i()Ljava/lang/String;
    ...
    invoke-interface {v1, p2, v0, v2, v3}, Lcom/vk/auth/main/g;->a(Lcom/vk/auth/main/VkAuthState;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/vk/auth/api/models/a;->o()Z

    move-result v6

    move-object v2, p2

    invoke-interface/range {v1 .. v6}, Lcom/vk/auth/main/g;->a(Lcom/vk/auth/main/VkAuthState;Ljava/lang/String;Ljava/lang/String;Lcom/vk/auth/verification/base/CodeState;Z)V
    ...
    invoke-virtual {p0, v1}, Lcom/vk/auth/base/BaseAuthObserver;->b(Ljava/lang/String;)Lc/a/m;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/vk/auth/base/BaseAuthObserver;->b(Lcom/vk/auth/main/VkAuthState;Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/b/a;Z)Lc/a/z/g;
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/vk/auth/base/BaseAuthObserver;->a(Lcom/vk/auth/main/VkAuthState;Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/b/a;Z)Lc/a/z/g;

    move-result-object p1

    .line 15
    invoke-virtual {v7, v8, p1}, Lc/a/m;->a(Lc/a/z/g;Lc/a/z/g;)Lio/reactivex/disposables/b;
    ...
    .line 16
    invoke-virtual {p0, p1}, Lcom/vk/auth/base/BaseAuthObserver;->b(Lio/reactivex/disposables/b;)Z
...
.method protected a(Lcom/vk/auth/main/VkAuthState;Lcom/vk/auth/api/models/a;)V
    ...
    invoke-interface {p2, p1}, Lcom/vk/auth/t/b;->a(Lcom/vk/auth/api/models/AuthCredentials;)V
...
.method protected b(Ljava/lang/String;)Lc/a/m;
    ...
    invoke-direct {p0}, Lcom/vk/auth/base/BaseAuthObserver;->d()Lcom/vk/auth/main/f;
...
.method protected b(Lcom/vk/auth/main/VkAuthState;Lcom/vk/auth/api/models/a;)V
    .locals 3
    ...
    .line 5
    :goto_0
    new-instance v0, Lcom/vk/auth/main/k;

    invoke-virtual {p2}, Lcom/vk/auth/api/models/a;->l()J

    move-result-wide v1

    invoke-virtual {p2}, Lcom/vk/auth/api/models/a;->k()Ljava/lang/String;

    move-result-object p2

    invoke-direct {v0, v1, v2, p2}, Lcom/vk/auth/main/k;-><init>(JLjava/lang/String;)V
    ...
    invoke-interface {p2, p1, v0}, Lcom/vk/auth/main/g;->a(Ljava/lang/String;Lcom/vk/auth/main/p;)V
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0, p1, p2}, Lcom/vk/auth/base/BaseAuthObserver;->a(Lcom/vk/auth/main/VkAuthState;Lcom/vk/auth/api/models/a;)V
...
.method protected final b(Lio/reactivex/disposables/b;)Z
    ...
    .line 16
    iget-object v0, p0, Lcom/vk/auth/base/BaseAuthObserver;->f:Lio/reactivex/disposables/a;
