.class Lcom/vk/audio/AudioMessageUtils$f;
...
.method private constructor <init>(Lcom/vk/audio/AudioMessageUtils;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/vk/audio/AudioMessageUtils$f;->a:Lcom/vk/audio/AudioMessageUtils;
...
.method synthetic constructor <init>(Lcom/vk/audio/AudioMessageUtils;Lcom/vk/audio/AudioMessageUtils$a;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Lcom/vk/audio/AudioMessageUtils$f;-><init>(Lcom/vk/audio/AudioMessageUtils;)V
...
.method public run()V
    ...
    .line 2
    iget-object v4, p0, Lcom/vk/audio/AudioMessageUtils$f;->a:Lcom/vk/audio/AudioMessageUtils;
    ...
    .line 5
    :cond_0
    iget-object v3, p0, Lcom/vk/audio/AudioMessageUtils$f;->a:Lcom/vk/audio/AudioMessageUtils;

    invoke-static {v3}, Lcom/vk/audio/AudioMessageUtils;->p(Lcom/vk/audio/AudioMessageUtils;)Ljava/io/File;
    ...
    invoke-static {v3}, Lcom/vk/audio/AudioMessageUtils;->a(Lcom/vk/audio/AudioMessageUtils;)V
    ...
    invoke-static {v3}, Lcom/vk/audio/AudioMessageUtils;->b(Lcom/vk/audio/AudioMessageUtils;)V
    ...
    .line 11
    invoke-static {v4}, Lcom/vk/audio/AudioMessageUtils;->c(Lcom/vk/audio/AudioMessageUtils;)I
    ...
    invoke-static {v3}, Lcom/vk/audio/AudioMessageUtils;->h(Lcom/vk/audio/AudioMessageUtils;)Lcom/vk/core/concurrent/DispatchQueue;

    move-result-object v3

    iget-object v4, p0, Lcom/vk/audio/AudioMessageUtils$f;->a:Lcom/vk/audio/AudioMessageUtils;

    invoke-static {v4}, Lcom/vk/audio/AudioMessageUtils;->g(Lcom/vk/audio/AudioMessageUtils;)Ljava/lang/Runnable;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/vk/core/concurrent/DispatchQueue;->b(Ljava/lang/Runnable;)V

    .line 18
    iget-object v3, p0, Lcom/vk/audio/AudioMessageUtils$f;->a:Lcom/vk/audio/AudioMessageUtils;

    invoke-static {v3}, Lcom/vk/audio/AudioMessageUtils;->i(Lcom/vk/audio/AudioMessageUtils;)V

    .line 19
    iget-object v3, p0, Lcom/vk/audio/AudioMessageUtils$f;->a:Lcom/vk/audio/AudioMessageUtils;

    invoke-static {v3}, Lcom/vk/audio/AudioMessageUtils;->j(Lcom/vk/audio/AudioMessageUtils;)Ljava/lang/Boolean;
    ...
    .line 28
    :goto_0
    iget-object v0, p0, Lcom/vk/audio/AudioMessageUtils$f;->a:Lcom/vk/audio/AudioMessageUtils;

    invoke-static {v0}, Lcom/vk/audio/AudioMessageUtils;->a(Lcom/vk/audio/AudioMessageUtils;)V
