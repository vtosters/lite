.class public final Lcom/vk/feedlikes/c/FeedLikesMergeAdapter;
...
.method public B(I)Z
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p1}, Lme/grishka/appkit/utils/MergeRecyclerAdapter;->getItemViewType(I)I
...
.method public a(Landroid/view/View;Lcom/vk/core/ui/themes/VKTheme;)V
    ...
    .line 3
    instance-of p2, p1, Lcom/vk/feedlikes/views/FeedLikesFilterView;
    ...
    invoke-virtual {p1}, Lcom/vk/feedlikes/views/FeedLikesFilterView;->a()V
...
.method public i(I)I
    ...
    .line 1
    invoke-virtual {p0, v0}, Lme/grishka/appkit/utils/MergeRecyclerAdapter;->getItemViewType(I)I
