.class public Lcom/vk/api/stories/t;
...
.method public constructor <init>(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    .line 3
    invoke-static {p1}, Lcom/vk/api/base/utils/a;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    .line 4
    invoke-static {p2}, Lcom/vk/api/base/utils/a;->a(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    .line 5
    invoke-static {p3}, Lcom/vk/api/base/utils/a;->a(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    :goto_0
    iput-boolean p1, p0, Lcom/vk/api/stories/t;->F:Z
...
.method private b(Lorg/json/JSONObject;)Ljava/util/ArrayList;
    ...
    new-instance v3, Lcom/vk/api/stories/t$a;

    invoke-direct {v3, p0}, Lcom/vk/api/stories/t$a;-><init>(Lcom/vk/api/stories/t;)V

    sget-object v4, Lcom/vk/dto/user/UserProfile;->g0:Lcom/vk/dto/common/data/c;

    .line 4
    invoke-static {v2, v3, v4}, Lcom/vk/dto/common/data/c;->a(Lorg/json/JSONArray;Lkotlin/jvm/b/b;Lcom/vk/dto/common/data/c;)Landroid/util/SparseArray;
    ...
    new-instance v3, Lcom/vk/api/stories/t$b;

    invoke-direct {v3, p0}, Lcom/vk/api/stories/t$b;-><init>(Lcom/vk/api/stories/t;)V

    sget-object v4, Lcom/vk/dto/group/Group;->Z:Lcom/vk/dto/common/data/c;

    .line 6
    invoke-static {p1, v3, v4}, Lcom/vk/dto/common/data/c;->a(Lorg/json/JSONArray;Lkotlin/jvm/b/b;Lcom/vk/dto/common/data/c;)Landroid/util/SparseArray;
...
# virtual methods
.method public a(Lorg/json/JSONObject;)Lcom/vk/dto/stories/model/b;
    .locals 8
    ...
    .line 3
    new-instance v0, Lcom/vk/dto/stories/model/b;

    invoke-direct {v0}, Lcom/vk/dto/stories/model/b;-><init>()V

    .line 4
    iget-boolean v1, p0, Lcom/vk/api/stories/t;->F:Z
    ...
    invoke-direct {p0, v1}, Lcom/vk/api/stories/t;->b(Lorg/json/JSONObject;)Ljava/util/ArrayList;

    move-result-object v1

    iput-object v1, v0, Lcom/vk/dto/stories/model/b;->a:Ljava/util/ArrayList;
    ...
    .line 17
    :cond_2
    iput-object v1, v0, Lcom/vk/dto/stories/model/b;->b:Landroid/util/SparseArray;

    .line 18
    iput-object v2, v0, Lcom/vk/dto/stories/model/b;->c:Landroid/util/SparseArray;
...
.method public bridge synthetic a(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/vk/api/stories/t;->a(Lorg/json/JSONObject;)Lcom/vk/dto/stories/model/b;
