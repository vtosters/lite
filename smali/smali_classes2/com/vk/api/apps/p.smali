.class public Lcom/vk/api/apps/p;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vk/api/apps/p$c;,
        Lcom/vk/api/apps/p$b;,
...
# instance fields
.field private F:Lcom/vk/api/apps/p$c;


# direct methods
.method public constructor <init>(Lcom/vk/api/apps/p$c;)V
    .locals 2
    ...
    .line 5
    iput-object p1, p0, Lcom/vk/api/apps/p;->F:Lcom/vk/api/apps/p$c;
...
.method private a(Lorg/json/JSONArray;Landroid/util/SparseArray;Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    .line 53
    invoke-direct {p0, v0, p1, p2, p3}, Lcom/vk/api/apps/p;->a(Ljava/util/List;Lorg/json/JSONArray;Landroid/util/SparseArray;Landroid/util/SparseArray;)V

    .line 54
    new-instance p1, Lcom/vk/api/apps/p$a;

    invoke-direct {p1, p0}, Lcom/vk/api/apps/p$a;-><init>(Lcom/vk/api/apps/p;)V
...
.method private a(Lorg/json/JSONArray;Ljava/util/List;)V
    ...
    .line 71
    iget-object v6, p0, Lcom/vk/api/apps/p;->F:Lcom/vk/api/apps/p$c;

    invoke-interface {v6, v5}, Lcom/vk/api/apps/p$c;->a(I)Lcom/vk/dto/user/UserProfile;
...
.method private a(Lorg/json/JSONObject;Ljava/util/List;Ljava/lang/String;)V
    ...
    .line 63
    invoke-static {p1, p3}, Lcom/vk/api/base/f;->a(Lorg/json/JSONObject;Ljava/lang/String;)Lcom/vk/dto/common/d;
    ...
    .line 65
    invoke-direct {p0, p1, p2}, Lcom/vk/api/apps/p;->a(Lorg/json/JSONArray;Ljava/util/List;)V
...
.method public a(Lorg/json/JSONObject;)Lcom/vk/api/apps/p$d;
    .locals 14
    ...
    .line 2
    :try_start_0
    new-instance v6, Lcom/vk/api/apps/p$d;

    invoke-direct {v6}, Lcom/vk/api/apps/p$d;-><init>()V
    ...
    .line 6
    iget-object v9, v6, Lcom/vk/api/apps/p$d;->c:Ljava/util/ArrayList;

    const-string v10, "catalogMy"

    invoke-direct {p0, p1, v9, v10}, Lcom/vk/api/apps/p;->a(Lorg/json/JSONObject;Ljava/util/List;Ljava/lang/String;)V

    .line 7
    iget-object v9, v6, Lcom/vk/api/apps/p$d;->d:Ljava/util/ArrayList;
    ...
    .line 8
    iget-object v9, v6, Lcom/vk/api/apps/p$d;->e:Ljava/util/ArrayList;
    ...
    .line 9
    iget-object v9, v6, Lcom/vk/api/apps/p$d;->f:Ljava/util/ArrayList;
    ...
    .line 10
    iget-object v9, v6, Lcom/vk/api/apps/p$d;->g:Ljava/util/ArrayList;
    ...
    .line 11
    iget-object v9, v6, Lcom/vk/api/apps/p$d;->i:Ljava/util/ArrayList;
    ...
    .line 12
    iget-object v9, v6, Lcom/vk/api/apps/p$d;->h:Ljava/util/ArrayList;
    ...
    .line 13
    invoke-static {p1, v7, v3}, Lcom/vk/api/apps/p;->b(Lorg/json/JSONObject;Landroid/util/SparseArray;Ljava/lang/String;)V

    .line 14
    invoke-static {p1, v7, v2}, Lcom/vk/api/apps/p;->b(Lorg/json/JSONObject;Landroid/util/SparseArray;Ljava/lang/String;)V

    .line 15
    invoke-static {p1, v8, v3}, Lcom/vk/api/apps/p;->a(Lorg/json/JSONObject;Landroid/util/SparseArray;Ljava/lang/String;)V

    .line 16
    invoke-static {p1, v8, v2}, Lcom/vk/api/apps/p;->a(Lorg/json/JSONObject;Landroid/util/SparseArray;Ljava/lang/String;)V
    ...
    iget-object v3, v3, Lcom/vk/dto/common/d;->b:Lorg/json/JSONArray;

    .line 19
    invoke-direct {p0, v3, v7, v8}, Lcom/vk/api/apps/p;->a(Lorg/json/JSONArray;Landroid/util/SparseArray;Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    .line 25
    :cond_0
    iget-object v12, v6, Lcom/vk/api/apps/p$d;->a:Ljava/util/ArrayList;
    ...
    .line 27
    iget-object v10, v6, Lcom/vk/api/apps/p$d;->c:Ljava/util/ArrayList;
    ...
    invoke-static {v10, v11, v12}, Lcom/vk/api/apps/p;->a(Ljava/util/List;II)V

    .line 28
    iget-object v10, v6, Lcom/vk/api/apps/p$d;->f:Ljava/util/ArrayList;
    ...
    .line 29
    :cond_2
    iget-object v3, v6, Lcom/vk/api/apps/p$d;->c:Ljava/util/ArrayList;

    invoke-static {v3, p0}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    .line 30
    iget-object v3, v6, Lcom/vk/api/apps/p$d;->f:Ljava/util/ArrayList;
    ...
    .line 35
    iget-object v10, v6, Lcom/vk/api/apps/p$d;->b:Ljava/util/ArrayList;
    ...
    .line 39
    iget-object v8, v6, Lcom/vk/api/apps/p$d;->j:Ljava/util/ArrayList;
    ...
    .line 46
    invoke-direct {p0, v7, v9}, Lcom/vk/api/apps/p;->a(Lorg/json/JSONArray;Ljava/util/List;)V

    .line 47
    iget-object v7, v6, Lcom/vk/api/apps/p$d;->k:Landroid/util/SparseArray;
    ...
    .line 50
    new-instance v2, Lcom/vk/api/apps/p$b;
    ...
    invoke-direct {v2, v1, p1}, Lcom/vk/api/apps/p$b;-><init>(Ljava/lang/String;I)V

    iput-object v2, v6, Lcom/vk/api/apps/p$d;->l:Lcom/vk/api/apps/p$b;
    :try_end_0
...
.method public bridge synthetic a(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/vk/api/apps/p;->a(Lorg/json/JSONObject;)Lcom/vk/api/apps/p$d;
...
.method public bridge synthetic compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1, p2}, Lcom/vk/api/apps/p;->a(Lcom/vk/dto/common/data/ApiApplication;Lcom/vk/dto/common/data/ApiApplication;)I
