...
# instance fields
.field F:Lcom/vk/api/friends/FriendsGetRequests$b;
...
.method public constructor <init>(IZ)V
    ...
    .line 1
    invoke-direct {p0, p1, p2, v0, v1}, Lcom/vk/api/friends/FriendsGet;-><init>(IZZLcom/vk/api/friends/FriendsGetRequests$b;)V

    return-void
.end method

.method public constructor <init>(IZZLcom/vk/api/friends/FriendsGetRequests$b;)V
    .locals 1
    ...
    .line 3
    iput-object p4, p0, Lcom/vk/api/friends/FriendsGet;->F:Lcom/vk/api/friends/FriendsGetRequests$b;

    .line 4
    sget-object p2, Lcom/vk/api/base/ApiConfig;->d:Lcom/vk/api/base/ApiConfig$a;

    invoke-interface {p2}, Lb/h/h/ModelConfig$a;->c()I
...
.method private a(Ljava/util/ArrayList;)Lcom/vk/api/friends/FriendsGetRequests$b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 30
    new-instance v0, Lcom/vk/api/friends/FriendsGet$a;

    invoke-direct {v0, p0, p1}, Lcom/vk/api/friends/FriendsGet$a;-><init>(Lcom/vk/api/friends/FriendsGet;Ljava/util/ArrayList;)V
...
# virtual methods
.method public a(Lorg/json/JSONObject;)Lcom/vk/api/friends/FriendsGet$b;
    .locals 10
    ...
    .line 3
    new-instance v4, Lcom/vk/api/friends/FriendsGet$b;

    invoke-direct {v4}, Lcom/vk/api/friends/FriendsGet$b;-><init>()V
    ...
    invoke-direct {p0, v7}, Lcom/vk/api/friends/FriendsGet;->b(Lorg/json/JSONObject;)Lcom/vk/dto/user/UserProfile;
    ...
    .line 9
    :cond_1
    iput-object v3, v4, Lcom/vk/api/friends/FriendsGet$b;->a:Ljava/util/ArrayList;
    ...
    .line 19
    :cond_2
    iput-object v5, v4, Lcom/vk/api/friends/FriendsGet$b;->b:Ljava/util/List;
    ...
    .line 21
    invoke-direct {p0, v3}, Lcom/vk/api/friends/FriendsGet;->a(Ljava/util/ArrayList;)Lcom/vk/api/friends/FriendsGetRequests$b;

    move-result-object v5

    const/4 v6, 0x1

    invoke-static {v0, v5, v6, v2}, Lcom/vk/api/friends/FriendsGetRequests;->a(Lorg/json/JSONObject;Lcom/vk/api/friends/FriendsGetRequests$b;ZZ)Lcom/vk/api/friends/FriendsGetRequests$c;

    move-result-object v0

    .line 22
    iget v5, v0, Lcom/vk/api/friends/FriendsGetRequests$c;->b:I

    iput v5, v4, Lcom/vk/api/friends/FriendsGet$b;->d:I

    .line 23
    iget-object v0, v0, Lcom/vk/api/friends/FriendsGetRequests$c;->a:Lcom/vk/dto/common/data/VKList;

    iput-object v0, v4, Lcom/vk/api/friends/FriendsGet$b;->g:Ljava/util/List;
    ...
    invoke-static {v0, v3, v2, v2}, Lcom/vk/api/friends/FriendsGetRequests;->a(Lorg/json/JSONObject;Lcom/vk/api/friends/FriendsGetRequests$b;ZZ)Lcom/vk/api/friends/FriendsGetRequests$c;

    move-result-object v0

    .line 26
    iget v3, v0, Lcom/vk/api/friends/FriendsGetRequests$c;->b:I

    iput v3, v4, Lcom/vk/api/friends/FriendsGet$b;->e:I

    .line 27
    iget-object v0, v0, Lcom/vk/api/friends/FriendsGetRequests$c;->a:Lcom/vk/dto/common/data/VKList;

    iput-object v0, v4, Lcom/vk/api/friends/FriendsGet$b;->h:Ljava/util/List;
    ...
    iput p1, v4, Lcom/vk/api/friends/FriendsGet$b;->f:I
    :try_end_0
...
.method public bridge synthetic a(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/vk/api/friends/FriendsGet;->a(Lorg/json/JSONObject;)Lcom/vk/api/friends/FriendsGet$b;
