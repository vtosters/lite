.class public final Lcom/vk/api/friends/i;
...
.field private K:Lcom/vk/api/friends/i$b;


# direct methods
.method public constructor <init>(IIZZZLcom/vk/api/friends/i$b;)V
    .locals 2
    ...
    .line 8
    :cond_1
    iput-boolean p5, p0, Lcom/vk/api/friends/i;->F:Z

    .line 9
    iput-boolean p3, p0, Lcom/vk/api/friends/i;->G:Z

    .line 10
    iput p1, p0, Lcom/vk/api/friends/i;->I:I

    .line 11
    iput-boolean p4, p0, Lcom/vk/api/friends/i;->H:Z

    .line 12
    iput-object p6, p0, Lcom/vk/api/friends/i;->K:Lcom/vk/api/friends/i$b;

    return-void
.end method

.method public static a(Lorg/json/JSONObject;Lcom/vk/api/friends/i$b;ZZ)Lcom/vk/api/friends/i$c;
    .locals 16
    ...
    .line 6
    invoke-interface/range {p1 .. p1}, Lcom/vk/api/friends/i$b;->a()Ljava/util/ArrayList;
    ...
    .line 30
    :cond_4
    new-instance v9, Lcom/vk/api/friends/i$c;

    new-instance v10, Lcom/vk/dto/common/data/VKList;

    new-instance v11, Lcom/vk/api/friends/i$a;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/vk/api/friends/i$a;-><init>(Landroid/util/SparseArray;ZLcom/vk/api/friends/i$b;Landroid/util/SparseArray;ZLjava/util/ArrayList;)V

    invoke-direct {v10, v0, v11}, Lcom/vk/dto/common/data/VKList;-><init>(Lorg/json/JSONObject;Lcom/vk/dto/common/data/c;)V

    invoke-direct {v9, v10, v8}, Lcom/vk/api/friends/i$c;-><init>(Lcom/vk/dto/common/data/VKList;I)V
...
# virtual methods
.method public a(Lorg/json/JSONObject;)Lcom/vk/api/friends/i$c;
    .locals 3

    .line 2
    :try_start_0
    iget v0, p0, Lcom/vk/api/friends/i;->I:I

    if-nez v0, :cond_1

    iget-boolean v0, p0, Lcom/vk/api/friends/i;->H:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Lcom/vk/api/friends/i;->F:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lcom/vk/api/friends/i;->J:Z

    if-nez v0, :cond_1

    .line 3
    :cond_0
    iget-boolean v0, p0, Lcom/vk/api/friends/i;->G:Z

    invoke-direct {p0, p1, v0}, Lcom/vk/api/friends/i;->a(Lorg/json/JSONObject;Z)V
    ...
    iget-object v0, p0, Lcom/vk/api/friends/i;->K:Lcom/vk/api/friends/i$b;

    iget-boolean v1, p0, Lcom/vk/api/friends/i;->G:Z

    iget-boolean v2, p0, Lcom/vk/api/friends/i;->H:Z

    invoke-static {p1, v0, v1, v2}, Lcom/vk/api/friends/i;->a(Lorg/json/JSONObject;Lcom/vk/api/friends/i$b;ZZ)Lcom/vk/api/friends/i$c;
...
.method public bridge synthetic a(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/vk/api/friends/i;->a(Lorg/json/JSONObject;)Lcom/vk/api/friends/i$c;
