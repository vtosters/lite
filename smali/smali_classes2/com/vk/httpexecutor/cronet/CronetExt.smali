.class public final Lcom/vk/httpexecutor/cronet/CronetExt;
...
.method public static final a(Lorg/chromium/net/RequestFinishedInfo;Lcom/vk/httpexecutor/api/utils/NetworkTypeDetector;Lcom/vk/httpexecutor/api/utils/RoamingDetector;)Lcom/vk/httpexecutor/api/HttpMetrics;
    .locals 23

    .line 11
    invoke-virtual/range {p0 .. p0}, Lorg/chromium/net/RequestFinishedInfo;->a()Lorg/chromium/net/RequestFinishedInfo$b;
    ...
    invoke-virtual {v0}, Lorg/chromium/net/RequestFinishedInfo$b;->d()Ljava/util/Date;
    ...
    invoke-virtual {v0}, Lorg/chromium/net/RequestFinishedInfo$b;->b()Ljava/util/Date;
    ...
    invoke-virtual {v0}, Lorg/chromium/net/RequestFinishedInfo$b;->g()Ljava/util/Date;
    ...
    invoke-virtual {v0}, Lorg/chromium/net/RequestFinishedInfo$b;->f()Ljava/util/Date;
    ...
    invoke-virtual {v0}, Lorg/chromium/net/RequestFinishedInfo$b;->e()Ljava/util/Date;
    ...
    .line 14
    :goto_5
    new-instance v0, Lcom/vk/httpexecutor/api/HttpMetrics;
    ...
    invoke-virtual {v2}, Lorg/chromium/net/RequestFinishedInfo$b;->h()Z
    ...
    invoke-virtual {v2}, Lorg/chromium/net/RequestFinishedInfo$b;->c()Ljava/util/Date;
    ...
    invoke-virtual {v2}, Lorg/chromium/net/RequestFinishedInfo$b;->d()Ljava/util/Date;
    ...
    invoke-virtual {v2}, Lorg/chromium/net/RequestFinishedInfo$b;->a()Ljava/util/Date;
    ...
    invoke-virtual {v2}, Lorg/chromium/net/RequestFinishedInfo$b;->b()Ljava/util/Date;
    ...
    .line 20
    invoke-direct/range {v11 .. v22}, Lcom/vk/httpexecutor/api/HttpMetrics;-><init>(Lcom/vk/httpexecutor/api/NetworkType;ZZJJJJ)V
...
.method public static final a(Lorg/chromium/net/CronetException;)Ljava/lang/Throwable;
    ...
    .line 39
    invoke-static {v0, p0}, Lcom/vk/httpexecutor/api/utils/ThrowableUtils;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V

    :cond_11
    return-object v0
.end method

.method public static final a(Lorg/chromium/net/ExperimentalUrlRequest$a;Ljava/util/Map;)Lorg/chromium/net/ExperimentalUrlRequest$a;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lorg/chromium/net/ExperimentalUrlRequest$a;",
            "Ljava/util/Map<",
            "Ljava/lang/String;",
            "+",
            "Ljava/util/List<",
    ...
    invoke-virtual {p0, v2, v0}, Lorg/chromium/net/ExperimentalUrlRequest$a;->a(Ljava/lang/String;Ljava/lang/String;)Lorg/chromium/net/ExperimentalUrlRequest$a;
...
.method public static final a(Lcom/vk/httpexecutor/api/HttpRequest;)Lorg/chromium/net/UploadDataProvider;
    .locals 1

    .line 7
    invoke-virtual {p0}, Lcom/vk/httpexecutor/api/HttpRequest;->c()Lcom/vk/httpexecutor/api/HttpMethod;

    move-result-object v0

    .line 8
    invoke-virtual {p0}, Lcom/vk/httpexecutor/api/HttpRequest;->a()Lcom/vk/httpexecutor/api/HttpRequestBody;
    ...
    .line 10
    invoke-interface {p0}, Lcom/vk/httpexecutor/api/HttpRequestBody;->b()[B

    move-result-object p0

    invoke-static {p0}, Lorg/chromium/net/UploadDataProviders1;->a([B)Lorg/chromium/net/UploadDataProvider;
