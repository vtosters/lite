.class public final Lcom/vk/core/extensions/x;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lcom/vk/core/extensions/c0;

    invoke-direct {v0}, Lcom/vk/core/extensions/c0;-><init>()V

    sput-object v0, Lcom/vk/core/extensions/x;->a:Landroid/util/SparseArray;
...
.method public static final a()Landroid/util/SparseArray;
    ...
    .line 12
    sget-object v0, Lcom/vk/core/extensions/x;->a:Landroid/util/SparseArray;
...
.method public static final a(Landroid/util/SparseArray;Lkotlin/jvm/b/b;)Landroid/util/SparseArray;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<V:",
    ...
    .line 6
    invoke-static {v0, v4, v3}, Lcom/vk/core/extensions/x;->a(Landroid/util/SparseArray;ILjava/lang/Object;)V
...
.method public static final b(Landroid/util/SparseArray;Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    .line 7
    invoke-static {v0, p0}, Lcom/vk/core/extensions/x;->a(Landroid/util/SparseArray;Landroid/util/SparseArray;)Landroid/util/SparseArray;
...
.method public static final b(Landroid/util/SparseArray;Lkotlin/jvm/b/b;)Landroid/util/SparseArray;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final c(Landroid/util/SparseArray;Lkotlin/jvm/b/b;)Landroid/util/SparseArray;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<V:",
    ...
    invoke-static {v0, v3, v4}, Lcom/vk/core/extensions/x;->a(Landroid/util/SparseArray;ILjava/lang/Object;)V
...
.method public static final c(Landroid/util/SparseArray;)Ljava/util/Iterator;
    ...
    .line 5
    new-instance v0, Lcom/vk/core/extensions/y;

    invoke-direct {v0, p0}, Lcom/vk/core/extensions/y;-><init>(Landroid/util/SparseArray;)V
...
.method public static final e(Landroid/util/SparseArray;)Ljava/util/Collection;
    ...
    .line 1
    new-instance v0, Lcom/vk/core/extensions/x$a;

    invoke-direct {v0, p0}, Lcom/vk/core/extensions/x$a;-><init>(Landroid/util/SparseArray;)V
...
.method public static final f(Landroid/util/SparseArray;)Ljava/lang/Iterable;
    ...
    .line 1
    new-instance v0, Lcom/vk/core/extensions/x$b;

    invoke-direct {v0, p0}, Lcom/vk/core/extensions/x$b;-><init>(Landroid/util/SparseArray;)V
...
.method public static final g(Landroid/util/SparseArray;)Ljava/util/List;
    ...
    .line 1
    invoke-static {p0}, Lcom/vk/core/extensions/x;->f(Landroid/util/SparseArray;)Ljava/lang/Iterable;
