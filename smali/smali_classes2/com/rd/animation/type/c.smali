.class public Lcom/rd/animation/type/c;
.super Lcom/rd/animation/type/b;
.source "FillAnimation.java"


# instance fields
.field private g:Lcom/rd/b/c/b/c;
...
.method public constructor <init>(Lcom/rd/b/b/b$a;)V
    ...
    .line 2
    new-instance p1, Lcom/rd/b/c/b/c;

    invoke-direct {p1}, Lcom/rd/b/c/b/c;-><init>()V

    iput-object p1, p0, Lcom/rd/animation/type/c;->g:Lcom/rd/b/c/b/c;
...
.method private a(Landroid/animation/ValueAnimator;)V
    ...
    .line 25
    iget-object v5, p0, Lcom/rd/animation/type/c;->g:Lcom/rd/b/c/b/c;

    invoke-virtual {v5, v0}, Lcom/rd/b/c/b/a;->a(I)V

    .line 26
    iget-object v0, p0, Lcom/rd/animation/type/c;->g:Lcom/rd/b/c/b/c;
    ...
    invoke-virtual {v0, v2}, Lcom/rd/b/c/b/c;->c(I)V

    .line 28
    iget-object v0, p0, Lcom/rd/animation/type/c;->g:Lcom/rd/b/c/b/c;

    invoke-virtual {v0, v3}, Lcom/rd/b/c/b/c;->d(I)V

    .line 29
    iget-object v0, p0, Lcom/rd/animation/type/c;->g:Lcom/rd/b/c/b/c;

    invoke-virtual {v0, v4}, Lcom/rd/b/c/b/c;->e(I)V

    .line 30
    iget-object v0, p0, Lcom/rd/animation/type/c;->g:Lcom/rd/b/c/b/c;

    invoke-virtual {v0, p1}, Lcom/rd/b/c/b/c;->f(I)V
...
.method static synthetic a(Lcom/rd/animation/type/c;Landroid/animation/ValueAnimator;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/rd/animation/type/c;->a(Landroid/animation/ValueAnimator;)V
...
.method private b(Z)Landroid/animation/PropertyValuesHolder;
    ...
    .line 1
    iget p1, p0, Lcom/rd/animation/type/c;->h:I
    ...
    .line 2
    :cond_0
    iget v0, p0, Lcom/rd/animation/type/c;->h:I
...
.method private b(IIII)Z
    ...
    .line 9
    :cond_2
    iget p1, p0, Lcom/rd/animation/type/c;->i:I
...
.method public bridge synthetic a()Landroid/animation/Animator;
    ...
    .line 2
    invoke-virtual {p0}, Lcom/rd/animation/type/c;->a()Landroid/animation/ValueAnimator;
...
.method public a()Landroid/animation/ValueAnimator;
    ...
    .line 6
    new-instance v1, Lcom/rd/animation/type/c$a;

    invoke-direct {v1, p0}, Lcom/rd/animation/type/c$a;-><init>(Lcom/rd/animation/type/c;)V
...
.method public a(IIII)Lcom/rd/animation/type/c;
    .locals 6
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/rd/animation/type/c;->b(IIII)Z
    ...
    .line 10
    iput p3, p0, Lcom/rd/animation/type/c;->h:I

    .line 11
    iput p4, p0, Lcom/rd/animation/type/c;->i:I
    ...
    .line 14
    invoke-direct {p0, p1}, Lcom/rd/animation/type/c;->b(Z)Landroid/animation/PropertyValuesHolder;

    move-result-object v0

    .line 15
    invoke-direct {p0, p3}, Lcom/rd/animation/type/c;->b(Z)Landroid/animation/PropertyValuesHolder;

    move-result-object v1

    .line 16
    invoke-direct {p0, p1}, Lcom/rd/animation/type/c;->c(Z)Landroid/animation/PropertyValuesHolder;

    move-result-object v2

    .line 17
    invoke-direct {p0, p3}, Lcom/rd/animation/type/c;->c(Z)Landroid/animation/PropertyValuesHolder;

    move-result-object v3

    .line 18
    iget-object v4, p0, Lcom/rd/animation/type/a;->c:Landroid/animation/Animator;
