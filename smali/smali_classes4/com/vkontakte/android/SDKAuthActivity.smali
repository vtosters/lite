...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/SDKAuthActivity$d;,
        Lcom/vkontakte/android/SDKAuthActivity$c;
    }
.end annotation
...
.field private J:Lcom/vkontakte/android/ui/ErrorView;
...
.method static synthetic a(Lcom/vkontakte/android/SDKAuthActivity;)Lcom/vkontakte/android/ui/ErrorView;
    ...
    .line 1
    iget-object p0, p0, Lcom/vkontakte/android/SDKAuthActivity;->J:Lcom/vkontakte/android/ui/ErrorView;
...
.method static synthetic b(Lcom/vkontakte/android/SDKAuthActivity;)Landroid/webkit/WebView;
    ...
    .line 1
    iget-object p0, p0, Lcom/vkontakte/android/SDKAuthActivity;->G:Landroid/webkit/WebView;
...
.method static synthetic c(Lcom/vkontakte/android/SDKAuthActivity;)Landroid/widget/ProgressBar;
    ...
    .line 1
    iget-object p0, p0, Lcom/vkontakte/android/SDKAuthActivity;->H:Landroid/widget/ProgressBar;
...
.method private w1()V
    ...
    .line 27
    :cond_2
    invoke-virtual {p0, v3}, Lcom/vkontakte/android/SDKAuthActivity;->a(Ljava/util/HashMap;)Ljava/lang/String;
    ...
    .line 29
    iget-object v1, p0, Lcom/vkontakte/android/SDKAuthActivity;->G:Landroid/webkit/WebView;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 1
    invoke-direct {p0}, Lcom/vkontakte/android/SDKAuthActivity;->w1()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/vkontakte/android/SDKAuthActivity;->H:Landroid/widget/ProgressBar;
    ...
    iput-object p1, p0, Lcom/vkontakte/android/SDKAuthActivity;->I:Landroid/widget/FrameLayout;

    .line 7
    iget-object p1, p0, Lcom/vkontakte/android/SDKAuthActivity;->I:Landroid/widget/FrameLayout;
    ...
    iput-object p1, p0, Lcom/vkontakte/android/SDKAuthActivity;->G:Landroid/webkit/WebView;

    .line 9
    iget-object p1, p0, Lcom/vkontakte/android/SDKAuthActivity;->G:Landroid/webkit/WebView;

    new-instance v0, Lcom/vkontakte/android/SDKAuthActivity$d;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/vkontakte/android/SDKAuthActivity$d;-><init>(Lcom/vkontakte/android/SDKAuthActivity;Lcom/vkontakte/android/SDKAuthActivity$a;)V
    ...
    new-instance v0, Lcom/vkontakte/android/SDKAuthActivity$c;

    invoke-direct {v0, p0, v1}, Lcom/vkontakte/android/SDKAuthActivity$c;-><init>(Lcom/vkontakte/android/SDKAuthActivity;Lcom/vkontakte/android/SDKAuthActivity$a;)V
    ...
    new-instance v0, Lcom/vkontakte/android/SDKAuthActivity$a;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/SDKAuthActivity$a;-><init>(Lcom/vkontakte/android/SDKAuthActivity;)V
    ...
    iget-object v0, p0, Lcom/vkontakte/android/SDKAuthActivity;->G:Landroid/webkit/WebView;
    ...
    iget-object v0, p0, Lcom/vkontakte/android/SDKAuthActivity;->H:Landroid/widget/ProgressBar;
    ...
    iput-object p1, p0, Lcom/vkontakte/android/SDKAuthActivity;->J:Lcom/vkontakte/android/ui/ErrorView;

    .line 17
    iget-object p1, p0, Lcom/vkontakte/android/SDKAuthActivity;->J:Lcom/vkontakte/android/ui/ErrorView;
    ...
    iget-object v1, p0, Lcom/vkontakte/android/SDKAuthActivity;->J:Lcom/vkontakte/android/ui/ErrorView;
    ...
    new-instance v0, Lcom/vkontakte/android/SDKAuthActivity$b;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/SDKAuthActivity$b;-><init>(Lcom/vkontakte/android/SDKAuthActivity;)V
