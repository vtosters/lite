.class public final Lcom/vkontakte/android/directshare/ImDirectShareService;
...
.method public constructor <init>()V
    ...
    .line 2
    iput v0, p0, Lcom/vkontakte/android/directshare/ImDirectShareService;->a:F

    const v0, 0x3f7d70a4    # 0.99f

    .line 3
    iput v0, p0, Lcom/vkontakte/android/directshare/ImDirectShareService;->b:F
    ...
    iput-object v0, p0, Lcom/vkontakte/android/directshare/ImDirectShareService;->d:Lcom/vk/im/engine/a;
...
.method private final a(Ljava/util/concurrent/atomic/AtomicInteger;)F
    ...
    iget p1, p0, Lcom/vkontakte/android/directshare/ImDirectShareService;->a:F

    goto :goto_0

    :cond_0
    iget p1, p0, Lcom/vkontakte/android/directshare/ImDirectShareService;->c:F
...
.method private final a()Landroid/service/chooser/ChooserTarget;
    ...
    .line 11
    iget v5, p0, Lcom/vkontakte/android/directshare/ImDirectShareService;->b:F
...
.method private final a(I)Lcom/vk/im/engine/commands/contacts/RecentAndHintsDialogsGetCmd$a;
    ...
    .line 3
    iget-object p1, p0, Lcom/vkontakte/android/directshare/ImDirectShareService;->d:Lcom/vk/im/engine/a;
...
.method private final b(Lcom/vk/im/engine/models/dialogs/Dialog;Lcom/vk/im/engine/models/ProfilesSimpleInfo;)Landroid/graphics/drawable/Icon;
    ...
    invoke-direct {v2, p1, p2}, Lcom/vkontakte/android/directshare/ImDirectShareService$getTargetIcon$1;-><init>(Lcom/vk/im/engine/models/dialogs/Dialog;Lcom/vk/im/engine/models/ProfilesSimpleInfo;)V
...
.method public onGetChooserTargets(Landroid/content/ComponentName;Landroid/content/IntentFilter;)Ljava/util/List;
    ...
    .line 4
    invoke-direct {p0, p2}, Lcom/vkontakte/android/directshare/ImDirectShareService;->a(I)Lcom/vk/im/engine/commands/contacts/RecentAndHintsDialogsGetCmd$a;
    ...
    .line 6
    invoke-direct {p0}, Lcom/vkontakte/android/directshare/ImDirectShareService;->b()Landroid/content/ComponentName;
    ...
    .line 13
    invoke-static {v1, v0}, Lcom/vkontakte/android/im/ImCompat;->b(Lcom/vk/im/engine/models/dialogs/Dialog;Lcom/vk/im/engine/models/ProfilesSimpleInfo;)Ljava/lang/String;

    move-result-object v2

    .line 14
    invoke-direct {p0, v1, v0}, Lcom/vkontakte/android/directshare/ImDirectShareService;->b(Lcom/vk/im/engine/models/dialogs/Dialog;Lcom/vk/im/engine/models/ProfilesSimpleInfo;)Landroid/graphics/drawable/Icon;

    move-result-object v3

    .line 15
    invoke-direct {p0, v8}, Lcom/vkontakte/android/directshare/ImDirectShareService;->a(Ljava/util/concurrent/atomic/AtomicInteger;)F

    move-result v4

    .line 16
    invoke-direct {p0, v1, v0}, Lcom/vkontakte/android/directshare/ImDirectShareService;->a(Lcom/vk/im/engine/models/dialogs/Dialog;Lcom/vk/im/engine/models/ProfilesSimpleInfo;)Landroid/os/Bundle;
    ...
    .line 19
    invoke-direct {p0}, Lcom/vkontakte/android/directshare/ImDirectShareService;->a()Landroid/service/chooser/ChooserTarget;
    ...
    .line 20
    :cond_2
    new-instance p1, Lcom/vkontakte/android/directshare/ImDirectShareService$a;

    invoke-direct {p1}, Lcom/vkontakte/android/directshare/ImDirectShareService$a;-><init>()V
