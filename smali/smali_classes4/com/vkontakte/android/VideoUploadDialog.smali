...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/VideoUploadDialog$a;
    }
.end annotation
...
.field public static final e:Lcom/vkontakte/android/VideoUploadDialog$a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/vkontakte/android/VideoUploadDialog$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/vkontakte/android/VideoUploadDialog$a;-><init>(Lkotlin/jvm/internal/i;)V

    sput-object v0, Lcom/vkontakte/android/VideoUploadDialog;->e:Lcom/vkontakte/android/VideoUploadDialog$a;
    ...
    sput v0, Lcom/vkontakte/android/VideoUploadDialog;->c:I
    ...
    sput v0, Lcom/vkontakte/android/VideoUploadDialog;->d:I
...
.method public static final a(Landroid/content/Context;ILandroid/net/Uri;)V
    ...
    invoke-virtual {v0, p0, p1, p2}, Lcom/vkontakte/android/VideoUploadDialog$a;->a(Landroid/content/Context;ILandroid/net/Uri;)V

    return-void
.end method

.method public static final synthetic a(Lcom/vkontakte/android/VideoUploadDialog;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/vkontakte/android/VideoUploadDialog;->u1()V
...
.method private final u1()V
    ...
    .line 3
    new-instance v1, Lcom/vkontakte/android/upload/l/r;
    ...
    .line 5
    sget-object v2, Lcom/vkontakte/android/VideoUploadDialog;->e:Lcom/vkontakte/android/VideoUploadDialog$a;

    iget-object v3, p0, Lcom/vkontakte/android/VideoUploadDialog;->a:Landroid/widget/EditText;

    const/4 v5, 0x0

    if-eqz v3, :cond_1

    invoke-static {v2, v3}, Lcom/vkontakte/android/VideoUploadDialog$a;->a(Lcom/vkontakte/android/VideoUploadDialog$a;Landroid/widget/EditText;)Ljava/lang/String;

    move-result-object v2

    .line 6
    sget-object v3, Lcom/vkontakte/android/VideoUploadDialog;->e:Lcom/vkontakte/android/VideoUploadDialog$a;

    iget-object v6, p0, Lcom/vkontakte/android/VideoUploadDialog;->b:Landroid/widget/EditText;

    if-eqz v6, :cond_0

    invoke-static {v3, v6}, Lcom/vkontakte/android/VideoUploadDialog$a;->a(Lcom/vkontakte/android/VideoUploadDialog$a;Landroid/widget/EditText;)Ljava/lang/String;
    ...
    .line 8
    invoke-direct/range {v3 .. v9}, Lcom/vkontakte/android/upload/l/r;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/vk/api/video/VideoSave$Target;IZ)V

    .line 9
    new-instance v2, Lcom/vkontakte/android/upload/UploadNotification$a;
    ...
    .line 11
    invoke-direct {v2, v3, v4, v0}, Lcom/vkontakte/android/upload/UploadNotification$a;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;)V

    invoke-static {v1, v2}, Lcom/vkontakte/android/upload/Upload;->a(Lcom/vkontakte/android/upload/j;Lcom/vkontakte/android/upload/UploadNotification$a;)Lcom/vkontakte/android/upload/UploadNotification$a;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 6
    sget v3, Lcom/vkontakte/android/VideoUploadDialog;->c:I
    ...
    .line 9
    sget v1, Lcom/vkontakte/android/VideoUploadDialog;->d:I
    ...
    .line 19
    sget v0, Lcom/vkontakte/android/VideoUploadDialog;->d:I
    ...
    .line 20
    iput-object v1, v8, Lcom/vkontakte/android/VideoUploadDialog;->a:Landroid/widget/EditText;

    .line 21
    iget-object v0, v8, Lcom/vkontakte/android/VideoUploadDialog;->a:Landroid/widget/EditText;
    ...
    .line 32
    sget v23, Lcom/vkontakte/android/VideoUploadDialog;->d:I
    ...
    .line 33
    iput-object v14, v8, Lcom/vkontakte/android/VideoUploadDialog;->b:Landroid/widget/EditText;

    .line 34
    iget-object v0, v8, Lcom/vkontakte/android/VideoUploadDialog;->b:Landroid/widget/EditText;
    ...
    .line 39
    new-instance v2, Lcom/vkontakte/android/VideoUploadDialog$d;

    invoke-direct {v2, v8}, Lcom/vkontakte/android/VideoUploadDialog$d;-><init>(Lcom/vkontakte/android/VideoUploadDialog;)V
    ...
    .line 42
    new-instance v1, Lcom/vkontakte/android/VideoUploadDialog$b;

    invoke-direct {v1, v8}, Lcom/vkontakte/android/VideoUploadDialog$b;-><init>(Lcom/vkontakte/android/VideoUploadDialog;)V
    ...
    .line 44
    iget-object v1, v8, Lcom/vkontakte/android/VideoUploadDialog;->a:Landroid/widget/EditText;

    if-eqz v1, :cond_1

    new-instance v2, Lcom/vkontakte/android/VideoUploadDialog$c;

    invoke-direct {v2, v0}, Lcom/vkontakte/android/VideoUploadDialog$c;-><init>(Landroidx/appcompat/app/AlertDialog;)V
...
.method protected onRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    .line 2
    iget-object v0, p0, Lcom/vkontakte/android/VideoUploadDialog;->a:Landroid/widget/EditText;
    ...
    .line 3
    iget-object v0, p0, Lcom/vkontakte/android/VideoUploadDialog;->b:Landroid/widget/EditText;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/vkontakte/android/VideoUploadDialog;->a:Landroid/widget/EditText;

    const/4 v2, 0x0

    if-eqz v1, :cond_1

    invoke-static {v0, v1}, Lcom/vkontakte/android/VideoUploadDialog$a;->a(Lcom/vkontakte/android/VideoUploadDialog$a;Landroid/widget/EditText;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/vkontakte/android/VideoUploadDialog;->b:Landroid/widget/EditText;
