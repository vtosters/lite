.class public final Lcom/vkontakte/android/bridges/CommonStoriesBridge;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/bridges/CommonStoriesBridge$c;
    }
.end annotation
...
.field public static final e:Lcom/vkontakte/android/bridges/CommonStoriesBridge;
...
.method static constructor <clinit>()V
    ...
    const-class v2, Lcom/vkontakte/android/bridges/CommonStoriesBridge;
    ...
    sput-object v0, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->a:[Lkotlin/u/j;

    .line 1
    new-instance v0, Lcom/vkontakte/android/bridges/CommonStoriesBridge;

    invoke-direct {v0}, Lcom/vkontakte/android/bridges/CommonStoriesBridge;-><init>()V

    sput-object v0, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->e:Lcom/vkontakte/android/bridges/CommonStoriesBridge;
    ...
    sput-object v0, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->b:Ljava/util/HashMap;
    ...
    sput-object v0, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->c:Ljava/util/concurrent/CopyOnWriteArraySet;

    .line 4
    sget-object v0, Lcom/vkontakte/android/bridges/CommonStoriesBridge$availableSections$2;->a:Lcom/vkontakte/android/bridges/CommonStoriesBridge$availableSections$2;

    invoke-static {v0}, Lkotlin/g;->a(Lkotlin/jvm/b/a;)Lkotlin/e;

    move-result-object v0

    sput-object v0, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->d:Lkotlin/e;
    ...
    .line 6
    sget-object v1, Lcom/vkontakte/android/bridges/CommonStoriesBridge$a;->a:Lcom/vkontakte/android/bridges/CommonStoriesBridge$a;
    ...
    .line 8
    sget-object v1, Lcom/vkontakte/android/bridges/CommonStoriesBridge$b;->a:Lcom/vkontakte/android/bridges/CommonStoriesBridge$b;
...
.method private final a()Ljava/util/List;
    ...
    sget-object v0, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->d:Lkotlin/e;

    sget-object v1, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->a:[Lkotlin/u/j;
...
.method public static final synthetic a(Lcom/vkontakte/android/bridges/CommonStoriesBridge;)Ljava/util/concurrent/CopyOnWriteArraySet;
    .locals 0

    .line 1
    sget-object p0, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->c:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method private final a(Ljava/lang/String;)Z
    ...
    .line 2
    sget-object v0, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->b:Ljava/util/HashMap;
    ...
    .line 4
    :cond_0
    invoke-direct {p0}, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->a()Ljava/util/List;
    ...
    .line 5
    sget-object v1, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->b:Ljava/util/HashMap;
...
.method public a(Landroid/content/Context;Landroid/view/View;ILjava/lang/String;)V
    ...
    .line 12
    invoke-direct {p0, p3}, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->a(I)Lcom/vk/dto/stories/model/StoriesContainer;
    ...
    .line 17
    new-instance v4, Lcom/vkontakte/android/bridges/CommonStoriesBridge$c;

    invoke-direct {v4, p2}, Lcom/vkontakte/android/bridges/CommonStoriesBridge$c;-><init>(Landroid/view/View;)V

    .line 18
    invoke-direct {p0, p4}, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->c(Ljava/lang/String;)Lcom/vk/stories/StoriesController$SourceType;

    move-result-object v5

    .line 19
    invoke-direct {p0, p4}, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public a(Landroid/content/Context;Landroid/view/View;Lcom/vk/dto/stories/model/StoryEntry;Lcom/vk/dto/stories/model/StoryOwner;ILjava/lang/String;)V
    ...
    .line 28
    invoke-direct {p0, p6}, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->c(Ljava/lang/String;)Lcom/vk/stories/StoriesController$SourceType;

    move-result-object v5

    .line 29
    invoke-direct {p0, p6}, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public a(Lcom/vk/bridges/f0;)V
    ...
    .line 33
    sget-object v0, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->c:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public a(ILjava/lang/String;)Z
    ...
    .line 10
    invoke-direct {p0, p2}, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->a(Ljava/lang/String;)Z
    ...
    .line 11
    :cond_0
    invoke-direct {p0, p1}, Lcom/vkontakte/android/bridges/CommonStoriesBridge;->a(I)Lcom/vk/dto/stories/model/StoriesContainer;
