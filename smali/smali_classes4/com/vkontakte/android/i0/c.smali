.class public Lcom/vkontakte/android/i0/c;
...
.method private static a(Lb/h/h/d/c;)Lb/h/h/d/c;
    ...
    .line 31
    invoke-static {p0}, Lcom/vkontakte/android/i0/c;->b(Lb/h/h/d/c;)V

    .line 32
    invoke-static {}, Lcom/vkontakte/android/i0/c;->a()Landroid/content/SharedPreferences;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/vkontakte/android/api/ApiWrapper;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v1}, Lcom/vkontakte/android/api/ApiWrapper;->a(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    return-object p0
.end method

.method public static declared-synchronized a(Lb/h/h/d/c;Lcom/vkontakte/android/api/execute/i$a;)V
    .locals 6
    .param p0    # Lb/h/h/d/c;
    ...
    const-class v0, Lcom/vkontakte/android/i0/c;
    ...
    :goto_1
    invoke-static {v1, v3, v4}, Lcom/vkontakte/android/i0/e;->a(ILjava/lang/String;Ljava/lang/String;)V

    .line 8
    :cond_2
    invoke-static {p0, p1}, Lcom/vk/auth/n;->a(Lb/h/h/d/c;Lcom/vkontakte/android/api/execute/i$a;)V

    .line 9
    invoke-static {p0}, Lcom/vkontakte/android/i0/c;->a(Lb/h/h/d/c;)Lb/h/h/d/c;

    sput-object p0, Lcom/vkontakte/android/i0/c;->a:Lb/h/h/d/c;
    ...
    .line 12
    invoke-static {p1, v2}, Lcom/vkontakte/android/i0/e;->a(Lcom/vkontakte/android/api/execute/i$a;Z)V
    ...
    .line 14
    iget-object p0, p1, Lcom/vkontakte/android/api/execute/i$a;->e:Lb/h/h/d/a;
...
.method public static a(Lcom/vkontakte/android/api/execute/i$a;Z)V
    .locals 3
    ...
    .line 24
    invoke-static {v0, p0}, Lcom/vk/auth/n;->a(Lb/h/h/d/c;Lcom/vkontakte/android/api/execute/i$a;)V
    ...
    .line 26
    iget-object v2, p0, Lcom/vkontakte/android/api/execute/i$a;->a:Lb/h/h/d/c;
    ...
    .line 29
    invoke-static {p0, p1}, Lcom/vkontakte/android/i0/e;->a(Lcom/vkontakte/android/api/execute/i$a;Z)V

    .line 30
    :cond_1
    iget-object p0, p0, Lcom/vkontakte/android/api/execute/i$a;->e:Lb/h/h/d/a;
...
.method static declared-synchronized b()Z
    ...
    .line 3
    invoke-static {v1}, Lcom/vkontakte/android/i0/c;->a(Lb/h/h/d/c;)Lb/h/h/d/c;

    sput-object v1, Lcom/vkontakte/android/i0/c;->a:Lb/h/h/d/c;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static d()Lb/h/h/d/c;
    ...
    .line 1
    sget-object v0, Lcom/vkontakte/android/i0/c;->a:Lb/h/h/d/c;
    ...
    .line 3
    :try_start_0
    sget-object v1, Lcom/vkontakte/android/i0/c;->a:Lb/h/h/d/c;

    if-nez v1, :cond_1

    .line 4
    invoke-static {}, Lcom/vkontakte/android/i0/c;->f()Lb/h/h/d/c;
