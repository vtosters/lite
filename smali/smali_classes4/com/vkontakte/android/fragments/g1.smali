.class public Lcom/vkontakte/android/fragments/g1;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/fragments/g1$b;
    }
.end annotation
...
# instance fields
.field private t0:Lcom/vkontakte/android/fragments/g1$b;
...
.method public static M(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-static {v0, v1, p0}, Lcom/vkontakte/android/utils/l;->b(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
...
.method public static a(Ljava/lang/String;I)Landroid/os/Bundle;
    ...
    .line 2
    invoke-static {p0}, Lcom/vkontakte/android/fragments/g1;->M(Ljava/lang/String;)Landroid/os/Bundle;
...
.method static synthetic a(Lcom/vkontakte/android/fragments/g1;)Ljava/util/ArrayList;
    .locals 0
...
.method static synthetic b(Lcom/vkontakte/android/fragments/g1;)Ljava/util/ArrayList;
    .locals 0
...
.method protected bridge synthetic Y4()Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/vkontakte/android/fragments/g1;->Y4()Lme/grishka/appkit/views/UsableRecyclerView$d;
...
.method protected Y4()Lme/grishka/appkit/views/UsableRecyclerView$d;
    ...
    .line 2
    iget-object v0, p0, Lcom/vkontakte/android/fragments/g1;->t0:Lcom/vkontakte/android/fragments/g1$b;

    if-nez v0, :cond_0

    .line 3
    new-instance v0, Lcom/vkontakte/android/fragments/g1$b;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/g1$b;-><init>(Lcom/vkontakte/android/fragments/g1;)V

    iput-object v0, p0, Lcom/vkontakte/android/fragments/g1;->t0:Lcom/vkontakte/android/fragments/g1$b;
...
.method protected h(II)V
    ...
    .line 1
    new-instance v0, Lcom/vkontakte/android/fragments/g1$a;

    invoke-direct {v0, p0, p0}, Lcom/vkontakte/android/fragments/g1$a;-><init>(Lcom/vkontakte/android/fragments/g1;Lcom/vk/core/fragments/FragmentImpl;)V
    ...
    :cond_0
    iget-object v3, p0, Lcom/vkontakte/android/fragments/g1;->u0:Ljava/lang/String;
