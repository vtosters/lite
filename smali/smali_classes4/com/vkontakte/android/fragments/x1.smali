.class public Lcom/vkontakte/android/fragments/x1;
.super Lcom/vkontakte/android/fragments/MaterialPreferenceFragment;
.source "SettingsAccountInnerFragment.java"


# instance fields
.field private R:Lcom/vkontakte/android/data/PurchasesManager;
...
.method private S4()Lcom/vkontakte/android/data/PurchasesManager;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    iget-object v0, p0, Lcom/vkontakte/android/fragments/x1;->R:Lcom/vkontakte/android/data/PurchasesManager;
    ...
    invoke-direct {v0, p0}, Lcom/vkontakte/android/data/PurchasesManager;-><init>(Lcom/vk/core/fragments/FragmentImpl;)V

    iput-object v0, p0, Lcom/vkontakte/android/fragments/x1;->R:Lcom/vkontakte/android/data/PurchasesManager;
...
.method private T4()V
    ...
    .line 3
    new-instance v1, Lcom/vk/api/store/m;

    const/4 v2, 0x1

    invoke-direct {v1, v2}, Lcom/vk/api/store/m;-><init>(I)V

    .line 4
    new-instance v2, Lcom/vkontakte/android/fragments/x1$b;

    invoke-direct {v2, p0, v0}, Lcom/vkontakte/android/fragments/x1$b;-><init>(Lcom/vkontakte/android/fragments/x1;Lb/h/g/k/a;)V
...
.method private U4()V
    ...
    iget-object v1, p0, Lcom/vkontakte/android/fragments/x1;->S:Lcom/vk/api/execute/ExecuteGetAccountSettings$Result;
    ...
    iget-object v4, p0, Lcom/vkontakte/android/fragments/x1;->S:Lcom/vk/api/execute/ExecuteGetAccountSettings$Result;
...
.method static synthetic a(Lcom/vkontakte/android/fragments/x1;)Lcom/vk/api/execute/ExecuteGetAccountSettings$Result;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/vkontakte/android/fragments/x1;->S:Lcom/vk/api/execute/ExecuteGetAccountSettings$Result;
...
.method private a(Landroidx/preference/Preference;)V
    ...
    .line 7
    iget-object v2, p0, Lcom/vkontakte/android/fragments/x1;->S:Lcom/vk/api/execute/ExecuteGetAccountSettings$Result;
    ...
    new-instance v6, Lcom/vkontakte/android/fragments/x1$d;

    invoke-direct {v6, p0}, Lcom/vkontakte/android/fragments/x1$d;-><init>(Lcom/vkontakte/android/fragments/x1;)V
    ...
    new-instance v0, Lcom/vkontakte/android/fragments/x1$c;

    invoke-direct {v0, p0, v1, v2, p1}, Lcom/vkontakte/android/fragments/x1$c;-><init>(Lcom/vkontakte/android/fragments/x1;Ljava/util/List;Ljava/lang/String;Landroidx/preference/Preference;)V
...
.method static synthetic a(Lcom/vkontakte/android/fragments/x1;Landroidx/preference/Preference;)V
    .locals 0

    .line 3
    invoke-direct {p0, p1}, Lcom/vkontakte/android/fragments/x1;->a(Landroidx/preference/Preference;)V

    return-void
.end method

.method static synthetic a(Lcom/vkontakte/android/fragments/x1;Ljava/lang/String;Ljava/lang/CharSequence;)V
    .locals 0

    .line 4
    invoke-direct {p0, p1, p2}, Lcom/vkontakte/android/fragments/x1;->a(Ljava/lang/String;Ljava/lang/CharSequence;)V

    return-void
.end method

.method static synthetic a(Lcom/vkontakte/android/fragments/x1;Z)V
    .locals 0

    .line 2
    invoke-direct {p0, p1}, Lcom/vkontakte/android/fragments/x1;->x0(Z)V
...
.method private a(Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    .line 20
    :cond_0
    new-instance v1, Lcom/vk/api/account/t;

    invoke-direct {v1, p1}, Lcom/vk/api/account/t;-><init>(Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/vkontakte/android/fragments/x1$e;

    invoke-direct {v2, p0, p2, v0}, Lcom/vkontakte/android/fragments/x1$e;-><init>(Lcom/vkontakte/android/fragments/x1;Ljava/lang/CharSequence;Landroid/content/Context;)V
...
.method static synthetic b(Lcom/vkontakte/android/fragments/x1;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/vkontakte/android/fragments/x1;->T4()V

    return-void
.end method

.method static synthetic c(Lcom/vkontakte/android/fragments/x1;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/vkontakte/android/fragments/x1;->V4()V

    return-void
.end method

.method static synthetic d(Lcom/vkontakte/android/fragments/x1;)Lcom/vkontakte/android/data/PurchasesManager;
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/vkontakte/android/fragments/x1;->S4()Lcom/vkontakte/android/data/PurchasesManager;
...
.method private x0(Z)V
    ...
    .line 2
    invoke-static {p1}, Lcom/vk/api/account/u;->c(Z)Lcom/vk/api/account/u;

    move-result-object v0

    new-instance v1, Lcom/vkontakte/android/fragments/x1$a;
    ...
    invoke-direct {v1, p0, v2, p1}, Lcom/vkontakte/android/fragments/x1$a;-><init>(Lcom/vkontakte/android/fragments/x1;Landroid/content/Context;Z)V
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-direct {p0, v1}, Lcom/vkontakte/android/fragments/x1;->p0(I)V
    ...
    .line 5
    iget-object v3, p0, Lcom/vkontakte/android/fragments/x1;->S:Lcom/vk/api/execute/ExecuteGetAccountSettings$Result;
    ...
    .line 14
    invoke-direct {p0}, Lcom/vkontakte/android/fragments/x1;->U4()V
    ...
    .line 15
    iget-object p1, p0, Lcom/vkontakte/android/fragments/x1;->S:Lcom/vk/api/execute/ExecuteGetAccountSettings$Result;
    ...
    iget-object p3, p0, Lcom/vkontakte/android/fragments/x1;->S:Lcom/vk/api/execute/ExecuteGetAccountSettings$Result;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/vkontakte/android/fragments/x1;->S:Lcom/vk/api/execute/ExecuteGetAccountSettings$Result;
    ...
    .line 5
    iget-object v0, p0, Lcom/vkontakte/android/fragments/x1;->S:Lcom/vk/api/execute/ExecuteGetAccountSettings$Result;
    ...
    .line 6
    new-instance v0, Lcom/vkontakte/android/fragments/x1$f;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/x1$f;-><init>(Lcom/vkontakte/android/fragments/x1;)V
    ...
    .line 9
    new-instance v0, Lcom/vkontakte/android/fragments/x1$g;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/x1$g;-><init>(Lcom/vkontakte/android/fragments/x1;)V
    ...
    .line 12
    new-instance v0, Lcom/vkontakte/android/fragments/x1$h;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/x1$h;-><init>(Lcom/vkontakte/android/fragments/x1;)V
    ...
    .line 14
    new-instance v0, Lcom/vkontakte/android/fragments/x1$i;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/x1$i;-><init>(Lcom/vkontakte/android/fragments/x1;)V
    ...
    .line 17
    new-instance v0, Lcom/vkontakte/android/fragments/x1$j;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/x1$j;-><init>(Lcom/vkontakte/android/fragments/x1;)V
    ...
    invoke-direct {p0, v0}, Lcom/vkontakte/android/fragments/x1;->p0(I)V

    .line 20
    new-instance v0, Lcom/vkontakte/android/fragments/x1$k;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/x1$k;-><init>(Lcom/vkontakte/android/fragments/x1;)V
    ...
    .line 26
    new-instance v0, Lcom/vkontakte/android/fragments/x1$l;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/x1$l;-><init>(Lcom/vkontakte/android/fragments/x1;)V
    ...
    .line 29
    new-instance v0, Lcom/vkontakte/android/fragments/x1$m;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/x1$m;-><init>(Lcom/vkontakte/android/fragments/x1;)V
    ...
    .line 32
    new-instance v0, Lcom/vkontakte/android/fragments/x1$n;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/x1$n;-><init>(Lcom/vkontakte/android/fragments/x1;)V
...
.method public onPause()V
    ...
    .line 7
    :cond_0
    invoke-static {v1}, Lcom/vk/api/account/u;->d(Z)Lcom/vk/api/account/u;
    ...
    .line 10
    invoke-static {v0}, Lcom/vk/api/account/u;->e(Z)Lcom/vk/api/account/u;
