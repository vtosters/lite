.class public Lcom/vkontakte/android/fragments/r1;
...
.field private P:Lcom/vkontakte/android/fragments/photos/e;

.field private Q:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;

.field private R:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;
...
.method public constructor <init>()V
    ...
    .line 2
    iput v0, p0, Lcom/vkontakte/android/fragments/r1;->S:I

    return-void
.end method

.method static synthetic a(Lcom/vkontakte/android/fragments/r1;)I
    .locals 0

    .line 1
    iget p0, p0, Lcom/vkontakte/android/fragments/r1;->O:I

    return p0
.end method

.method static synthetic a(Lcom/vkontakte/android/fragments/r1;Lcom/vkontakte/android/fragments/photos/PhotoListFragment;)Lcom/vkontakte/android/fragments/photos/PhotoListFragment;
    .locals 0

    .line 2
    iput-object p1, p0, Lcom/vkontakte/android/fragments/r1;->R:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;

    return-object p1
.end method

.method static synthetic b(Lcom/vkontakte/android/fragments/r1;)Lcom/vkontakte/android/fragments/photos/PhotoListFragment;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/vkontakte/android/fragments/r1;->R:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;
...
.method public P4()Z
    ...
    .line 1
    invoke-direct {p0}, Lcom/vkontakte/android/fragments/r1;->b5()Z
...
.method public Z4()Ljava/lang/CharSequence;
    ...
    .line 1
    iget v0, p0, Lcom/vkontakte/android/fragments/r1;->O:I
    ...
    .line 6
    new-instance v3, Lcom/vkontakte/android/ui/p;

    invoke-direct {v3}, Lcom/vkontakte/android/ui/p;-><init>()V
...
.method public a5()V
    ...
    .line 1
    iget v0, p0, Lcom/vkontakte/android/fragments/r1;->S:I

    if-ltz v0, :cond_0

    .line 2
    :try_start_0
    invoke-virtual {p0}, Lcom/vkontakte/android/fragments/r1;->Z4()Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Ld/a/a/a/k;->a(ILjava/lang/CharSequence;)V
    :try_end_0
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    iput v0, p0, Lcom/vkontakte/android/fragments/r1;->O:I
    ...
    iget v1, p0, Lcom/vkontakte/android/fragments/r1;->O:I
    ...
    .line 4
    iget p1, p0, Lcom/vkontakte/android/fragments/r1;->O:I
    ...
    .line 14
    iget v4, p0, Lcom/vkontakte/android/fragments/r1;->O:I

    iput v4, v3, Lcom/vk/dto/photo/PhotoAlbum;->b:I

    .line 15
    new-instance v4, Lcom/vkontakte/android/fragments/photos/h;

    invoke-direct {v4}, Lcom/vkontakte/android/fragments/photos/h;-><init>()V

    iput-object v4, p0, Lcom/vkontakte/android/fragments/r1;->Q:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;
    ...
    .line 20
    iget-object v6, p0, Lcom/vkontakte/android/fragments/r1;->Q:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;

    invoke-virtual {v6, v1}, Landroidx/fragment/app/Fragment;->setArguments(Landroid/os/Bundle;)V

    .line 21
    iget-object v1, p0, Lcom/vkontakte/android/fragments/r1;->Q:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;
    ...
    .line 24
    new-instance v6, Lcom/vkontakte/android/fragments/photos/e;

    invoke-direct {v6}, Lcom/vkontakte/android/fragments/photos/e;-><init>()V

    iput-object v6, p0, Lcom/vkontakte/android/fragments/r1;->P:Lcom/vkontakte/android/fragments/photos/e;

    .line 25
    iget v6, p0, Lcom/vkontakte/android/fragments/r1;->O:I
    ...
    .line 29
    iget-object v2, p0, Lcom/vkontakte/android/fragments/r1;->P:Lcom/vkontakte/android/fragments/photos/e;

    invoke-virtual {v2, v1}, Landroidx/fragment/app/Fragment;->setArguments(Landroid/os/Bundle;)V

    .line 30
    iget-object v1, p0, Lcom/vkontakte/android/fragments/r1;->P:Lcom/vkontakte/android/fragments/photos/e;
    ...
    .line 34
    new-instance v2, Lcom/vk/api/photos/u;

    invoke-direct {v2, v1, v8, v8}, Lcom/vk/api/photos/u;-><init>(III)V

    new-instance v1, Lcom/vkontakte/android/fragments/r1$a;

    invoke-direct {v1, p0, p1, v0}, Lcom/vkontakte/android/fragments/r1$a;-><init>(Lcom/vkontakte/android/fragments/r1;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    .line 39
    iget v2, p0, Lcom/vkontakte/android/fragments/r1;->O:I
    ...
    new-instance v1, Lcom/vkontakte/android/fragments/photos/f;

    invoke-direct {v1}, Lcom/vkontakte/android/fragments/photos/f;-><init>()V

    goto :goto_3

    :cond_5
    new-instance v1, Lcom/vkontakte/android/fragments/photos/PhotoListFragment;

    invoke-direct {v1}, Lcom/vkontakte/android/fragments/photos/PhotoListFragment;-><init>()V

    :goto_3
    iput-object v1, p0, Lcom/vkontakte/android/fragments/r1;->R:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;

    .line 47
    iget-object v1, p0, Lcom/vkontakte/android/fragments/r1;->R:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;
    ...
    iput v1, p0, Lcom/vkontakte/android/fragments/r1;->S:I
...
.method public onResume()V
    ...
    .line 2
    invoke-virtual {p0}, Lcom/vkontakte/android/fragments/r1;->a5()V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 5
    iget-object v0, p0, Lcom/vkontakte/android/fragments/r1;->Q:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;

    invoke-virtual {v0}, Lcom/vkontakte/android/fragments/photos/PhotoListFragment;->d5()V

    .line 6
    iget-object v0, p0, Lcom/vkontakte/android/fragments/r1;->R:Lcom/vkontakte/android/fragments/photos/PhotoListFragment;

    invoke-virtual {v0}, Lcom/vkontakte/android/fragments/photos/PhotoListFragment;->d5()V

    .line 7
    iget-object v0, p0, Lcom/vkontakte/android/fragments/r1;->P:Lcom/vkontakte/android/fragments/photos/e;

    invoke-virtual {v0}, Lcom/vkontakte/android/fragments/photos/e;->c5()V
    ...
    .line 13
    invoke-virtual {p0}, Ld/a/a/a/k;->W4()Lcom/google/android/material/tabs/TabLayout;
