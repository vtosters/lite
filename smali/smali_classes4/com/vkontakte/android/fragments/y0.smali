.class public abstract Lcom/vkontakte/android/fragments/y0;
.super Lcom/vk/newsfeed/EntriesListFragment;
.source "BaseNewsSearchFragment.java"

# interfaces
.implements Lcom/vk/newsfeed/contracts/m;


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/fragments/y0$b;
    }
.end annotation
...
.method public constructor <init>()V
    ...
    .line 2
    new-instance v0, Lcom/vkontakte/android/fragments/y0$a;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/fragments/y0$a;-><init>(Lcom/vkontakte/android/fragments/y0;)V

    iput-object v0, p0, Lcom/vkontakte/android/fragments/y0;->q0:Landroid/view/View$OnClickListener;
...
.method public b5()Lcom/vk/lists/i0;
    ...
    .line 1
    new-instance v0, Lcom/vk/search/b/b;

    invoke-direct {p0}, Lcom/vkontakte/android/fragments/y0;->L1()Z

    move-result v1

    invoke-direct {v0, v1}, Lcom/vk/search/b/b;-><init>(Z)V

    .line 2
    new-instance v1, Lcom/vk/search/b/d;
    ...
    check-cast v2, Lcom/vk/newsfeed/contracts/l;

    invoke-interface {v2}, Lcom/vk/newsfeed/contracts/l;->P()Lcom/vk/lists/o;
    ...
    invoke-interface {v2}, Lcom/vk/newsfeed/contracts/e;->getRef()Ljava/lang/String;

    move-result-object v6

    new-instance v7, Lcom/vkontakte/android/fragments/a;

    invoke-direct {v7, p0}, Lcom/vkontakte/android/fragments/a;-><init>(Lcom/vkontakte/android/fragments/y0;)V
...
.method public synthetic d5()Ljava/lang/String;
    ...
    check-cast v0, Lcom/vk/newsfeed/contracts/l;

    invoke-interface {v0}, Lcom/vk/newsfeed/contracts/l;->S()Ljava/lang/String;
...
.method public j(Ljava/util/List;)V
    ...
    .line 8
    iget-object v7, p0, Lcom/vkontakte/android/fragments/y0;->q0:Landroid/view/View$OnClickListener;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 5
    new-instance p3, Lcom/vkontakte/android/fragments/y0$b;

    const/4 v0, 0x0

    invoke-direct {p3, p0, v0}, Lcom/vkontakte/android/fragments/y0$b;-><init>(Lcom/vkontakte/android/fragments/y0;Lcom/vkontakte/android/fragments/y0$a;)V
