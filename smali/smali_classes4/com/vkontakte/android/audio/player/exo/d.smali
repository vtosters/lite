...
.field private o:Lcom/vkontakte/android/audio/player/exo/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vkontakte/android/audio/player/exo/d;->p:Ljava/util/concurrent/atomic/AtomicReference;
...
.method constructor <init>(Lokhttp3/e$a;Ljava/lang/String;Lcom/google/android/exoplayer2/util/x;Lcom/google/android/exoplayer2/upstream/f0;Lokhttp3/d;)V
    ...
    iput-object v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->o:Lcom/vkontakte/android/audio/player/exo/a;
    ...
    iput-object p1, p0, Lcom/vkontakte/android/audio/player/exo/d;->a:Lokhttp3/e$a;

    .line 4
    invoke-static {p2}, Lcom/google/android/exoplayer2/util/e;->a(Ljava/lang/String;)Ljava/lang/String;

    iput-object p2, p0, Lcom/vkontakte/android/audio/player/exo/d;->b:Ljava/lang/String;

    .line 5
    iput-object p3, p0, Lcom/vkontakte/android/audio/player/exo/d;->c:Lcom/google/android/exoplayer2/util/x;

    .line 6
    iput-object p4, p0, Lcom/vkontakte/android/audio/player/exo/d;->d:Lcom/google/android/exoplayer2/upstream/f0;

    .line 7
    iput-object p5, p0, Lcom/vkontakte/android/audio/player/exo/d;->e:Lokhttp3/d;
    ...
    iput-object p1, p0, Lcom/vkontakte/android/audio/player/exo/d;->f:Ljava/util/HashMap;
...
.method private a([BII)I
    ...
    .line 32
    :cond_0
    iget-wide v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->l:J
    ...
    .line 33
    iget-wide v5, p0, Lcom/vkontakte/android/audio/player/exo/d;->n:J
    ...
    .line 35
    :cond_2
    iget-object v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->i:Ljava/io/InputStream;
    ...
    .line 36
    iget-object v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->o:Lcom/vkontakte/android/audio/player/exo/a;
    ...
    .line 37
    iget-wide p1, p0, Lcom/vkontakte/android/audio/player/exo/d;->l:J
    ...
    iput-wide p1, p0, Lcom/vkontakte/android/audio/player/exo/d;->n:J

    .line 40
    iget-object p1, p0, Lcom/vkontakte/android/audio/player/exo/d;->d:Lcom/google/android/exoplayer2/upstream/f0;

    if-eqz p1, :cond_5

    .line 41
    iget-object p2, p0, Lcom/vkontakte/android/audio/player/exo/d;->g:Lcom/google/android/exoplayer2/upstream/n;
...
.method private b(Lcom/google/android/exoplayer2/upstream/n;)Lokhttp3/z;
    ...
    invoke-static {v4}, Lcom/vkontakte/android/audio/player/exo/a;->a(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/vkontakte/android/audio/player/exo/a;->b(Landroid/net/Uri;)Ljava/lang/String;
    ...
    .line 11
    iget-object v4, p0, Lcom/vkontakte/android/audio/player/exo/d;->e:Lokhttp3/d;
    ...
    .line 13
    :cond_2
    iget-object v4, p0, Lcom/vkontakte/android/audio/player/exo/d;->f:Ljava/util/HashMap;

    monitor-enter v4

    .line 14
    :try_start_1
    iget-object v7, p0, Lcom/vkontakte/android/audio/player/exo/d;->f:Ljava/util/HashMap;
    ...
    .line 20
    :cond_6
    iget-object v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->b:Ljava/lang/String;
...
.method private c()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->h:Lokhttp3/b0;
    ...
    .line 5
    iput-object v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->h:Lokhttp3/b0;

    .line 6
    iput-object v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->i:Ljava/io/InputStream;
...
.method private d()V
    ...
    .line 1
    iget-wide v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->m:J

    iget-wide v2, p0, Lcom/vkontakte/android/audio/player/exo/d;->k:J
    ...
    .line 2
    :cond_0
    sget-object v0, Lcom/vkontakte/android/audio/player/exo/d;->p:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-wide v3, p0, Lcom/vkontakte/android/audio/player/exo/d;->k:J
    ...
    .line 5
    iget-object v1, p0, Lcom/vkontakte/android/audio/player/exo/d;->i:Ljava/io/InputStream;
    ...
    .line 6
    iget-object v2, p0, Lcom/vkontakte/android/audio/player/exo/d;->o:Lcom/vkontakte/android/audio/player/exo/a;
    ...
    iput-wide v2, p0, Lcom/vkontakte/android/audio/player/exo/d;->m:J

    .line 9
    iget-object v2, p0, Lcom/vkontakte/android/audio/player/exo/d;->d:Lcom/google/android/exoplayer2/upstream/f0;

    if-eqz v2, :cond_1

    .line 10
    iget-object v3, p0, Lcom/vkontakte/android/audio/player/exo/d;->g:Lcom/google/android/exoplayer2/upstream/n;
    ...
    .line 13
    :cond_4
    sget-object v1, Lcom/vkontakte/android/audio/player/exo/d;->p:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public a(Lcom/google/android/exoplayer2/upstream/n;)J
    ...
    .line 3
    iput-object p1, p0, Lcom/vkontakte/android/audio/player/exo/d;->g:Lcom/google/android/exoplayer2/upstream/n;
    ...
    .line 6
    invoke-direct {p0, p1}, Lcom/vkontakte/android/audio/player/exo/d;->b(Lcom/google/android/exoplayer2/upstream/n;)Lokhttp3/z;
    ...
    .line 7
    :try_start_0
    iget-object v4, p0, Lcom/vkontakte/android/audio/player/exo/d;->a:Lokhttp3/e$a;
    ...
    iput-object v4, p0, Lcom/vkontakte/android/audio/player/exo/d;->h:Lokhttp3/b0;

    .line 8
    iget-object v4, p0, Lcom/vkontakte/android/audio/player/exo/d;->h:Lokhttp3/b0;
    ...
    iput-object v4, p0, Lcom/vkontakte/android/audio/player/exo/d;->i:Ljava/io/InputStream;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 10
    iget-object v5, p0, Lcom/vkontakte/android/audio/player/exo/d;->h:Lokhttp3/b0;
    ...
    .line 16
    :cond_1
    iget-object v2, p0, Lcom/vkontakte/android/audio/player/exo/d;->h:Lokhttp3/b0;
    ...
    .line 18
    :goto_0
    iget-object v5, p0, Lcom/vkontakte/android/audio/player/exo/d;->c:Lcom/google/android/exoplayer2/util/x;
    ...
    :cond_5
    iput-wide v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->k:J
    ...
    .line 23
    iput-wide v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->l:J
    ...
    .line 25
    iget-wide v4, p0, Lcom/vkontakte/android/audio/player/exo/d;->k:J

    sub-long v4, v0, v4

    :cond_7
    iput-wide v4, p0, Lcom/vkontakte/android/audio/player/exo/d;->l:J

    .line 26
    :goto_2
    iput-boolean v3, p0, Lcom/vkontakte/android/audio/player/exo/d;->j:Z

    .line 27
    iget-object v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->d:Lcom/google/android/exoplayer2/upstream/f0;
    ...
    iget-wide v1, p0, Lcom/vkontakte/android/audio/player/exo/d;->l:J

    invoke-virtual {v0, p1, v1, v2}, Lcom/vkontakte/android/audio/player/exo/a;->a(Lcom/google/android/exoplayer2/upstream/n;J)V
...
.method public a(Lcom/google/android/exoplayer2/upstream/f0;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/vkontakte/android/audio/player/exo/d;->d:Lcom/google/android/exoplayer2/upstream/f0;
...
.method public close()V
    ...
    .line 2
    iget-boolean v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->j:Z
    ...
    .line 3
    iput-boolean v0, p0, Lcom/vkontakte/android/audio/player/exo/d;->j:Z
    ...
    .line 5
    iget-object v1, p0, Lcom/vkontakte/android/audio/player/exo/d;->g:Lcom/google/android/exoplayer2/upstream/n;
...
.method public read([BII)I
    ...
    .line 2
    invoke-direct {p0, p1, p2, p3}, Lcom/vkontakte/android/audio/player/exo/d;->a([BII)I
    ...
    iget-object p3, p0, Lcom/vkontakte/android/audio/player/exo/d;->g:Lcom/google/android/exoplayer2/upstream/n;
