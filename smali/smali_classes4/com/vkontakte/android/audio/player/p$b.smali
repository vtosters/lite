.class Lcom/vkontakte/android/audio/player/p$b;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/vkontakte/android/audio/player/p;->g()V
.end annotation
...
# instance fields
.field final synthetic a:Lcom/vkontakte/android/audio/player/p;


# direct methods
.method constructor <init>(Lcom/vkontakte/android/audio/player/p;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/vkontakte/android/audio/player/p$b;->a:Lcom/vkontakte/android/audio/player/p;
...
.method private a(Lcom/google/android/exoplayer2/ExoPlaybackException;)V
    ...
    .line 2
    iget-object v2, p0, Lcom/vkontakte/android/audio/player/p$b;->a:Lcom/vkontakte/android/audio/player/p;

    invoke-static {v2}, Lcom/vkontakte/android/audio/player/p;->h(Lcom/vkontakte/android/audio/player/p;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/vkontakte/android/audio/player/p$b;->a:Lcom/vkontakte/android/audio/player/p;

    invoke-static {v1}, Lcom/vkontakte/android/audio/player/p;->i(Lcom/vkontakte/android/audio/player/p;)Lcom/vk/music/common/MusicPlaybackLaunchContext;
    ...
    .line 3
    iget-object v6, p0, Lcom/vkontakte/android/audio/player/p$b;->a:Lcom/vkontakte/android/audio/player/p;

    invoke-static {v6}, Lcom/vkontakte/android/audio/player/p;->h(Lcom/vkontakte/android/audio/player/p;)Ljava/lang/String;
...
.method public onPlayerError(Lcom/google/android/exoplayer2/ExoPlaybackException;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/vkontakte/android/audio/player/p$b;->a(Lcom/google/android/exoplayer2/ExoPlaybackException;)V

    .line 2
    iget-object p1, p0, Lcom/vkontakte/android/audio/player/p$b;->a:Lcom/vkontakte/android/audio/player/p;

    invoke-static {p1}, Lcom/vkontakte/android/audio/player/p;->g(Lcom/vkontakte/android/audio/player/p;)Z
    ...
    invoke-virtual {p1}, Lcom/vkontakte/android/audio/player/p;->stop()V

    .line 4
    :cond_0
    iget-object p1, p0, Lcom/vkontakte/android/audio/player/p$b;->a:Lcom/vkontakte/android/audio/player/p;

    invoke-static {p1}, Lcom/vkontakte/android/audio/player/p;->b(Lcom/vkontakte/android/audio/player/p;)Lcom/vkontakte/android/audio/player/MediaPlayerHelperI$MediaPlayerHelperListener;

    move-result-object p1

    iget-object v0, p0, Lcom/vkontakte/android/audio/player/p$b;->a:Lcom/vkontakte/android/audio/player/p;
...
.method public onPlayerStateChanged(ZI)V
    ...
    invoke-static {v0}, Lcom/vkontakte/android/audio/player/p;->a(Lcom/vkontakte/android/audio/player/p;)Lcom/google/android/exoplayer2/o0;
    ...
    invoke-direct {p0, p2}, Lcom/vkontakte/android/audio/player/p$b;->a(I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/vkontakte/android/audio/player/p;->c(Lcom/vkontakte/android/audio/player/p;)Z
    ...
    invoke-static {p1, v2}, Lcom/vkontakte/android/audio/player/p;->a(Lcom/vkontakte/android/audio/player/p;Z)Z

    .line 7
    iget-object p1, p0, Lcom/vkontakte/android/audio/player/p$b;->a:Lcom/vkontakte/android/audio/player/p;

    invoke-static {p1}, Lcom/vkontakte/android/audio/player/p;->d(Lcom/vkontakte/android/audio/player/p;)Lcom/vk/music/player/PlayState;
    ...
    invoke-static {p1}, Lcom/vkontakte/android/audio/player/p;->e(Lcom/vkontakte/android/audio/player/p;)Z
    ...
    invoke-static {p1}, Lcom/vkontakte/android/audio/player/p;->a(Lcom/vkontakte/android/audio/player/p;)Lcom/google/android/exoplayer2/o0;
    ...
    invoke-static {p1}, Lcom/vkontakte/android/audio/player/p;->f(Lcom/vkontakte/android/audio/player/p;)V
    ...
    iget-object p2, p0, Lcom/vkontakte/android/audio/player/p$b;->a:Lcom/vkontakte/android/audio/player/p;

    invoke-static {p2}, Lcom/vkontakte/android/audio/player/p;->a(Lcom/vkontakte/android/audio/player/p;)Lcom/google/android/exoplayer2/o0;
    ...
    invoke-interface {p1, p2, v1}, Lcom/vkontakte/android/audio/player/MediaPlayerHelperI$MediaPlayerHelperListener;->a(Lcom/vkontakte/android/audio/player/MediaPlayerHelperI;I)V
