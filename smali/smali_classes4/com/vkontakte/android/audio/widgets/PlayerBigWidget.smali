.class public Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;
.super Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;
.source "PlayerBigWidget.java"


# static fields
.field private static c:Lio/reactivex/disposables/b; = null
...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;-><init>()V
...
.method public static a(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    .line 9
    :goto_1
    invoke-static {v5}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->a(Lcom/vk/music/player/d;)Z
    ...
    invoke-virtual {v6, v9}, Lcom/vk/music/player/e;->a([Lcom/vk/music/player/PlayerAction;)Z
    ...
    invoke-virtual {v6, v1}, Lcom/vk/music/player/e;->a([Lcom/vk/music/player/PlayerAction;)Z
    ...
    .line 15
    invoke-static {v0, v13}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/app/PendingIntent;

    move-result-object v18

    .line 16
    invoke-static {v0, v13}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->b(Landroid/content/Context;Ljava/lang/String;)Landroid/app/PendingIntent;

    move-result-object v12

    .line 17
    invoke-static {v0, v13}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->c(Landroid/content/Context;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    .line 20
    invoke-virtual {v6, v15}, Lcom/vk/music/player/e;->a([Lcom/vk/music/player/PlayerAction;)Z
    ...
    invoke-virtual {v3, v0, v12}, Lcom/vk/music/n/e;->a(Landroid/content/Context;Z)Landroid/content/Intent;

    move-result-object v12

    invoke-static {v0, v12, v13}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v3, v0}, Lcom/vk/music/n/e;->c(Landroid/content/Context;)Landroid/content/Intent;
    ...
    invoke-virtual {v3, v0}, Lcom/vk/music/n/e;->f(Landroid/content/Context;)Landroid/content/Intent;
    ...
    .line 29
    invoke-virtual {v3, v0, v11}, Lcom/vk/music/n/e;->b(Landroid/content/Context;Z)Landroid/content/Intent;

    move-result-object v15

    invoke-static {v0, v15, v13}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    .line 33
    invoke-virtual {v3, v0, v8}, Lcom/vk/music/n/e;->a(Landroid/content/Context;Lcom/vk/music/player/LoopMode;)Landroid/content/Intent;

    move-result-object v2

    invoke-static {v0, v2, v13}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v6}, Lcom/vk/music/player/e;->m()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v3, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v6}, Lcom/vk/music/player/e;->l()Ljava/lang/String;
    ...
    .line 36
    invoke-virtual {v6}, Lcom/vk/music/player/e;->b()Ljava/lang/CharSequence;
    ...
    .line 39
    sget-object v2, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->c:Lio/reactivex/disposables/b;
    ...
    .line 41
    invoke-static {v4}, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->a(Landroid/widget/RemoteViews;)V

    goto :goto_15

    .line 42
    :cond_15
    sget v2, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->d:I
    ...
    sput v2, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->d:I
    ...
    sput v2, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->e:I
    ...
    invoke-static {v10, v2}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->a(Lcom/vk/dto/music/MusicTrack;F)Lc/a/m;

    move-result-object v2

    sget-object v3, Lcom/vkontakte/android/audio/widgets/a;->a:Lcom/vkontakte/android/audio/widgets/a;

    .line 46
    invoke-virtual {v2, v3}, Lc/a/m;->b(Lc/a/z/a;)Lc/a/m;

    move-result-object v2

    new-instance v3, Lcom/vkontakte/android/audio/widgets/b;

    invoke-direct {v3, v4}, Lcom/vkontakte/android/audio/widgets/b;-><init>(Landroid/widget/RemoteViews;)V

    new-instance v6, Lcom/vkontakte/android/audio/widgets/c;

    invoke-direct {v6, v4}, Lcom/vkontakte/android/audio/widgets/c;-><init>(Landroid/widget/RemoteViews;)V
    ...
    sput-object v2, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->c:Lio/reactivex/disposables/b;
    ...
    .line 58
    invoke-static {v0, v1, v2}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->a(Landroid/content/Context;II)Landroid/graphics/Bitmap;
    ...
    .line 62
    :goto_26
    sget-object v1, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget$a;->a:[I
    ...
    .line 67
    invoke-static {v0, v1, v3}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->a(Landroid/content/Context;II)Landroid/graphics/Bitmap;
    ...
    const-class v2, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;
...
.method static synthetic a(Landroid/widget/RemoteViews;Landroid/graphics/Bitmap;)V
    ...
    .line 92
    sget v0, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->d:I

    sget v1, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->e:I

    invoke-static {p1, v0, v1}, Lcom/vkontakte/android/audio/widgets/AudioPlayerWidget;->a(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method static synthetic a(Landroid/widget/RemoteViews;Ljava/lang/Throwable;)V
    ...
    .line 96
    invoke-static {p0}, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->a(Landroid/widget/RemoteViews;)V
...
.method static synthetic b()V
    ...
    .line 1
    sput-object v0, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->c:Lio/reactivex/disposables/b;
...
.method public onUpdate(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    .line 1
    invoke-static {p1, p2, p3}, Lcom/vkontakte/android/audio/widgets/PlayerBigWidget;->a(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
