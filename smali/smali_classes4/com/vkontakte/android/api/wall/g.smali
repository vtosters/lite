.class public Lcom/vkontakte/android/api/wall/g;
...
.method public constructor <init>(IIIIIZLjava/lang/String;ZLjava/lang/String;)V
    ...
    .line 6
    invoke-virtual {p0, p4, p5}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    .line 11
    invoke-virtual {p0, p2, p7}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    .line 12
    invoke-virtual {p0, p4, p2}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    .line 14
    invoke-virtual {p0, p2, p9}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    .line 16
    iput-boolean p8, p0, Lcom/vkontakte/android/api/wall/g;->F:Z

    .line 17
    iput p3, p0, Lcom/vkontakte/android/api/wall/g;->G:I
...
.method public a(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/wall/a;
    ...
    .line 10
    new-instance v9, Lcom/vkontakte/android/api/wall/a;

    invoke-direct {v9}, Lcom/vkontakte/android/api/wall/a;-><init>()V
    ...
    iput v10, v9, Lcom/vkontakte/android/api/wall/a;->i:I
    ...
    iput v10, v9, Lcom/vkontakte/android/api/wall/a;->j:I
    ...
    iput v10, v9, Lcom/vkontakte/android/api/wall/a;->k:I
    ...
    :goto_0
    iput-boolean v10, v9, Lcom/vkontakte/android/api/wall/a;->l:Z
    ...
    iput-object v10, v9, Lcom/vkontakte/android/api/wall/a;->h:Ljava/util/List;
    ...
    iput-object p1, v9, Lcom/vkontakte/android/api/wall/a;->a:Lcom/vk/dto/common/data/VKList;
    ...
    iput p1, v9, Lcom/vkontakte/android/api/wall/a;->b:I
    ...
    new-instance v5, Lcom/vkontakte/android/api/wall/g$a;

    invoke-direct {v5, p0, v2, v3}, Lcom/vkontakte/android/api/wall/g$a;-><init>(Lcom/vkontakte/android/api/wall/g;Landroid/util/SparseArray;Landroid/util/SparseArray;)V

    invoke-direct {p1, v4, v5}, Lcom/vk/dto/common/data/VKList;-><init>(Lorg/json/JSONObject;Lcom/vk/dto/common/data/c;)V

    iput-object p1, v9, Lcom/vkontakte/android/api/wall/a;->a:Lcom/vk/dto/common/data/VKList;

    .line 32
    iget-boolean p1, p0, Lcom/vkontakte/android/api/wall/g;->F:Z

    if-eqz p1, :cond_6

    .line 33
    iget-object p1, v9, Lcom/vkontakte/android/api/wall/a;->a:Lcom/vk/dto/common/data/VKList;
    ...
    .line 34
    iget v2, p0, Lcom/vkontakte/android/api/wall/g;->G:I

    invoke-virtual {v4, p1, v2}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I

    move-result p1

    iput p1, v9, Lcom/vkontakte/android/api/wall/a;->c:I

    .line 35
    iget p1, v9, Lcom/vkontakte/android/api/wall/a;->c:I

    if-gez p1, :cond_7

    .line 36
    iput v0, v9, Lcom/vkontakte/android/api/wall/a;->c:I
    :try_end_0
...
.method public bridge synthetic a(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/api/wall/g;->a(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/wall/a;
...
.method public b(I)Lcom/vkontakte/android/api/wall/g;
    .locals 1
...
.method public c(I)Lcom/vkontakte/android/api/wall/g;
    .locals 1
