...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->K:[Ljava/lang/String;
...
.method public constructor <init>(Ljava/lang/String;IILjava/lang/String;Ljava/lang/Boolean;IIIIZLjava/lang/String;Lorg/json/JSONObject;)V
    ...
    .line 2
    invoke-direct {p0, v6}, Lcom/vk/api/base/d;-><init>(Ljava/lang/String;)V
    ...
    iput-wide v6, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->G:J

    move-object/from16 v6, p11

    .line 4
    iput-object v6, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->H:Ljava/lang/String;

    .line 5
    iput-object v1, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->F:Ljava/lang/String;

    .line 6
    iput v2, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->J:I
    ...
    .line 7
    invoke-virtual {p0, v6, v7}, Lcom/vk/api/base/d;->b(Ljava/lang/String;I)Lcom/vk/api/base/d;
    ...
    invoke-virtual {p0, v7, v6}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    .line 11
    invoke-virtual {p0, v6, p1}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    .line 12
    invoke-virtual {p0, v7, v6}, Lcom/vk/api/base/d;->b(Ljava/lang/String;I)Lcom/vk/api/base/d;
    ...
    .line 13
    invoke-virtual {p0, v7, p2}, Lcom/vk/api/base/d;->b(Ljava/lang/String;I)Lcom/vk/api/base/d;
    ...
    .line 14
    invoke-virtual {p0, v7, v8}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    .line 16
    :cond_1
    invoke-virtual {p0, v8, v6}, Lcom/vk/api/base/d;->b(Ljava/lang/String;I)Lcom/vk/api/base/d;
    ...
    .line 17
    invoke-virtual {p0, v9, v7}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    sget-object v12, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->K:[Ljava/lang/String;
    ...
    .line 24
    invoke-static {v12}, Lcom/vkontakte/android/utils/l;->b([Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    invoke-virtual {p0, v8, v11}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    invoke-virtual {p0, v11, v7}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;

    .line 28
    invoke-virtual {p0, v8, v10}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    .line 29
    invoke-virtual {p0, v8, v7}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;

    goto :goto_2

    .line 30
    :cond_7
    invoke-virtual {p0, v11, v10}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    invoke-virtual {v1}, Lcom/vk/newsfeed/controllers/a;->l()Z
    ...
    invoke-virtual {p0, v1, v7}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    invoke-virtual {p0, v7, v1}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    invoke-virtual {p0, v4, v1}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    .line 44
    invoke-virtual {p0, v1, v6}, Lcom/vk/api/base/d;->b(Ljava/lang/String;I)Lcom/vk/api/base/d;

    .line 45
    :cond_13
    iput-object v3, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->I:Ljava/lang/String;
    ...
    .line 46
    invoke-virtual {p0, v1, v3}, Lcom/vk/api/base/d;->c(Ljava/lang/String;Ljava/lang/String;)Lcom/vk/api/base/d;
    ...
    invoke-virtual {p0, v2, v1}, Lcom/vk/api/base/d;->a(Ljava/lang/String;Z)Lcom/vk/api/base/d;
...
.method private b(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;
    .locals 10
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    .line 39
    :try_start_1
    iget-object v3, p0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->H:Ljava/lang/String;
...
.method private c(Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;Lorg/json/JSONObject;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;
    ...
    invoke-direct {p1, v1}, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;-><init>(Ljava/lang/String;)V
...
.method private d(Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;Lorg/json/JSONObject;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;
    ...
    iput-object v1, p1, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;->stories:Lcom/vk/dto/stories/model/GetStoriesResponse;
    :try_end_0
...
.method public a(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;
    ...
    .line 10
    invoke-direct {p0, v4}, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->b(Lorg/json/JSONObject;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;

    move-result-object v0

    .line 11
    invoke-virtual {p0, v0, v4}, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->b(Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;Lorg/json/JSONObject;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;

    move-result-object v0

    .line 12
    invoke-virtual {p0, v0, v4}, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->a(Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;Lorg/json/JSONObject;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;

    move-result-object v0

    .line 13
    invoke-direct {p0, v0, v4}, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->c(Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;Lorg/json/JSONObject;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;

    move-result-object v0

    .line 14
    invoke-direct {p0, v0, v4}, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->d(Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;Lorg/json/JSONObject;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
    ...
    iput-object v1, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;->situationalSuggest:Lcom/vk/dto/newsfeed/SituationalSuggest;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .line 16
    :try_start_2
    iput-object v2, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;->situationalSuggest:Lcom/vk/dto/newsfeed/SituationalSuggest;
    ...
    invoke-virtual {v1, v3}, Lcom/vk/newsfeed/controllers/a;->b(Z)V

    if-eqz v0, :cond_1

    .line 19
    iget-wide v4, p0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->G:J

    iput-wide v4, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;->requestedAt:J

    .line 20
    iget-object v1, p0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->F:Ljava/lang/String;

    iput-object v1, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;->startFrom:Ljava/lang/String;

    .line 21
    iget v1, p0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->J:I

    iput v1, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;->reqListId:I

    .line 22
    iget-object v1, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;->history:Ljava/util/List;

    iget-object v6, p0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->F:Ljava/lang/String;

    invoke-virtual {v0}, Lcom/vk/dto/common/data/VKFromList;->a()Ljava/lang/String;

    move-result-object v7

    iget-wide v8, p0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->G:J

    iget-wide v10, v0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;->createdAt:J
...
.method public b(Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;Lorg/json/JSONObject;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;
    ...
    iput-object v1, p1, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;->lists:Ljava/util/List;
    ...
    .line 10
    :cond_4
    iget-object v6, p1, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet$Response;->lists:Ljava/util/List;

    new-instance v7, Lcom/vkontakte/android/NewsfeedList;

    const/4 v8, -0x3

    invoke-direct {v7, v8, v5}, Lcom/vkontakte/android/NewsfeedList;-><init>(ILjava/lang/String;)V
    ...
    .line 23
    iget-object v2, p0, Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;->I:Ljava/lang/String;
    ...
    new-instance v2, Lcom/vkontakte/android/NewsfeedList;

    invoke-direct {v2, v0}, Lcom/vkontakte/android/NewsfeedList;-><init>(Lorg/json/JSONObject;)V
...
.method public d(Ljava/lang/String;)Lcom/vkontakte/android/api/newsfeed/NewsfeedGet;
    .locals 1
