...
# instance fields
.field private a:Lcom/vtosters/lite/audio/player/d0/LockFile;
...
.field private c:Lcom/vtosters/lite/audio/player/d0/FileInfo;
...
.method private static a(Ljava/io/File;)Lcom/vtosters/lite/audio/player/d0/FileInfo;
    .locals 3
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method private static a(Ljava/io/File;J)Lcom/vtosters/lite/audio/player/d0/FileInfo;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    .line 47
    invoke-static {p0}, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->a(Ljava/io/File;)Lcom/vtosters/lite/audio/player/d0/FileInfo;
    ...
    .line 50
    invoke-virtual {v0, p1, p2}, Lcom/vtosters/lite/audio/player/d0/FileInfo;->a(J)V

    const-string p0, ""

    .line 51
    invoke-virtual {v0, p0}, Lcom/vtosters/lite/audio/player/d0/FileInfo;->a(Ljava/lang/String;)V

    .line 52
    invoke-virtual {v0}, Lcom/vtosters/lite/audio/player/d0/FileInfo;->c()V
    :try_end_0
...
.method public declared-synchronized a()V
    ...
    .line 37
    :try_start_2
    iget-object v1, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->c:Lcom/vtosters/lite/audio/player/d0/FileInfo;
    ...
    invoke-virtual {v1}, Lcom/vtosters/lite/audio/player/d0/FileInfo;->c()V
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0
    ...
    :cond_1
    :goto_0
    iget-object v1, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->a:Lcom/vtosters/lite/audio/player/d0/LockFile;
    ...
    invoke-virtual {v1}, Lcom/vtosters/lite/audio/player/d0/LockFile;->b()V

    .line 42
    iput-object v0, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->a:Lcom/vtosters/lite/audio/player/d0/LockFile;
...
.method public declared-synchronized a(Lcom/google/android/exoplayer2/upstream/n;J)V
    ...
    iput-wide v1, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->b:J

    .line 12
    invoke-static {v0}, Lcom/vtosters/lite/audio/player/CacheUtils;->b(Ljava/lang/String;)Ljava/io/File;

    move-result-object p1

    .line 13
    invoke-static {p1}, Lcom/vtosters/lite/audio/player/d0/LockFile;->a(Ljava/io/File;)Lcom/vtosters/lite/audio/player/d0/LockFile;
    ...
    .line 14
    invoke-static {p1, p2, p3}, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->a(Ljava/io/File;J)Lcom/vtosters/lite/audio/player/d0/FileInfo;

    move-result-object p2

    iput-object p2, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->c:Lcom/vtosters/lite/audio/player/d0/FileInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 16
    iget-wide v0, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->b:J
    ...
    .line 20
    :try_start_3
    iput-boolean p1, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->f:Z
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method public a([BII)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->c:Lcom/vtosters/lite/audio/player/d0/FileInfo;
    ...
    invoke-static {p1, p3, v0, v1}, Lcom/vtosters/lite/audio/utils/Utils;->a([BIJ)V
    ...
    .line 27
    iget-object p1, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->c:Lcom/vtosters/lite/audio/player/d0/FileInfo;
    ...
    invoke-virtual {p1, v0, v1, v2, v3}, Lcom/vtosters/lite/audio/player/d0/FileInfo;->a(JJ)V
    ...
    iget-wide v0, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->e:J
    ...
    invoke-virtual {p1}, Lcom/vtosters/lite/audio/player/d0/FileInfo;->c()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-wide p1, p0, Lcom/vtosters/lite/audio/player/exo/AudioCacheHelper;->b:J
