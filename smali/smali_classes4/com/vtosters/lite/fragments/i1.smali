.class public Lcom/vtosters/lite/fragments/i1;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vtosters/lite/fragments/i1$c;,
        Lcom/vtosters/lite/fragments/i1$d;
    }
.end annotation
...
.method public constructor <init>()V
    ...
    .line 2
    new-instance v0, Lcom/vtosters/lite/fragments/i1$a;

    invoke-direct {v0, p0}, Lcom/vtosters/lite/fragments/i1$a;-><init>(Lcom/vtosters/lite/fragments/i1;)V

    iput-object v0, p0, Lcom/vtosters/lite/fragments/i1;->u0:Landroid/content/BroadcastReceiver;
...
.method static synthetic a(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    .line 2
    sput-object p0, Lcom/vtosters/lite/fragments/i1;->v0:Landroid/util/SparseArray;

    return-object p0
.end method

.method static synthetic a(Lcom/vtosters/lite/fragments/i1;)V
    .locals 0
...
.method static synthetic a(Lcom/vtosters/lite/fragments/i1;Ljava/lang/CharSequence;)V
    .locals 0
...
.method static synthetic b(Lcom/vtosters/lite/fragments/i1;)Ljava/util/ArrayList;
    .locals 0
...
.method static synthetic c(Lcom/vtosters/lite/fragments/i1;)Ljava/util/ArrayList;
    .locals 0
...
.method static synthetic d(Lcom/vtosters/lite/fragments/i1;)Ljava/util/ArrayList;
    .locals 0
...
.method static synthetic d5()Landroid/util/SparseArray;
    ...
    .line 1
    sget-object v0, Lcom/vtosters/lite/fragments/i1;->v0:Landroid/util/SparseArray;
...
.method protected Y4()Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    .line 1
    iget-object v0, p0, Lcom/vtosters/lite/fragments/i1;->t0:Landroidx/recyclerview/widget/RecyclerView$Adapter;

    if-nez v0, :cond_0

    .line 2
    new-instance v0, Lcom/vtosters/lite/fragments/i1$c;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/vtosters/lite/fragments/i1$c;-><init>(Lcom/vtosters/lite/fragments/i1;Lcom/vtosters/lite/fragments/i1$a;)V

    iput-object v0, p0, Lcom/vtosters/lite/fragments/i1;->t0:Landroidx/recyclerview/widget/RecyclerView$Adapter;
...
.method public e(Ljava/util/List;Z)V
    ...
    .line 1
    invoke-direct {p0}, Lcom/vtosters/lite/fragments/i1;->e5()Lcom/vk/dto/common/data/CatalogInfo;
...
.method protected h(II)V
    ...
    .line 3
    new-instance p2, Lcom/vtosters/lite/api/m;

    invoke-direct {p2, p0}, Lcom/vtosters/lite/api/m;-><init>(Ld/a/a/a/i;)V
    ...
    new-instance v1, Lcom/vtosters/lite/fragments/i1$b;

    invoke-direct {v1, p0, p2}, Lcom/vtosters/lite/fragments/i1$b;-><init>(Lcom/vtosters/lite/fragments/i1;I)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/vtosters/lite/fragments/i1;->u0:Landroid/content/BroadcastReceiver;
