.class public final Lcom/vk/profile/utils/OnlineFormatterExt;
...
.method public static final a(Lcom/vk/core/formatters/OnlineFormatter;Lcom/vk/dto/user/UserProfile;)Ljava/lang/CharSequence;
    ...
    invoke-static {p1, p0}, Lcom/vk/profile/utils/OnlineFormatterExt;->a(Ljava/lang/CharSequence;Landroid/content/Context;)Ljava/lang/CharSequence;
...
.method private static final a(Ljava/lang/CharSequence;Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, p1, v2}, Lcom/vk/core/drawable/RecoloredDrawable;-><init>(Landroid/graphics/drawable/Drawable;I)V

    .line 12
    invoke-virtual {v1}, Lcom/vk/core/drawable/RecoloredDrawable;->getIntrinsicWidth()I

    move-result p1

    invoke-virtual {v1}, Lcom/vk/core/drawable/RecoloredDrawable;->getIntrinsicHeight()I

    move-result v2

    const/4 v3, 0x0

    invoke-virtual {v1, v3, v3, p1, v2}, Lcom/vk/core/drawable/RecoloredDrawable;->setBounds(IIII)V
