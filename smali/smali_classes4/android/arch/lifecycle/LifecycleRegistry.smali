...
# instance fields
.field private a:Landroid/arch/a/b/FastSafeIterableMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/arch/a/b/FastSafeIterableMap<",
...
.method public constructor <init>(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    .line 59
    new-instance v0, Landroid/arch/a/b/FastSafeIterableMap;

    invoke-direct {v0}, Landroid/arch/a/b/FastSafeIterableMap;-><init>()V

    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->a:Landroid/arch/a/b/FastSafeIterableMap;
...
.method private a(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    .line 284
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->a:Landroid/arch/a/b/FastSafeIterableMap;

    .line 285
    invoke-virtual {v0}, Landroid/arch/a/b/FastSafeIterableMap;->c()Landroid/arch/a/b/SafeIterableMap$d;
    ...
    iget-object v3, p0, Landroid/arch/lifecycle/LifecycleRegistry;->a:Landroid/arch/a/b/FastSafeIterableMap;
    ...
    invoke-virtual {v3, v4}, Landroid/arch/a/b/FastSafeIterableMap;->c(Ljava/lang/Object;)Z
...
.method private b(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    .line 300
    invoke-virtual {v0}, Landroid/arch/a/b/FastSafeIterableMap;->b()Ljava/util/Iterator;
...
.method private b()Z
    ...
    invoke-virtual {v0}, Landroid/arch/a/b/FastSafeIterableMap;->a()I
    ...
    invoke-virtual {v0}, Landroid/arch/a/b/FastSafeIterableMap;->d()Ljava/util/Map$Entry;
    ...
    .line 146
    iget-object v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->a:Landroid/arch/a/b/FastSafeIterableMap;

    invoke-virtual {v2}, Landroid/arch/a/b/FastSafeIterableMap;->e()Ljava/util/Map$Entry;
...
.method private c(Landroid/arch/lifecycle/LifecycleObserver;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    invoke-virtual {v0, p1}, Landroid/arch/a/b/FastSafeIterableMap;->d(Ljava/lang/Object;)Ljava/util/Map$Entry;
...
.method private d()V
    ...
    invoke-virtual {v2}, Landroid/arch/a/b/FastSafeIterableMap;->d()Ljava/util/Map$Entry;
    ...
    .line 329
    :cond_1
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->a:Landroid/arch/a/b/FastSafeIterableMap;

    invoke-virtual {v1}, Landroid/arch/a/b/FastSafeIterableMap;->e()Ljava/util/Map$Entry;
...
.method public a(Landroid/arch/lifecycle/LifecycleObserver;)V
    ...
    .line 162
    :goto_0
    new-instance v1, Landroid/arch/lifecycle/LifecycleRegistry$a;

    invoke-direct {v1, p1, v0}, Landroid/arch/lifecycle/LifecycleRegistry$a;-><init>(Landroid/arch/lifecycle/LifecycleObserver;Landroid/arch/lifecycle/Lifecycle$State;)V

    .line 163
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->a:Landroid/arch/a/b/FastSafeIterableMap;

    invoke-virtual {v0, p1, v1}, Landroid/arch/a/b/FastSafeIterableMap;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 177
    :goto_3
    iget-object v5, v1, Landroid/arch/lifecycle/LifecycleRegistry$a;->a:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-object v4, p0, Landroid/arch/lifecycle/LifecycleRegistry;->a:Landroid/arch/a/b/FastSafeIterableMap;

    .line 178
    invoke-virtual {v4, p1}, Landroid/arch/a/b/FastSafeIterableMap;->c(Ljava/lang/Object;)Z
    ...
    .line 179
    iget-object v4, v1, Landroid/arch/lifecycle/LifecycleRegistry$a;->a:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    invoke-virtual {v1, v0, v4}, Landroid/arch/lifecycle/LifecycleRegistry$a;->a(Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method public b(Landroid/arch/lifecycle/LifecycleObserver;)V
    ...
    invoke-virtual {v0, p1}, Landroid/arch/a/b/FastSafeIterableMap;->b(Ljava/lang/Object;)Ljava/lang/Object;
