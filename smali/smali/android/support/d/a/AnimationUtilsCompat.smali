.class public Landroid/support/d/a/AnimationUtilsCompat;
...
.method public static a(Landroid/content/Context;I)Landroid/view/animation/Interpolator;
    ...
    .line 74
    :try_start_0
    new-instance p0, Landroid/support/v4/view/b/FastOutLinearInInterpolator;

    invoke-direct {p0}, Landroid/support/v4/view/b/FastOutLinearInInterpolator;-><init>()V
    ...
    .line 76
    new-instance p0, Landroid/support/v4/view/b/FastOutSlowInInterpolator;

    invoke-direct {p0}, Landroid/support/v4/view/b/FastOutSlowInInterpolator;-><init>()V
    ...
    .line 78
    new-instance p0, Landroid/support/v4/view/b/LinearOutSlowInInterpolator;

    invoke-direct {p0}, Landroid/support/v4/view/b/LinearOutSlowInInterpolator;-><init>()V
    ...
    invoke-static {p0, v0, v2, v1}, Landroid/support/d/a/AnimationUtilsCompat;->a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
...
.method private static a(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
    ...
    .line 140
    new-instance v0, Landroid/support/d/a/PathInterpolatorCompat;

    invoke-direct {v0, p0, p2, p3}, Landroid/support/d/a/PathInterpolatorCompat;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;)V
