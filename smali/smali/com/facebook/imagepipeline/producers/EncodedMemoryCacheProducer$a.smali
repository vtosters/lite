...
# instance fields
.field private final c:Lcom/facebook/x/c/MemoryCache;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method public constructor <init>(Lcom/facebook/imagepipeline/producers/Consumer;Lcom/facebook/x/c/MemoryCache;Lcom/facebook/cache/common/CacheKey;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lcom/facebook/imagepipeline/producers/EncodedMemoryCacheProducer$a;->c:Lcom/facebook/x/c/MemoryCache;

    .line 3
    iput-object p3, p0, Lcom/facebook/imagepipeline/producers/EncodedMemoryCacheProducer$a;->d:Lcom/facebook/cache/common/CacheKey;

    .line 4
    iput-boolean p4, p0, Lcom/facebook/imagepipeline/producers/EncodedMemoryCacheProducer$a;->e:Z
...
.method public a(Lcom/facebook/x/g/EncodedImage;I)V
    ...
    sget-object v1, Lcom/facebook/w/ImageFormat;->b:Lcom/facebook/w/ImageFormat;
    ...
    .line 7
    :try_start_1
    iget-boolean v2, p0, Lcom/facebook/imagepipeline/producers/EncodedMemoryCacheProducer$a;->e:Z

    if-eqz v2, :cond_2

    .line 8
    iget-object v1, p0, Lcom/facebook/imagepipeline/producers/EncodedMemoryCacheProducer$a;->c:Lcom/facebook/x/c/MemoryCache;

    iget-object v2, p0, Lcom/facebook/imagepipeline/producers/EncodedMemoryCacheProducer$a;->d:Lcom/facebook/cache/common/CacheKey;

    invoke-interface {v1, v2, v0}, Lcom/facebook/x/c/MemoryCache;->a(Ljava/lang/Object;Lcom/facebook/common/references/CloseableReference;)Lcom/facebook/common/references/CloseableReference;
    ...
    invoke-direct {v0, v1}, Lcom/facebook/x/g/EncodedImage;-><init>(Lcom/facebook/common/references/CloseableReference;)V

    .line 11
    invoke-virtual {v0, p1}, Lcom/facebook/x/g/EncodedImage;->a(Lcom/facebook/x/g/EncodedImage;)V
    :try_end_3
    ...
    invoke-interface {p1, v1}, Lcom/facebook/imagepipeline/producers/Consumer;->a(F)V
...
.method public bridge synthetic b(Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/facebook/imagepipeline/producers/EncodedMemoryCacheProducer$a;->a(Lcom/facebook/x/g/EncodedImage;I)V
