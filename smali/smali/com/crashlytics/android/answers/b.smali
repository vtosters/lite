...
.field h:Lcom/crashlytics/android/answers/a0;
...
.method public constructor <init>()V
    ...
    .line 2
    iput-boolean v0, p0, Lcom/crashlytics/android/answers/b;->g:Z
...
.method public static o()Lcom/crashlytics/android/answers/b;
    .locals 1
...
.method public a(Lcom/crashlytics/android/answers/m;)V
    ...
    .line 1
    iget-boolean v0, p0, Lcom/crashlytics/android/answers/b;->g:Z
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lcom/crashlytics/android/answers/b;->h:Lcom/crashlytics/android/answers/a0;

    if-eqz v0, :cond_1

    .line 4
    invoke-virtual {v0, p1}, Lcom/crashlytics/android/answers/a0;->a(Lcom/crashlytics/android/answers/m;)V
...
.method public a(Lio/fabric/sdk/android/services/common/i$a;)V
    ...
    .line 9
    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/i;->b()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/i;->a()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v0, v1, p1}, Lcom/crashlytics/android/answers/a0;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(Lio/fabric/sdk/android/services/common/i$b;)V
    ...
    invoke-virtual {v0, p1}, Lcom/crashlytics/android/answers/a0;->a(Ljava/lang/String;)V
...
.method protected c()Ljava/lang/Boolean;
    ...
    .line 7
    iget-object v3, p0, Lcom/crashlytics/android/answers/b;->h:Lcom/crashlytics/android/answers/a0;

    iget-object v2, v2, Lio/fabric/sdk/android/services/settings/t;->e:Lio/fabric/sdk/android/services/settings/b;

    .line 8
    invoke-virtual {p0}, Lcom/crashlytics/android/answers/b;->n()Ljava/lang/String;

    move-result-object v4

    .line 9
    invoke-virtual {v3, v2, v4}, Lcom/crashlytics/android/answers/a0;->a(Lio/fabric/sdk/android/services/settings/b;Ljava/lang/String;)V
    ...
    .line 12
    iget-object v2, p0, Lcom/crashlytics/android/answers/b;->h:Lcom/crashlytics/android/answers/a0;

    invoke-virtual {v2}, Lcom/crashlytics/android/answers/a0;->b()V
...
.method protected bridge synthetic c()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/crashlytics/android/answers/b;->c()Ljava/lang/Boolean;
...
.method protected m()Z
    ...
    invoke-static/range {v1 .. v7}, Lcom/crashlytics/android/answers/a0;->a(Lio/fabric/sdk/android/h;Landroid/content/Context;Lio/fabric/sdk/android/services/common/IdManager;Ljava/lang/String;Ljava/lang/String;J)Lcom/crashlytics/android/answers/a0;

    move-result-object v1

    iput-object v1, p0, Lcom/crashlytics/android/answers/b;->h:Lcom/crashlytics/android/answers/a0;

    .line 12
    iget-object v1, p0, Lcom/crashlytics/android/answers/b;->h:Lcom/crashlytics/android/answers/a0;

    invoke-virtual {v1}, Lcom/crashlytics/android/answers/a0;->c()V
    ...
    iput-boolean v1, p0, Lcom/crashlytics/android/answers/b;->g:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
