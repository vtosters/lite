...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/crashlytics/android/core/QueueFileLogStore$b;
    }
.end annotation
...
.method private b(JLjava/lang/String;)V
    ...
    invoke-virtual {p2, p1}, Lio/fabric/sdk/android/services/common/QueueFile;->a([B)V

    .line 12
    :goto_0
    iget-object p1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->c:Lio/fabric/sdk/android/services/common/QueueFile;

    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/QueueFile;->b()Z
    ...
    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/QueueFile;->d()I
    ...
    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/QueueFile;->c()V
    :try_end_0
...
.method private e()Lcom/crashlytics/android/core/QueueFileLogStore$b;
    .locals 7
    ...
    invoke-direct {v4, p0, v0, v1}, Lcom/crashlytics/android/core/QueueFileLogStore$a;-><init>(Lcom/crashlytics/android/core/QueueFileLogStore;[B[I)V

    invoke-virtual {v3, v4}, Lio/fabric/sdk/android/services/common/QueueFile;->a(Lio/fabric/sdk/android/services/common/QueueFile$d;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 7
    :goto_0
    new-instance v3, Lcom/crashlytics/android/core/QueueFileLogStore$b;

    aget v1, v1, v2

    invoke-direct {v3, p0, v0, v1}, Lcom/crashlytics/android/core/QueueFileLogStore$b;-><init>(Lcom/crashlytics/android/core/QueueFileLogStore;[BI)V
...
.method public b()Lcom/crashlytics/android/core/ByteString;
    .locals 3

    .line 1
    invoke-direct {p0}, Lcom/crashlytics/android/core/QueueFileLogStore;->e()Lcom/crashlytics/android/core/QueueFileLogStore$b;
    ...
    .line 2
    :cond_0
    iget-object v1, v0, Lcom/crashlytics/android/core/QueueFileLogStore$b;->a:[B

    const/4 v2, 0x0

    iget v0, v0, Lcom/crashlytics/android/core/QueueFileLogStore$b;->b:I

    invoke-static {v1, v2, v0}, Lcom/crashlytics/android/core/ByteString;->a([BII)Lcom/crashlytics/android/core/ByteString;
...
.method public c()[B
    ...
    .line 2
    :cond_0
    iget-object v0, v0, Lcom/crashlytics/android/core/QueueFileLogStore$b;->a:[B
