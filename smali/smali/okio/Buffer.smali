...
.method public a_(Lokio/Buffer;J)V
    ...
    iget-boolean v1, v0, Lokio/Segment;->d:Z
...
.method public f(J)Ljava/lang/String;
    ...
    .line 664
    invoke-virtual {p0, v5, v6}, Lokio/Buffer;->g(J)Ljava/lang/String;
    ...
    .line 666
    invoke-virtual {p0, v5, v6}, Lokio/Buffer;->c(J)B
    ...
    .line 667
    invoke-virtual {p0, v0, v1}, Lokio/Buffer;->g(J)Ljava/lang/String;
    ...
    .line 672
    invoke-virtual {v6}, Lokio/Buffer;->q()Lokio/ByteString;
...
.method public i()B
    ...
    iput-wide v9, p0, Lokio/Buffer;->b:J
...
.method public i(J)V
    ...
    iget-object p2, p0, Lokio/Buffer;->a:Lokio/Segment;

    iget p2, p2, Lokio/Segment;->c:I
    ...
    .line 858
    invoke-virtual {p1}, Lokio/Segment;->b()Lokio/Segment;

    move-result-object p2

    iput-object p2, p0, Lokio/Buffer;->a:Lokio/Segment;

    .line 859
    invoke-static {p1}, Lokio/SegmentPool;->a(Lokio/Segment;)V
...
.method public l()J
    ...
    .line 388
    invoke-virtual/range {p0 .. p0}, Lokio/Buffer;->k()I
    ...
    .line 392
    :cond_1
    iget-object v6, v1, Lokio/Segment;->a:[B
...
.method public o()J
    ...
    invoke-virtual {v1, v3, v4}, Lokio/Buffer;->k(J)Lokio/Buffer;
    ...
    iput-wide v8, v0, Lokio/Buffer;->b:J
...
.method public p()J
    ...
    invoke-virtual {v1, v5, v6}, Lokio/Buffer;->l(J)Lokio/Buffer;

    move-result-object v1

    invoke-virtual {v1, v11}, Lokio/Buffer;->b(I)Lokio/Buffer;
    ...
    .line 528
    invoke-virtual {v7}, Lokio/Segment;->b()Lokio/Segment;
    ...
    iput-wide v9, v0, Lokio/Buffer;->b:J
...
.method public q()Lokio/ByteString;
    ...
    invoke-virtual {p0}, Lokio/Buffer;->u()[B
...
.method public t()I
    ...
    .line 743
    :cond_5
    invoke-virtual {p0, v7, v8}, Lokio/Buffer;->i(J)V

    return v4

    .line 748
    :cond_6
    invoke-virtual {p0, v9, v10}, Lokio/Buffer;->i(J)V
...
.method public toString()Ljava/lang/String;
    ...
    .line 1719
    invoke-virtual {p0}, Lokio/Buffer;->x()Lokio/ByteString;
...
.method public synthetic y()Lokio/BufferedSink;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
