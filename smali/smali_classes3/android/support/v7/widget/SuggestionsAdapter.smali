...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v7/widget/SuggestionsAdapter$a;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    .line 74
    iput v1, p0, Landroid/support/v7/widget/SuggestionsAdapter;->q:I
    ...
    iput p2, p0, Landroid/support/v7/widget/SuggestionsAdapter;->o:I
...
.method private a(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    ...
    .line 626
    iget-object v1, p0, Landroid/support/v7/widget/SuggestionsAdapter;->n:Ljava/util/WeakHashMap;
    ...
    .line 627
    iget-object p1, p0, Landroid/support/v7/widget/SuggestionsAdapter;->n:Ljava/util/WeakHashMap;
...
.method private a(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v3, v1}, Landroid/support/v4/content/ContextCompat;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    sget v2, Landroid/support/v7/a/R$a;->textColorSearchUrl:I
    ...
    iget-object v5, p0, Landroid/support/v7/widget/SuggestionsAdapter;->r:Landroid/content/res/ColorStateList;
...
.method private f(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
    ...
    .line 377
    invoke-direct {p0, p1}, Landroid/support/v7/widget/SuggestionsAdapter;->a(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
...
.method private g(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
    ...
    .line 605
    iget-object p1, p0, Landroid/support/v7/widget/SuggestionsAdapter;->l:Landroid/app/SearchableInfo;

    invoke-virtual {p1}, Landroid/app/SearchableInfo;->getSearchActivity()Landroid/content/ComponentName;

    move-result-object p1

    invoke-direct {p0, p1}, Landroid/support/v7/widget/SuggestionsAdapter;->a(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    ...
    .line 611
    :cond_0
    iget-object p1, p0, Landroid/support/v7/widget/SuggestionsAdapter;->d:Landroid/content/Context;
...
.method public a(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    .line 151
    :goto_0
    iget-object v0, p0, Landroid/support/v7/widget/SuggestionsAdapter;->k:Landroid/support/v7/widget/SearchView;
    ...
    invoke-virtual {p0, v0, p1, v2}, Landroid/support/v7/widget/SuggestionsAdapter;->a(Landroid/app/SearchableInfo;Ljava/lang/String;I)Landroid/database/Cursor;
...
.method public a(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 244
    new-instance p2, Landroid/support/v7/widget/SuggestionsAdapter$a;

    invoke-direct {p2, p1}, Landroid/support/v7/widget/SuggestionsAdapter$a;-><init>(Landroid/view/View;)V

    invoke-virtual {p1, p2}, Landroid/view/View;->setTag(Ljava/lang/Object;)V

    .line 247
    sget p2, Landroid/support/v7/a/R$f;->edit_query:I
    ...
    .line 248
    iget p3, p0, Landroid/support/v7/widget/SuggestionsAdapter;->o:I
...
.method public a(Landroid/database/Cursor;)V
    ...
    iput p1, p0, Landroid/support/v7/widget/SuggestionsAdapter;->x:I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    check-cast p1, Landroid/support/v7/widget/SuggestionsAdapter$a;

    .line 277
    iget p2, p0, Landroid/support/v7/widget/SuggestionsAdapter;->x:I
    ...
    .line 280
    :goto_0
    iget-object v1, p1, Landroid/support/v7/widget/SuggestionsAdapter$a;->a:Landroid/widget/TextView;

    if-eqz v1, :cond_1

    .line 281
    iget v1, p0, Landroid/support/v7/widget/SuggestionsAdapter;->s:I

    invoke-static {p3, v1}, Landroid/support/v7/widget/SuggestionsAdapter;->a(Landroid/database/Cursor;I)Ljava/lang/String;

    move-result-object v1

    .line 282
    iget-object v2, p1, Landroid/support/v7/widget/SuggestionsAdapter$a;->a:Landroid/widget/TextView;

    invoke-direct {p0, v2, v1}, Landroid/support/v7/widget/SuggestionsAdapter;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    .line 284
    :cond_1
    iget-object v1, p1, Landroid/support/v7/widget/SuggestionsAdapter$a;->b:Landroid/widget/TextView;
    ...
    .line 286
    iget v1, p0, Landroid/support/v7/widget/SuggestionsAdapter;->u:I
    ...
    .line 288
    invoke-direct {p0, v1}, Landroid/support/v7/widget/SuggestionsAdapter;->b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    .line 290
    :cond_2
    iget v1, p0, Landroid/support/v7/widget/SuggestionsAdapter;->t:I
    ...
    .line 296
    iget-object v4, p1, Landroid/support/v7/widget/SuggestionsAdapter$a;->a:Landroid/widget/TextView;
    ...
    :cond_4
    :goto_2
    iget-object v4, p1, Landroid/support/v7/widget/SuggestionsAdapter$a;->b:Landroid/widget/TextView;

    invoke-direct {p0, v4, v1}, Landroid/support/v7/widget/SuggestionsAdapter;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    .line 309
    :cond_5
    iget-object v1, p1, Landroid/support/v7/widget/SuggestionsAdapter$a;->c:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v1, v4, v5}, Landroid/support/v7/widget/SuggestionsAdapter;->a(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;I)V

    .line 312
    :cond_6
    iget-object v1, p1, Landroid/support/v7/widget/SuggestionsAdapter$a;->d:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, v1, p3, v4}, Landroid/support/v7/widget/SuggestionsAdapter;->a(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;I)V

    .line 315
    :cond_7
    iget p3, p0, Landroid/support/v7/widget/SuggestionsAdapter;->q:I
    ...
    .line 322
    :cond_8
    iget-object p1, p1, Landroid/support/v7/widget/SuggestionsAdapter$a;->e:Landroid/widget/ImageView;
    ...
    :cond_9
    :goto_3
    iget-object p2, p1, Landroid/support/v7/widget/SuggestionsAdapter$a;->e:Landroid/widget/ImageView;
    ...
    iget-object p3, p1, Landroid/support/v7/widget/SuggestionsAdapter$a;->a:Landroid/widget/TextView;
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 476
    iget-object p2, p0, Landroid/support/v7/widget/SuggestionsAdapter;->d:Landroid/content/Context;

    iget-object v0, p0, Landroid/support/v7/widget/SuggestionsAdapter;->c:Landroid/database/Cursor;

    invoke-virtual {p0, p2, v0, p3}, Landroid/support/v7/widget/SuggestionsAdapter;->b(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    check-cast p3, Landroid/support/v7/widget/SuggestionsAdapter$a;

    .line 479
    iget-object p3, p3, Landroid/support/v7/widget/SuggestionsAdapter$a;->a:Landroid/widget/TextView;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, p2, v0, p3}, Landroid/support/v7/widget/SuggestionsAdapter;->a(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
