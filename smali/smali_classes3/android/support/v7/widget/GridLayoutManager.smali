...
.method private P()V
    ...
    .line 192
    invoke-virtual {v2}, Landroid/support/v7/widget/GridLayoutManager$b;->l_()I
...
.method a(II)I
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/GridLayoutManager;->k()Z
...
.method public a(Landroid/view/View;ILandroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;)Landroid/view/View;
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->k()Z
...
.method public a(I)V
    ...
    .line 819
    invoke-virtual {p0}, Landroid/support/v7/widget/GridLayoutManager;->t()V
...
.method a(Landroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/LinearLayoutManager$c;Landroid/support/v7/widget/LinearLayoutManager$b;)V
    ...
    .line 525
    iget-object v0, v6, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/OrientationHelper;
    ...
    .line 532
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/GridLayoutManager;->Q()V
    ...
    .line 593
    iget-object v3, v6, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/OrientationHelper;
    ...
    .line 598
    iget-object v5, v6, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/OrientationHelper;

    invoke-virtual {v5, v2}, Landroid/support/v7/widget/OrientationHelper;->f(Landroid/view/View;)I
    ...
    .line 674
    iget-object v1, v6, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/OrientationHelper;

    invoke-virtual {v1, v7}, Landroid/support/v7/widget/OrientationHelper;->f(Landroid/view/View;)I
    ...
    invoke-virtual {v3, v7}, Landroid/support/v7/widget/OrientationHelper;->f(Landroid/view/View;)I
    ...
    .line 693
    invoke-virtual {v9}, Landroid/support/v7/widget/GridLayoutManager$b;->j_()Z

    move-result v0

    if-nez v0, :cond_1a

    invoke-virtual {v9}, Landroid/support/v7/widget/GridLayoutManager$b;->k_()Z
...
.method public a(Landroid/support/v7/widget/RecyclerView$p;Landroid/support/v7/widget/RecyclerView$u;Landroid/view/View;Landroid/support/v4/view/a/AccessibilityNodeInfoCompat;)V
    ...
    .line 147
    invoke-super {p0, p3, p4}, Landroid/support/v7/widget/LinearLayoutManager;->a(Landroid/view/View;Landroid/support/v4/view/a/AccessibilityNodeInfoCompat;)V
    ...
    .line 151
    invoke-virtual {v0}, Landroid/support/v7/widget/GridLayoutManager$b;->l_()I
    ...
    .line 153
    invoke-static/range {v1 .. v6}, Landroid/support/v4/view/a/AccessibilityNodeInfoCompat$b;->a(IIIIZZ)Landroid/support/v4/view/a/AccessibilityNodeInfoCompat$b;
