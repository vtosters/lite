.class Lcom/vk/media/recorder/impl/l;
.super Lcom/vk/media/recorder/impl/k;
...
.method constructor <init>(Lcom/vk/media/recorder/impl/connection/h;Lcom/vk/media/recorder/impl/Streamer$b;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lcom/vk/media/recorder/impl/k;-><init>(Lcom/vk/media/recorder/impl/connection/h;Lcom/vk/media/recorder/impl/Streamer$b;)V
...
.method private k()V
    ...
    .line 2
    invoke-virtual {p0}, Lcom/vk/media/recorder/impl/j;->d()V
    ...
    iput-object v0, p0, Lcom/vk/media/recorder/impl/l;->r:Landroid/view/Surface;
...
.method a()V
    ...
    .line 10
    :try_start_0
    invoke-virtual {p0}, Lcom/vk/media/recorder/impl/j;->c()V

    .line 11
    invoke-virtual {p0}, Lcom/vk/media/recorder/impl/j;->b()V

    .line 12
    iget-object v0, p0, Lcom/vk/media/recorder/impl/l;->r:Landroid/view/Surface;
    ...
    invoke-virtual {p0, v0}, Lcom/vk/media/recorder/impl/j;->a(Lcom/vk/media/recorder/impl/Streamer$CAPTURE_STATE;)V
    ...
    .line 16
    :try_start_1
    sget-object v1, Lcom/vk/media/recorder/impl/l;->s:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/vk/media/recorder/impl/j;->a(Lcom/vk/media/recorder/impl/Streamer$CAPTURE_STATE;)V

    .line 18
    throw v0
.end method

.method a(Lcom/vk/media/recorder/impl/d;)V
    .locals 3
    ...
    iput-object v1, p0, Lcom/vk/media/recorder/impl/k;->p:Landroid/media/MediaCodec$BufferInfo;

    .line 4
    :cond_0
    iput-object p1, p0, Lcom/vk/media/recorder/impl/j;->d:Lcom/vk/media/recorder/impl/d;

    .line 5
    invoke-direct {p0}, Lcom/vk/media/recorder/impl/l;->k()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method i()V
    ...
    .line 2
    invoke-virtual {p0}, Lcom/vk/media/recorder/impl/k;->h()V
