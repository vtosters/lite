...
.field private final t:Lb/h/p/MediaUtils$b;

.field private u:Lcom/vk/media/gles/EglSurface$b;

.field protected v:Lb/h/p/f/TimestampHelper;
...
.method protected constructor <init>()V
    ...
    iput-object v0, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->s:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->t:Lb/h/p/MediaUtils$b;

    .line 4
    new-instance v0, Lb/h/p/f/TimestampHelper;

    invoke-direct {v0}, Lb/h/p/f/TimestampHelper;-><init>()V

    iput-object v0, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->v:Lb/h/p/f/TimestampHelper;

    .line 5
    new-instance v0, Lcom/vk/media/recorder/RecorderSurfaceBase$a;

    invoke-direct {v0, p0}, Lcom/vk/media/recorder/RecorderSurfaceBase$a;-><init>(Lcom/vk/media/recorder/RecorderSurfaceBase;)V
...
.method static synthetic a(Lcom/vk/media/recorder/RecorderSurfaceBase;)Ljava/lang/Object;
    ...
    .line 1
    iget-object p0, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->s:Ljava/lang/Object;

    return-object p0
.end method

.method private a(Lb/h/p/f/Frame;)V
    .locals 4

    .line 6
    iget-object v0, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->u:Lcom/vk/media/gles/EglSurface$b;
    ...
    .line 7
    :cond_0
    iget-object v0, p0, Lcom/vk/media/recorder/RecorderBase;->e:Lcom/vk/media/camera/CameraRenderBase$d;

    if-eqz v0, :cond_1

    .line 8
    iget-object v1, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->t:Lb/h/p/MediaUtils$b;

    invoke-virtual {v1}, Lb/h/p/MediaUtils$b;->c()I

    move-result v1

    iget-object v2, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->t:Lb/h/p/MediaUtils$b;
    ...
    .line 10
    invoke-virtual {p0}, Lcom/vk/media/recorder/RecorderSurfaceBase;->t()Z
    ...
    .line 11
    invoke-direct {p0}, Lcom/vk/media/recorder/RecorderSurfaceBase;->x()Z
    ...
    invoke-interface {v0, p1}, Lcom/vk/media/camera/CameraRenderBase$d;->a(Lb/h/p/f/Frame;)J
    ...
    invoke-virtual {p1, v0, v1}, Lb/h/p/f/TimestampHelper;->a(J)J

    move-result-wide v0

    .line 13
    iget-object p1, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->u:Lcom/vk/media/gles/EglSurface$b;

    invoke-virtual {p1, v0, v1}, Lcom/vk/media/gles/EglSurface;->a(J)Z
    :try_end_0
...
.method private a(Lcom/vk/media/gles/EglBase;)V
    ...
    .line 17
    :cond_2
    invoke-virtual {p0}, Lcom/vk/media/recorder/RecorderSurfaceBase;->u()Landroid/view/Surface;
    ...
    iput-object v1, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->u:Lcom/vk/media/gles/EglSurface$b;

    .line 20
    iget-object p1, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->u:Lcom/vk/media/gles/EglSurface$b;

    invoke-virtual {p1}, Lcom/vk/media/gles/EglSurface;->a()V
...
.method static synthetic b(Lcom/vk/media/recorder/RecorderSurfaceBase;)Lb/h/p/MediaUtils$b;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->t:Lb/h/p/MediaUtils$b;
...
.method private y()V
    ...
    .line 4
    iput-object v0, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->u:Lcom/vk/media/gles/EglSurface$b;
...
# virtual methods
.method protected a(Lb/h/p/f/Frame;Lcom/vk/media/gles/EglBase;)V
    .locals 2
    ...
    .line 4
    invoke-direct {p0, p1}, Lcom/vk/media/recorder/RecorderSurfaceBase;->a(Lb/h/p/f/Frame;)V
...
.method public n()V
    ...
    .line 2
    iget-object v0, p0, Lcom/vk/media/recorder/RecorderSurfaceBase;->s:Ljava/lang/Object;
    ...
    .line 4
    invoke-direct {p0}, Lcom/vk/media/recorder/RecorderSurfaceBase;->y()V
