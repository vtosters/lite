...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$b;
    }
.end annotation
...
.field private f:Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$b;
...
.method private a()D
    ...
    .line 62
    iget-object v0, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->b:Lcom/vk/media/ext/encoder/engine/TrackTranscoder;
    ...
    .line 63
    :goto_0
    iget-object v0, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->c:Lcom/vk/media/ext/encoder/engine/TrackTranscoder;
...
.method private a(Lcom/vk/media/ext/encoder/engine/TrackTranscoder;)D
    .locals 7
    ...
    .line 60
    :cond_0
    invoke-interface {p1}, Lcom/vk/media/ext/encoder/engine/TrackTranscoder;->b()Z
    ...
    .line 61
    :cond_1
    invoke-interface {p1}, Lcom/vk/media/ext/encoder/engine/TrackTranscoder;->f()J

    move-result-wide v3

    long-to-double v3, v3

    iget-wide v5, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->g:J
...
.method private a(Lcom/vk/media/ext/encoder/format/MediaFormatStrategy;)V
    ...
    invoke-static {v0}, Lcom/vk/media/ext/a/b/MediaExtractorUtils;->a(Landroid/media/MediaExtractor;)Lcom/vk/media/ext/a/b/MediaExtractorUtils$b;

    move-result-object v0

    .line 45
    iget-object v1, v0, Lcom/vk/media/ext/a/b/MediaExtractorUtils$b;->b:Landroid/media/MediaFormat;

    invoke-interface {p1, v1}, Lcom/vk/media/ext/encoder/format/MediaFormatStrategy;->b(Landroid/media/MediaFormat;)Landroid/media/MediaFormat;

    move-result-object v1

    .line 46
    iget-object v2, v0, Lcom/vk/media/ext/a/b/MediaExtractorUtils$b;->d:Landroid/media/MediaFormat;

    invoke-interface {p1, v2}, Lcom/vk/media/ext/encoder/format/MediaFormatStrategy;->a(Landroid/media/MediaFormat;)Landroid/media/MediaFormat;
    ...
    .line 49
    iget-object v3, v0, Lcom/vk/media/ext/a/b/MediaExtractorUtils$b;->b:Landroid/media/MediaFormat;
    ...
    .line 50
    :cond_2
    iget-object v3, v0, Lcom/vk/media/ext/a/b/MediaExtractorUtils$b;->d:Landroid/media/MediaFormat;
    ...
    iget-object v4, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->e:Landroid/media/MediaMuxer;

    new-instance v5, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$a;

    invoke-direct {v5, p0}, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$a;-><init>(Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;)V
    ...
    .line 52
    new-instance v2, Lcom/vk/media/ext/encoder/engine/VideoTrackTranscoder;

    iget-object v4, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->d:Landroid/media/MediaExtractor;

    iget v5, v0, Lcom/vk/media/ext/a/b/MediaExtractorUtils$b;->a:I

    invoke-direct {v2, v4, v5, v1, v3}, Lcom/vk/media/ext/encoder/engine/VideoTrackTranscoder;-><init>(Landroid/media/MediaExtractor;ILandroid/media/MediaFormat;Lcom/vk/media/ext/encoder/engine/QueuedMuxer;)V

    iput-object v2, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->b:Lcom/vk/media/ext/encoder/engine/TrackTranscoder;
    ...
    iget-object v2, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->d:Landroid/media/MediaExtractor;

    iget v4, v0, Lcom/vk/media/ext/a/b/MediaExtractorUtils$b;->c:I

    invoke-direct {v1, v2, v4, p1, v3}, Lcom/vk/media/ext/encoder/engine/AudioTrackTranscoder;-><init>(Landroid/media/MediaExtractor;ILandroid/media/MediaFormat;Lcom/vk/media/ext/encoder/engine/QueuedMuxer;)V
    ...
    .line 55
    invoke-interface {p1}, Lcom/vk/media/ext/encoder/engine/TrackTranscoder;->d()V

    .line 56
    iget-object p1, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->d:Landroid/media/MediaExtractor;

    iget v1, v0, Lcom/vk/media/ext/a/b/MediaExtractorUtils$b;->a:I
    ...
    iget v0, v0, Lcom/vk/media/ext/a/b/MediaExtractorUtils$b;->c:I
...
.method private b()V
    ...
    .line 2
    iget-wide v0, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->g:J
    ...
    .line 3
    iget-object v4, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->f:Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$b;

    if-eqz v4, :cond_0

    invoke-interface {v4, v0, v1}, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$b;->a(D)V
    ...
    invoke-interface {v4}, Lcom/vk/media/ext/encoder/engine/TrackTranscoder;->b()Z
    ...
    invoke-direct {p0, v5}, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->a(Lcom/vk/media/ext/encoder/engine/TrackTranscoder;)D

    move-result-wide v5

    .line 10
    iget-object v9, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->c:Lcom/vk/media/ext/encoder/engine/TrackTranscoder;

    invoke-direct {p0, v9}, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->a(Lcom/vk/media/ext/encoder/engine/TrackTranscoder;)D
    ...
    .line 11
    invoke-direct {p0}, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->a()D
    ...
    .line 12
    iget-object v9, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->f:Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$b;

    if-eqz v9, :cond_7

    invoke-interface {v9, v5, v6}, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$b;->a(D)V
...
.method static synthetic c(Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;)Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$b;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->f:Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$b;
...
.method private c()V
    ...
    iput-wide v0, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->g:J
    :try_end_1
    ...
    iget-wide v1, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->g:J
...
# virtual methods
.method public a(Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$b;)V
    .locals 0

    .line 3
    iput-object p1, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->f:Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine$b;
...
.method public a(Ljava/lang/String;Lcom/vk/media/ext/encoder/format/MediaFormatStrategy;)V
    ...
    .line 4
    iget-object v3, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->a:Ljava/io/FileDescriptor;
    ...
    iput-object v4, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->d:Landroid/media/MediaExtractor;

    .line 6
    iget-object v4, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->d:Landroid/media/MediaExtractor;

    iget-object v5, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->a:Ljava/io/FileDescriptor;
    ...
    iput-object v4, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->e:Landroid/media/MediaMuxer;

    .line 8
    invoke-direct {p0}, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->c()V
    ...
    .line 17
    iput-object v3, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->c:Lcom/vk/media/ext/encoder/engine/TrackTranscoder;
    ...
    .line 20
    iput-object v3, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->d:Landroid/media/MediaExtractor;
    :try_end_1
    ...
    .line 23
    iput-object v3, p0, Lcom/vk/media/ext/encoder/engine/MediaTranscoderEngine;->e:Landroid/media/MediaMuxer;
    :try_end_2
    ...
    invoke-interface {p2}, Lcom/vk/media/ext/encoder/engine/TrackTranscoder;->a()V
