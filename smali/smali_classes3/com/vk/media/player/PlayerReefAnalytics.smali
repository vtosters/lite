.class public final Lcom/vk/media/player/PlayerReefAnalytics;
...
.method public constructor <init>(Lcom/vk/reef/Reef;)V
    ...
    iput-object p1, p0, Lcom/vk/media/player/PlayerReefAnalytics;->b:Lcom/vk/reef/Reef;
    ...
    iput-object p1, p0, Lcom/vk/media/player/PlayerReefAnalytics;->a:Lcom/google/android/exoplayer2/p0$c;
...
.method private final j(Lcom/google/android/exoplayer2/q0/c$a;)J
    ...
    iget-object v1, p0, Lcom/vk/media/player/PlayerReefAnalytics;->a:Lcom/google/android/exoplayer2/p0$c;
...
.method public final a()V
    ...
    .line 8
    iget-object v0, p0, Lcom/vk/media/player/PlayerReefAnalytics;->b:Lcom/vk/reef/Reef;

    invoke-virtual {v0}, Lcom/vk/reef/Reef;->c()Lcom/vk/reef/i/ReefExoAdapter;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/vk/reef/i/ReefExoAdapter;->a()V

    .line 9
    :cond_0
    iget-object v0, p0, Lcom/vk/media/player/PlayerReefAnalytics;->b:Lcom/vk/reef/Reef;

    invoke-virtual {v0}, Lcom/vk/reef/Reef;->b()Lcom/vk/reef/trackers/ReefHeartbeatTracker;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/vk/reef/trackers/ReefHeartbeatTracker;->b()V
...
.method public final a(JJ)V
    ...
    invoke-virtual {v0, p3, p4, p1, p2}, Lcom/vk/reef/i/ReefExoAdapter;->a(JJ)V
...
.method public a(Lcom/google/android/exoplayer2/q0/c$a;Lcom/google/android/exoplayer2/ExoPlaybackException;)V
    ...
    .line 22
    iget-object p1, p0, Lcom/vk/media/player/PlayerReefAnalytics;->b:Lcom/vk/reef/Reef;

    invoke-virtual {p1}, Lcom/vk/reef/Reef;->c()Lcom/vk/reef/i/ReefExoAdapter;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1, p2}, Lcom/vk/reef/i/ReefExoAdapter;->a(Ljava/lang/Throwable;)V
...
.method public a(Lcom/google/android/exoplayer2/q0/c$a;Lcom/google/android/exoplayer2/source/TrackGroupArray;Lcom/google/android/exoplayer2/trackselection/l;)V
    ...
    .line 16
    invoke-direct {p0, p1}, Lcom/vk/media/player/PlayerReefAnalytics;->j(Lcom/google/android/exoplayer2/q0/c$a;)J
    ...
    .line 18
    iget-object v2, p0, Lcom/vk/media/player/PlayerReefAnalytics;->b:Lcom/vk/reef/Reef;

    invoke-virtual {v2}, Lcom/vk/reef/Reef;->c()Lcom/vk/reef/i/ReefExoAdapter;
    ...
    invoke-direct {p0, p1}, Lcom/vk/media/player/PlayerReefAnalytics;->k(Lcom/google/android/exoplayer2/q0/c$a;)J
    ...
    invoke-virtual/range {v2 .. v9}, Lcom/vk/reef/i/ReefExoAdapter;->a(ZIIJJ)V

    .line 19
    :cond_3
    iget-object p3, p0, Lcom/vk/media/player/PlayerReefAnalytics;->b:Lcom/vk/reef/Reef;

    invoke-virtual {p3}, Lcom/vk/reef/Reef;->a()Lcom/vk/reef/trackers/ReefContentStateTracker;
    ...
    .line 20
    invoke-virtual {p3, v10}, Lcom/vk/reef/trackers/ReefContentStateTracker;->a(I)V

    .line 21
    invoke-virtual {p3, v0, v1}, Lcom/vk/reef/trackers/ReefContentStateTracker;->a(J)V
...
.method public a(Lcom/google/android/exoplayer2/q0/c$a;ZI)V
    ...
    invoke-direct {p0, p3}, Lcom/vk/media/player/PlayerReefAnalytics;->a(I)Lcom/vk/reef/dto/ReefVideoPlayerState;
    ...
    invoke-virtual/range {v1 .. v7}, Lcom/vk/reef/i/ReefExoAdapter;->a(ZLcom/vk/reef/dto/ReefVideoPlayerState;JJ)V
...
.method public final a(Lcom/vk/reef/dto/ContentState$Quality;)V
    ...
    invoke-virtual {v0}, Lcom/vk/reef/Reef;->a()Lcom/vk/reef/trackers/ReefContentStateTracker;
    ...
    invoke-virtual {v0, p1, v1}, Lcom/vk/reef/trackers/ReefContentStateTracker;->a(Lcom/vk/reef/dto/ContentState$Quality;Z)V
...
.method public final a(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;Z)V
    ...
    .line 2
    invoke-virtual {v0, p1}, Lcom/vk/reef/trackers/ReefContentStateTracker;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/vk/reef/trackers/ReefContentStateTracker;->a(Landroid/net/Uri;)V
    ...
    :goto_0
    invoke-virtual {v0, v1}, Lcom/vk/reef/trackers/ReefContentStateTracker;->a(Lcom/vk/reef/dto/ContentState$Type;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/vk/reef/trackers/ReefContentStateTracker;->a(Lcom/vk/reef/dto/ContentState$Quality;Z)V
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/vk/reef/i/ReefExoAdapter;->a(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;Z)V

    .line 7
    :cond_2
    iget-object p1, p0, Lcom/vk/media/player/PlayerReefAnalytics;->b:Lcom/vk/reef/Reef;

    invoke-virtual {p1}, Lcom/vk/reef/Reef;->b()Lcom/vk/reef/trackers/ReefHeartbeatTracker;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {p1}, Lcom/vk/reef/trackers/ReefHeartbeatTracker;->a()V
...
.method public final b(JJ)V
    ...
    invoke-virtual {v0, p3, p4, p1, p2}, Lcom/vk/reef/i/ReefExoAdapter;->b(JJ)V
...
.method public c(Lcom/google/android/exoplayer2/q0/c$a;I)V
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/vk/reef/i/ReefExoAdapter;->a(IJJ)V
...
.method public c(Lcom/google/android/exoplayer2/q0/c$a;Lcom/google/android/exoplayer2/source/a0$b;Lcom/google/android/exoplayer2/source/a0$c;)V
    ...
    iget-object p2, p0, Lcom/vk/media/player/PlayerReefAnalytics;->b:Lcom/vk/reef/Reef;

    invoke-virtual {p2}, Lcom/vk/reef/Reef;->a()Lcom/vk/reef/trackers/ReefContentStateTracker;

    move-result-object p2

    if-eqz p2, :cond_0

    invoke-virtual {p2, p1}, Lcom/vk/reef/trackers/ReefContentStateTracker;->a(Landroid/net/Uri;)V
...
.method public d(Lcom/google/android/exoplayer2/q0/c$a;)V
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/vk/reef/i/ReefExoAdapter;->d(JJ)V
...
.method public f(Lcom/google/android/exoplayer2/q0/c$a;)V
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/vk/reef/i/ReefExoAdapter;->c(JJ)V
