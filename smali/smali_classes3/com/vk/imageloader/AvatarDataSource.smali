...
# instance fields
.field private final g:Lcom/facebook/x/e/ListDataSource;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/facebook/x/e/ListDataSource<",
            "Lcom/facebook/x/g/CloseableImage;",
            ">;"
        }
    .end annotation
...
.method public constructor <init>(Ljava/util/ArrayList;)V
    ...
    iput-object p1, p0, Lcom/vk/imageloader/AvatarDataSource;->g:Lcom/facebook/x/e/ListDataSource;

    .line 3
    iget-object p1, p0, Lcom/vk/imageloader/AvatarDataSource;->g:Lcom/facebook/x/e/ListDataSource;

    new-instance v0, Lcom/vk/imageloader/AvatarDataSource$a;

    invoke-direct {v0, p0}, Lcom/vk/imageloader/AvatarDataSource$a;-><init>(Lcom/vk/imageloader/AvatarDataSource;)V
    ...
    .line 5
    invoke-virtual {p1, v0, v1}, Lcom/facebook/datasource/AbstractDataSource;->a(Lcom/facebook/datasource/DataSubscriber;Ljava/util/concurrent/Executor;)V
...
.method public static a(Landroid/net/Uri;)Lcom/vk/imageloader/AvatarDataSource;
    ...
    .line 6
    invoke-virtual {v4}, Lcom/vk/imageloader/FrescoWrapper;->b()Lcom/facebook/x/d/ImagePipeline;
    ...
    .line 8
    invoke-static {v5}, Lcom/facebook/u/b/a/PipelineDraweeControllerBuilder;->a(Lcom/facebook/drawee/controller/AbstractDraweeControllerBuilder$CacheLevel;)Lcom/facebook/imagepipeline/request/ImageRequest$RequestLevel;

    move-result-object v5

    .line 9
    invoke-virtual {v4, v2, v3, v5}, Lcom/facebook/x/d/ImagePipeline;->a(Lcom/facebook/imagepipeline/request/ImageRequest;Ljava/lang/Object;Lcom/facebook/imagepipeline/request/ImageRequest$RequestLevel;)Lcom/facebook/datasource/DataSource;
...
.method private static b(Ljava/util/List;)Lcom/facebook/common/references/CloseableReference;
    ...
    .line 7
    invoke-virtual {v1, v2, v2}, Lcom/facebook/x/b/PlatformBitmapFactory;->a(II)Lcom/facebook/common/references/CloseableReference;

    move-result-object v1

    .line 8
    :try_start_0
    invoke-virtual {v1}, Lcom/facebook/common/references/CloseableReference;->b()Ljava/lang/Object;
    ...
    .line 10
    sget-object v4, Lcom/vk/imageloader/ImageLoaderUtils;->b:Ljava/lang/ThreadLocal;
    ...
    .line 11
    sget-object v5, Lcom/vk/imageloader/ImageLoaderUtils;->c:Ljava/lang/ThreadLocal;
    ...
    check-cast v16, Lcom/facebook/common/references/CloseableReference;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    .line 14
    :try_start_1
    invoke-virtual/range {v16 .. v16}, Lcom/facebook/common/references/CloseableReference;->b()Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/facebook/x/g/CloseableImage;

    .line 15
    instance-of v6, v5, Lcom/facebook/x/g/CloseableBitmap;
    :try_end_1
    ...
    :goto_1
    :try_start_2
    invoke-static/range {v16 .. v16}, Lcom/facebook/common/references/CloseableReference;->b(Lcom/facebook/common/references/CloseableReference;)V
    :try_end_2
    ...
    :cond_2
    :try_start_3
    check-cast v5, Lcom/facebook/x/g/CloseableBitmap;

    invoke-virtual {v5}, Lcom/facebook/x/g/CloseableBitmap;->d()Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v5 .. v11}, Lcom/vk/imageloader/AvatarDataSource;->a(IILandroid/graphics/Rect;Landroid/graphics/Rect;III)V

    .line 19
    sget-object v5, Lcom/vk/imageloader/ImageLoaderUtils;->a:Landroid/graphics/Paint;
    ...
    sget-object v2, Lcom/facebook/x/g/ImmutableQualityInfo;->d:Lcom/facebook/x/g/QualityInfo;

    const/4 v3, 0x0

    invoke-direct {v0, v1, v2, v3}, Lcom/facebook/x/g/CloseableStaticBitmap;-><init>(Lcom/facebook/common/references/CloseableReference;Lcom/facebook/x/g/QualityInfo;I)V
...
.method public declared-synchronized c()Z
    ...
    .line 2
    iget-object v0, p0, Lcom/vk/imageloader/AvatarDataSource;->g:Lcom/facebook/x/e/ListDataSource;

    invoke-virtual {v0}, Lcom/facebook/x/e/ListDataSource;->c()Z
...
.method public close()Z
    ...
    invoke-virtual {v0}, Lcom/facebook/x/e/ListDataSource;->close()Z
...
.method public declared-synchronized g()Lcom/facebook/common/references/CloseableReference;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0}, Lcom/facebook/x/e/ListDataSource;->g()Ljava/util/List;
...
.method public bridge synthetic g()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/vk/imageloader/AvatarDataSource;->g()Lcom/facebook/common/references/CloseableReference;
