...
.method public a(Ljava/lang/String;IILandroid/content/Intent;)V
    ...
    invoke-static {p1}, Lcom/vk/music/stories/MusicCatalogSelector;->e(Lcom/vk/music/stories/MusicCatalogSelector;)Lcom/vk/core/dialogs/bottomsheet/k/CustomisableModalBottomSheet;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-interface {p1}, Lcom/vk/core/dialogs/bottomsheet/k/CustomisableModalBottomSheet;->U3()Lcom/vk/core/dialogs/bottomsheet/k/b/ModalBottomSheetController;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-interface {p1, p2}, Lcom/vk/core/dialogs/bottomsheet/k/b/ModalBottomSheetController;->a(Z)V
