.class public Lcom/vk/music/h/MediaSessionHelper;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vk/music/h/MediaSessionHelper$d;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$c;Z)V
    ...
    iput-object p1, p0, Lcom/vk/music/h/MediaSessionHelper;->a:Landroid/content/Context;

    .line 3
    iput-boolean p3, p0, Lcom/vk/music/h/MediaSessionHelper;->e:Z

    .line 4
    iput-object p2, p0, Lcom/vk/music/h/MediaSessionHelper;->c:Landroid/support/v4/media/session/MediaSessionCompat$c;

    .line 5
    invoke-virtual {p0}, Lcom/vk/music/h/MediaSessionHelper;->b()V

    return-void
.end method

.method static synthetic a(Lcom/vk/music/h/MediaSessionHelper;Lcom/vk/music/player/TrackInfo;Landroid/graphics/Bitmap;II)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/vk/music/h/MediaSessionHelper;->a(Lcom/vk/music/player/TrackInfo;Landroid/graphics/Bitmap;II)V

    return-void
.end method

.method private a(Lcom/vk/music/player/TrackInfo;Landroid/graphics/Bitmap;II)V
    .locals 6
    ...
    .line 7
    iget-object v1, p0, Lcom/vk/music/h/MediaSessionHelper;->b:Landroid/support/v4/media/session/MediaSessionCompat;
    ...
    .line 21
    :cond_3
    iget-object p1, p0, Lcom/vk/music/h/MediaSessionHelper;->b:Landroid/support/v4/media/session/MediaSessionCompat;
...
.method private b(Lcom/vk/music/player/PlayState;Lcom/vk/music/player/TrackInfo;II)V
    .locals 6
    ...
    .line 11
    sget-object v1, Lcom/vk/music/h/MediaSessionHelper$c;->a:[I
    ...
    .line 20
    invoke-direct {p0, p2, p1, p3, p4}, Lcom/vk/music/h/MediaSessionHelper;->a(Lcom/vk/music/player/TrackInfo;Landroid/graphics/Bitmap;II)V
    ...
    new-instance v0, Lcom/vk/music/h/MediaSessionHelper$a;

    invoke-direct {v0, p0, p2, p3, p4}, Lcom/vk/music/h/MediaSessionHelper$a;-><init>(Lcom/vk/music/h/MediaSessionHelper;Lcom/vk/music/player/TrackInfo;II)V

    new-instance v1, Lcom/vk/music/h/MediaSessionHelper$b;

    invoke-direct {v1, p0, p2, p3, p4}, Lcom/vk/music/h/MediaSessionHelper$b;-><init>(Lcom/vk/music/h/MediaSessionHelper;Lcom/vk/music/player/TrackInfo;II)V
...
.method private c(Lcom/vk/music/player/PlayState;Lcom/vk/music/player/TrackInfo;II)V
    .locals 1
    ...
    .line 8
    invoke-virtual {p0}, Lcom/vk/music/h/MediaSessionHelper;->c()V
    ...
    .line 10
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/vk/music/h/MediaSessionHelper;->b(Lcom/vk/music/player/PlayState;Lcom/vk/music/player/TrackInfo;II)V
...
.method public a()Landroid/support/v4/media/session/MediaSessionCompat;
    ...
    .line 2
    iget-object v0, p0, Lcom/vk/music/h/MediaSessionHelper;->b:Landroid/support/v4/media/session/MediaSessionCompat;

    return-object v0
.end method

.method public a(Lcom/vk/music/player/PlayState;Lcom/vk/music/player/TrackInfo;II)V
    .locals 1

    .line 3
    iget-boolean v0, p0, Lcom/vk/music/h/MediaSessionHelper;->e:Z
    ...
    .line 5
    :cond_0
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/vk/music/h/MediaSessionHelper;->c(Lcom/vk/music/player/PlayState;Lcom/vk/music/player/TrackInfo;II)V
...
.method public b()V
    ...
    .line 1
    iget-boolean v0, p0, Lcom/vk/music/h/MediaSessionHelper;->d:Z
    ...
    .line 2
    iput-boolean v0, p0, Lcom/vk/music/h/MediaSessionHelper;->d:Z
    ...
    iget-object v2, p0, Lcom/vk/music/h/MediaSessionHelper;->a:Landroid/content/Context;
    ...
    .line 4
    iget-object v1, p0, Lcom/vk/music/h/MediaSessionHelper;->a:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/vk/music/h/MediaSessionHelper;->a:Landroid/content/Context;
    ...
    iput-object v2, p0, Lcom/vk/music/h/MediaSessionHelper;->b:Landroid/support/v4/media/session/MediaSessionCompat;

    .line 7
    iget-object v0, p0, Lcom/vk/music/h/MediaSessionHelper;->b:Landroid/support/v4/media/session/MediaSessionCompat;

    iget-object v1, p0, Lcom/vk/music/h/MediaSessionHelper;->c:Landroid/support/v4/media/session/MediaSessionCompat$c;
...
.method public c()V
    ...
    .line 6
    iput-object v0, p0, Lcom/vk/music/h/MediaSessionHelper;->b:Landroid/support/v4/media/session/MediaSessionCompat;
