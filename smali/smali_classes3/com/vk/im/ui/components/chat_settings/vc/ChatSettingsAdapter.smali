...
.field private final C:Lcom/vk/im/ui/components/chat_settings/vc/a;
...
# direct methods
.method public constructor <init>(Lcom/vk/im/ui/components/chat_settings/vc/a;)V
    .locals 1

    .line 1
    invoke-direct {p0}, Lcom/vk/im/ui/views/adapter_delegate/b;-><init>()V

    iput-object p1, p0, Lcom/vk/im/ui/components/chat_settings/vc/ChatSettingsAdapter;->C:Lcom/vk/im/ui/components/chat_settings/vc/a;
    ...
    invoke-direct {p1}, Lcom/vk/im/engine/models/dialogs/d;-><init>()V
    ...
    .line 5
    const-class p1, Lcom/vk/im/ui/components/chat_settings/vc/b$a;
    ...
    invoke-virtual {p0, p1, v0}, Lcom/vk/im/ui/views/adapter_delegate/a;->a(Ljava/lang/Class;Lkotlin/jvm/b/b;)V

    .line 6
    const-class p1, Lcom/vk/im/ui/components/chat_settings/vc/b$e;
    ...
    .line 7
    const-class p1, Lcom/vk/im/ui/components/chat_settings/vc/b$f;
    ...
    .line 8
    const-class p1, Lcom/vk/im/ui/components/chat_settings/vc/b$b;
    ...
    .line 9
    const-class p1, Lcom/vk/im/ui/components/chat_settings/vc/b$c;
    ...
    .line 10
    const-class p1, Lcom/vk/im/ui/components/chat_settings/vc/b$d;
...
.method private final a(Lcom/vk/im/engine/models/dialogs/Dialog;Lcom/vk/im/engine/models/dialogs/d;Lcom/vk/im/engine/models/Member;ZZ)Ljava/util/List;
    .locals 6
    ...
    invoke-virtual {p2}, Lcom/vk/im/engine/models/dialogs/d;->a()I
    ...
    .line 14
    :goto_2
    new-instance p4, Lcom/vk/im/ui/components/chat_settings/vc/b$a;
    ...
    invoke-direct {p4, p1, v2, v5, p3}, Lcom/vk/im/ui/components/chat_settings/vc/b$a;-><init>(Lcom/vk/im/engine/models/dialogs/Dialog;Ljava/lang/String;Lcom/vk/im/engine/models/ProfilesInfo;Z)V
    ...
    .line 16
    :cond_3
    new-instance p3, Lcom/vk/im/ui/components/chat_settings/vc/b$e;

    invoke-virtual {v0}, Lcom/vk/im/engine/models/dialogs/ChatSettings;->F1()I

    move-result p4

    invoke-direct {p3, p1, p4, v3}, Lcom/vk/im/ui/components/chat_settings/vc/b$e;-><init>(Lcom/vk/im/engine/models/dialogs/Dialog;IZ)V

    invoke-virtual {v0}, Lcom/vk/im/engine/models/dialogs/ChatSettings;->J1()Z

    move-result p4

    invoke-static {v1, p3, p4}, Lcom/vk/core/extensions/c;->a(Ljava/util/Collection;Ljava/lang/Object;Z)V

    .line 17
    new-instance p3, Lcom/vk/im/ui/components/chat_settings/vc/b$f;

    invoke-direct {p3, p1}, Lcom/vk/im/ui/components/chat_settings/vc/b$f;-><init>(Lcom/vk/im/engine/models/dialogs/Dialog;)V
    ...
    .line 19
    new-instance p2, Lcom/vk/im/ui/components/chat_settings/vc/b$c;

    invoke-direct {p2, p1}, Lcom/vk/im/ui/components/chat_settings/vc/b$c;-><init>(Lcom/vk/im/engine/models/dialogs/Dialog;)V
    ...
    .line 24
    new-instance v3, Lcom/vk/im/ui/components/chat_settings/vc/b$d;

    iget-object v5, p0, Lcom/vk/im/ui/components/chat_settings/vc/ChatSettingsAdapter;->h:Lcom/vk/im/engine/models/ProfilesInfo;

    invoke-direct {v3, p5, v5}, Lcom/vk/im/ui/components/chat_settings/vc/b$d;-><init>(Lcom/vk/im/engine/models/dialogs/DialogMember;Lcom/vk/im/engine/models/ProfilesInfo;)V
    ...
    invoke-static {v1, p3, p2}, Lcom/vk/core/extensions/c;->a(Ljava/util/Collection;Ljava/util/Collection;Z)V

    .line 28
    new-instance p2, Lcom/vk/im/ui/components/chat_settings/vc/b$e;

    invoke-virtual {p4}, Ljava/util/ArrayList;->size()I

    move-result p3

    invoke-direct {p2, p1, p3, v4}, Lcom/vk/im/ui/components/chat_settings/vc/b$e;-><init>(Lcom/vk/im/engine/models/dialogs/Dialog;IZ)V
    ...
    invoke-static {v1, p2, p1}, Lcom/vk/core/extensions/c;->a(Ljava/util/Collection;Ljava/lang/Object;Z)V
    ...
    invoke-static {v1, p4, p1}, Lcom/vk/core/extensions/c;->a(Ljava/util/Collection;Ljava/util/Collection;Z)V
...
.method public final a(Lcom/vk/im/engine/models/dialogs/Dialog;Lcom/vk/im/engine/models/dialogs/d;Lcom/vk/im/engine/models/ProfilesInfo;Lcom/vk/im/engine/models/Member;ZZ)V
    ...
    .line 3
    invoke-direct/range {v0 .. v5}, Lcom/vk/im/ui/components/chat_settings/vc/ChatSettingsAdapter;->a(Lcom/vk/im/engine/models/dialogs/Dialog;Lcom/vk/im/engine/models/dialogs/d;Lcom/vk/im/engine/models/Member;ZZ)Ljava/util/List;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/vk/im/ui/views/adapter_delegate/b;->setItems(Ljava/util/List;)V
...
.method public final a(ZJ)V
    ...
    .line 8
    :goto_0
    invoke-virtual {p0}, Lcom/vk/im/ui/views/adapter_delegate/a;->getItemCount()I
...
.method public b(Lcom/vk/im/ui/views/adapter_delegate/d;)V
    ...
    invoke-static {p1}, Lcom/vk/im/ui/utils/d;->a(Landroid/view/View;)V
...
.method public final m()Lcom/vk/im/ui/components/chat_settings/vc/a;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/vk/im/ui/components/chat_settings/vc/ChatSettingsAdapter;->C:Lcom/vk/im/ui/components/chat_settings/vc/a;
...
.method public bridge synthetic onViewDetachedFromWindow(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p0, p1}, Lcom/vk/im/ui/components/chat_settings/vc/ChatSettingsAdapter;->b(Lcom/vk/im/ui/views/adapter_delegate/d;)V
