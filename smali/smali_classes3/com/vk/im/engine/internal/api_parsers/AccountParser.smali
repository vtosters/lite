...
.method private final c(Lorg/json/JSONObject;)Ljava/util/List;
    ...
    :cond_3
    invoke-static {v2}, Lcom/vk/im/engine/utils/collection/IntCollectionExt;->b(Ljava/util/Collection;)Lcom/vk/im/engine/utils/collection/IntArrayList;
...
.method public final a(Lorg/json/JSONObject;)Lcom/vk/im/engine/models/account/PrivacySetting;
    ...
    invoke-direct {p0, v0}, Lcom/vk/im/engine/internal/api_parsers/AccountParser;->c(Lorg/json/JSONObject;)Ljava/util/List;

    move-result-object v4

    .line 10
    invoke-direct {p0, p1}, Lcom/vk/im/engine/internal/api_parsers/AccountParser;->b(Lorg/json/JSONObject;)Ljava/util/List;
