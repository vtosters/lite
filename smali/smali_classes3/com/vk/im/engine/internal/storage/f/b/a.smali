.class public final Lcom/vk/im/engine/internal/storage/f/b/a;
...
.method public constructor <init>(Lcom/vk/im/engine/internal/storage/b;)V
    ...
    iput-object p1, p0, Lcom/vk/im/engine/internal/storage/f/b/a;->a:Lcom/vk/im/engine/internal/storage/b;

    return-void
.end method

.method private final a(Landroid/database/Cursor;)Lcom/vk/im/engine/models/conversations/c;
    .locals 4
    ...
    .line 18
    new-instance v0, Lcom/vk/im/engine/models/conversations/c$c;
    ...
    .line 20
    invoke-direct {v0, p1, v1}, Lcom/vk/im/engine/models/conversations/c$c;-><init>(II)V
    ...
    .line 22
    :cond_1
    new-instance v0, Lcom/vk/im/engine/models/conversations/c$a;
    ...
    .line 25
    invoke-direct {v0, v2, p1, v1}, Lcom/vk/im/engine/models/conversations/c$a;-><init>(III)V

    goto :goto_0

    .line 26
    :cond_2
    new-instance v0, Lcom/vk/im/engine/models/conversations/c$d;
    ...
    .line 28
    invoke-direct {v0, p1, v1}, Lcom/vk/im/engine/models/conversations/c$d;-><init>(II)V

    :goto_0
    return-object v0
.end method

.method private final b(Lcom/vk/im/engine/models/conversations/c;)V
    .locals 3

    .line 11
    iget-object v0, p0, Lcom/vk/im/engine/internal/storage/f/b/a;->a:Lcom/vk/im/engine/internal/storage/b;
    ...
    invoke-direct {p0, p1}, Lcom/vk/im/engine/internal/storage/f/b/a;->c(Lcom/vk/im/engine/models/conversations/c;)Ljava/lang/String;
...
.method private final c(Lcom/vk/im/engine/models/conversations/c;)Ljava/lang/String;
    .locals 3
    ...
    check-cast p1, Lcom/vk/im/engine/models/conversations/c$a;
    ...
    invoke-virtual {p1}, Lcom/vk/im/engine/models/conversations/c$a;->d()I
    ...
    .line 5
    :cond_1
    instance-of v0, p1, Lcom/vk/im/engine/models/conversations/c$c;
    ...
    check-cast p1, Lcom/vk/im/engine/models/conversations/c$c;

    invoke-virtual {p1}, Lcom/vk/im/engine/models/conversations/c$c;->c()I
...
# virtual methods
.method public final a(Ljava/lang/String;)Lcom/vk/im/engine/models/conversations/c;
    .locals 2
    ...
    .line 11
    iget-object p1, p0, Lcom/vk/im/engine/internal/storage/f/b/a;->a:Lcom/vk/im/engine/internal/storage/b;
    ...
    .line 13
    invoke-direct {p0, p1}, Lcom/vk/im/engine/internal/storage/f/b/a;->a(Landroid/database/Cursor;)Lcom/vk/im/engine/models/conversations/c;
...
.method public final a(Lcom/vk/im/engine/models/conversations/c;)V
    .locals 5
    ...
    check-cast v3, Lcom/vk/im/engine/models/conversations/c$a;

    invoke-virtual {v3}, Lcom/vk/im/engine/models/conversations/c$d;->c()I
    ...
    invoke-virtual {v3}, Lcom/vk/im/engine/models/conversations/c$a;->d()I
    ...
    invoke-virtual {p1}, Lcom/vk/im/engine/models/conversations/c;->b()I
    ...
    check-cast v3, Lcom/vk/im/engine/models/conversations/c$d;
...
.method public final a(Ljava/lang/String;Lcom/vk/im/engine/models/conversations/c;)V
    .locals 2
    ...
    invoke-direct {p0, p2}, Lcom/vk/im/engine/internal/storage/f/b/a;->c(Lcom/vk/im/engine/models/conversations/c;)Ljava/lang/String;
...
.method public final b()Ljava/util/List;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List<",
            "Lcom/vk/im/engine/models/conversations/c;",
            ">;"
        }
    .end annotation
    ...
    .line 2
    iget-object v1, p0, Lcom/vk/im/engine/internal/storage/f/b/a;->a:Lcom/vk/im/engine/internal/storage/b;
    ...
    .line 5
    invoke-direct {p0, v1}, Lcom/vk/im/engine/internal/storage/f/b/a;->a(Landroid/database/Cursor;)Lcom/vk/im/engine/models/conversations/c;
...
.method public final b(Ljava/lang/String;Lcom/vk/im/engine/models/conversations/c;)V
    .locals 0

    if-eqz p1, :cond_0

    .line 8
    invoke-direct {p0, p1}, Lcom/vk/im/engine/internal/storage/f/b/a;->b(Ljava/lang/String;)V

    goto :goto_0

    .line 9
    :cond_0
    invoke-direct {p0, p2}, Lcom/vk/im/engine/internal/storage/f/b/a;->b(Lcom/vk/im/engine/models/conversations/c;)V
