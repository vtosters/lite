.class public final Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager$putUsers$$inlined$putPeersInfo$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager;->e(Ljava/util/Collection;)V
.end annotation
...
.method public constructor <init>(Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager;Ljava/util/Collection;)V
    ...
    iput-object p1, p0, Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager$putUsers$$inlined$putPeersInfo$1;->this$0:Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager;

    iput-object p2, p0, Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager$putUsers$$inlined$putPeersInfo$1;->$values:Ljava/util/Collection;
...
.method public final a(Lio/requery/android/database/sqlite/SQLiteDatabase;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager$putUsers$$inlined$putPeersInfo$1;->this$0:Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager;
    ...
    .line 2
    :try_start_0
    iget-object v2, p0, Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager$putUsers$$inlined$putPeersInfo$1;->$values:Ljava/util/Collection;
    ...
    check-cast v5, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;

    .line 5
    iget-object v5, p0, Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager$putUsers$$inlined$putPeersInfo$1;->this$0:Lcom/vk/im/engine/internal/storage/delegates/search/SearchStorageManager;

    .line 6
    move-object v6, v4

    check-cast v6, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;
    ...
    .line 9
    invoke-virtual {v6}, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;->getId()I
    ...
    invoke-virtual {v6}, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;->E1()Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;->I1()Ljava/lang/String;
    ...
    .line 13
    invoke-virtual {v6}, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;->B1()Ljava/lang/String;
    ...
    .line 15
    sget-object v11, Lcom/vk/im/engine/models/PeerType;->USER:Lcom/vk/im/engine/models/PeerType;

    invoke-virtual {v5}, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;->getId()I
    ...
    check-cast v12, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;

    .line 20
    sget-object v13, Lcom/vk/im/engine/models/PeerType;->USER:Lcom/vk/im/engine/models/PeerType;

    invoke-virtual {v12}, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;->getId()I
    ...
    invoke-static {v3, v7, v12}, Lcom/vk/libsqliteext/CustomSqliteExtensionsKt;->a(Lio/requery/android/database/sqlite/SQLiteStatement;II)V

    .line 21
    move-object v7, v4

    check-cast v7, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;
    ...
    .line 24
    invoke-virtual {v7}, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;->getId()I
    ...
    .line 28
    check-cast v4, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;

    .line 29
    invoke-virtual {v4}, Lcom/vk/im/engine/internal/storage/models/UserStorageModel;->B1()Ljava/lang/String;
