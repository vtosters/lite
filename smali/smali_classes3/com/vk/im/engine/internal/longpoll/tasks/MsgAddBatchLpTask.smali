...
.field private final j:Lcom/vk/im/engine/ImEnvironment;


# direct methods
.method public constructor <init>(Lcom/vk/im/engine/ImEnvironment;Lcom/vk/im/engine/models/x/MsgAddBatchLpEvent;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/vk/im/engine/internal/longpoll/LongPollTask;-><init>()V

    iput-object p1, p0, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->j:Lcom/vk/im/engine/ImEnvironment;

    .line 2
    invoke-virtual {p2}, Lcom/vk/im/engine/models/x/MsgAddBatchLpEvent;->a()I
    ...
    .line 3
    invoke-virtual {p2}, Lcom/vk/im/engine/models/x/MsgAddBatchLpEvent;->d()Landroid/util/SparseArray;
    ...
    .line 4
    invoke-virtual {p2}, Lcom/vk/im/engine/models/x/MsgAddBatchLpEvent;->b()Landroid/util/SparseArray;
    ...
    .line 5
    invoke-virtual {p2}, Lcom/vk/im/engine/models/x/MsgAddBatchLpEvent;->e()Landroid/util/SparseBooleanArray;
    ...
    .line 6
    invoke-virtual {p2}, Lcom/vk/im/engine/models/x/MsgAddBatchLpEvent;->c()Landroid/util/SparseBooleanArray;
...
.method private final a(Ljava/util/Collection;)Landroid/util/SparseBooleanArray;
    ...
    .line 38
    iget-object v0, p0, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->j:Lcom/vk/im/engine/ImEnvironment;
    ...
    invoke-static {p1, v1}, Lcom/vk/im/engine/utils/collection/IntCollectionExt;->a(Ljava/util/Collection;Lkotlin/jvm/b/Functions2;)Lcom/vk/im/engine/utils/collection/IntCollection;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/vk/im/engine/internal/storage/delegates/messages/MsgStorageManager;->b(Lcom/vk/im/engine/utils/collection/IntCollection;)Landroid/util/SparseBooleanArray;
...
.method private final a(Ljava/util/List;I)Ljava/util/List;
    ...
    .line 7
    iget-object p2, p0, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->j:Lcom/vk/im/engine/ImEnvironment;

    invoke-virtual {p1, p2}, Lcom/vk/im/engine/internal/k/MergeTask;->a(Lcom/vk/im/engine/ImEnvironment;)Ljava/lang/Object;
...
.method private final a(Lcom/vk/im/engine/ImEnvironment;Lcom/vk/im/engine/models/dialogs/DialogApiModel;)V
    ...
    .line 16
    invoke-virtual {p2}, Lcom/vk/im/engine/models/dialogs/DialogApiModel;->t()I
    ...
    .line 19
    new-instance p2, Lcom/vk/im/engine/models/account/BusinessNotifyConfig;

    invoke-direct {p2, v1, v0}, Lcom/vk/im/engine/models/account/BusinessNotifyConfig;-><init>(ZI)V

    .line 20
    invoke-virtual {p1, p2}, Lcom/vk/im/engine/internal/storage/delegates/account/AccountStorageManager;->a(Lcom/vk/im/engine/models/account/BusinessNotifyConfig;)V
...
.method private final a(Lcom/vk/im/engine/ImEnvironment;Ljava/util/List;Landroid/util/SparseArray;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v6}, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask$updateDialogKeyboard$1;-><init>(Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;Ljava/util/List;Lcom/vk/im/engine/ImEnvironment;Landroid/util/SparseArray;Lcom/vk/im/engine/internal/storage/delegates/dialogs/DialogsEntryStorageManager;)V
...
.method private final a(Lcom/vk/im/engine/internal/longpoll/LongPollEntityInfo;Ljava/util/List;Landroid/util/SparseArray;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/vk/im/engine/internal/longpoll/LongPollEntityInfo;",
            "Ljava/util/List<",
            "+",
            "Lcom/vk/im/engine/models/messages/Msg;",
            ">;",
    ...
    invoke-direct {p3, p1}, Lcom/vk/im/engine/internal/merge/dialogs/DialogInfoMergeTask;-><init>(Lcom/vk/im/engine/models/dialogs/DialogApiModel;)V

    iget-object v0, p0, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->j:Lcom/vk/im/engine/ImEnvironment;

    invoke-virtual {p3, v0}, Lcom/vk/im/engine/internal/k/MergeTask;->a(Lcom/vk/im/engine/ImEnvironment;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v0, p2, p3}, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->b(Lcom/vk/im/engine/ImEnvironment;Ljava/util/List;Landroid/util/SparseArray;)V

    .line 11
    :goto_0
    iget-object p3, p0, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->j:Lcom/vk/im/engine/ImEnvironment;

    invoke-direct {p0, p3, p2}, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->a(Lcom/vk/im/engine/ImEnvironment;Ljava/util/List;)V

    .line 12
    iget-object p2, p0, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->j:Lcom/vk/im/engine/ImEnvironment;

    invoke-direct {p0, p2, p1}, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->a(Lcom/vk/im/engine/ImEnvironment;Lcom/vk/im/engine/models/dialogs/DialogApiModel;)V
...
.method private final b(Lcom/vk/im/engine/ImEnvironment;Ljava/util/List;Landroid/util/SparseArray;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 59
    invoke-direct {p0, p1, p2, p3}, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->a(Lcom/vk/im/engine/ImEnvironment;Ljava/util/List;Landroid/util/SparseArray;)V
...
.method protected b(Lcom/vk/im/engine/internal/longpoll/LongPollChanges;)V
    ...
    invoke-virtual {p1, v3, v2}, Lcom/vk/im/engine/internal/longpoll/LongPollChanges;->h(II)V
    ...
    invoke-virtual {p1, v2, v3}, Lcom/vk/im/engine/internal/longpoll/LongPollChanges;->e(II)V
    ...
    invoke-virtual {p1, v2, v3}, Lcom/vk/im/engine/internal/longpoll/LongPollChanges;->b(II)V
    ...
    invoke-virtual {p1, v2}, Lcom/vk/im/engine/internal/longpoll/LongPollChanges;->d(I)V
    ...
    .line 31
    invoke-virtual {p1, v1}, Lcom/vk/im/engine/internal/longpoll/LongPollChanges;->b(Z)V
...
.method protected b(Lcom/vk/im/engine/internal/longpoll/LongPollEntityInfo;)V
    ...
    :cond_0
    iget-object v5, p1, Lcom/vk/im/engine/internal/longpoll/LongPollEntityInfo;->g:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, p1, v0, v1}, Lcom/vk/im/engine/internal/longpoll/tasks/MsgAddBatchLpTask;->a(Lcom/vk/im/engine/internal/longpoll/LongPollEntityInfo;Ljava/util/List;Landroid/util/SparseArray;)V
...
.method protected b(Lcom/vk/im/engine/internal/longpoll/LongPollEntityInfo;Lcom/vk/im/engine/internal/longpoll/LongPollEntityMissed;)V
    ...
    .line 7
    :goto_4
    iget-object v7, p1, Lcom/vk/im/engine/internal/longpoll/LongPollEntityInfo;->g:Landroid/util/SparseArray;

    const-string v8, "lpInfo.messages"

    invoke-static {v7, v8}, Lkotlin/jvm/internal/Intrinsics;->a(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v7, v5}, Lcom/vk/core/extensions/SparseArrayExt1;->a(Landroid/util/SparseArray;I)Z
    ...
    .line 8
    iget-object v6, p2, Lcom/vk/im/engine/internal/longpoll/LongPollEntityMissed;->d:Lcom/vk/im/engine/utils/collection/IntArraySet;

    invoke-virtual {v6, v5}, Lcom/vk/im/engine/utils/collection/IntArraySet;->add(I)V
