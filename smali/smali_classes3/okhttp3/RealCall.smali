...
.field final b:Lokhttp3/internal/b/RetryAndFollowUpInterceptor;
...
.method private constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/Request;Z)V
    ...
    .line 54
    new-instance p2, Lokhttp3/internal/b/RetryAndFollowUpInterceptor;

    invoke-direct {p2, p1, p3}, Lokhttp3/internal/b/RetryAndFollowUpInterceptor;-><init>(Lokhttp3/OkHttpClient;Z)V

    iput-object p2, p0, Lokhttp3/RealCall;->b:Lokhttp3/internal/b/RetryAndFollowUpInterceptor;
...
.method static a(Lokhttp3/OkHttpClient;Lokhttp3/Request;Z)Lokhttp3/RealCall;
    ...
    .line 60
    invoke-virtual {p0}, Lokhttp3/OkHttpClient;->z()Lokhttp3/EventListener$a;
...
.method private i()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/e/Platform;->a(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    .line 90
    iget-object v1, p0, Lokhttp3/RealCall;->b:Lokhttp3/internal/b/RetryAndFollowUpInterceptor;

    invoke-virtual {v1, v0}, Lokhttp3/internal/b/RetryAndFollowUpInterceptor;->a(Ljava/lang/Object;)V
...
.method public a(Lokhttp3/Callback;)V
    ...
    invoke-virtual {v0, p0}, Lokhttp3/EventListener;->d(Lokhttp3/Call;)V

    .line 100
    iget-object v0, p0, Lokhttp3/RealCall;->a:Lokhttp3/OkHttpClient;

    invoke-virtual {v0}, Lokhttp3/OkHttpClient;->u()Lokhttp3/Dispatcher;
...
.method public c()V
    ...
    .line 104
    iget-object v0, p0, Lokhttp3/RealCall;->b:Lokhttp3/internal/b/RetryAndFollowUpInterceptor;

    invoke-virtual {v0}, Lokhttp3/internal/b/RetryAndFollowUpInterceptor;->a()V
...
.method public d()Z
    ...
    invoke-virtual {v0}, Lokhttp3/internal/b/RetryAndFollowUpInterceptor;->b()Z
...
.method h()Lokhttp3/Response;
    ...
    .line 188
    new-instance v0, Lokhttp3/internal/b/BridgeInterceptor;
    ...
    invoke-direct {v0, v2}, Lokhttp3/internal/b/BridgeInterceptor;-><init>(Lokhttp3/CookieJar;)V

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 189
    new-instance v0, Lokhttp3/internal/a/CacheInterceptor;

    iget-object v2, p0, Lokhttp3/RealCall;->a:Lokhttp3/OkHttpClient;

    invoke-virtual {v2}, Lokhttp3/OkHttpClient;->i()Lokhttp3/internal/a/InternalCache;

    move-result-object v2

    invoke-direct {v0, v2}, Lokhttp3/internal/a/CacheInterceptor;-><init>(Lokhttp3/internal/a/InternalCache;)V
    ...
    .line 194
    :cond_0
    new-instance v0, Lokhttp3/internal/b/CallServerInterceptor;

    iget-boolean v2, p0, Lokhttp3/RealCall;->d:Z

    invoke-direct {v0, v2}, Lokhttp3/internal/b/CallServerInterceptor;-><init>(Z)V

    invoke-interface {v1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 196
    new-instance v12, Lokhttp3/internal/b/RealInterceptorChain;
    ...
    invoke-direct/range {v0 .. v11}, Lokhttp3/internal/b/RealInterceptorChain;-><init>(Ljava/util/List;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/internal/b/HttpCodec;Lokhttp3/internal/connection/RealConnection;ILokhttp3/Request;Lokhttp3/Call;Lokhttp3/EventListener;III)V
