.class public final Lokhttp3/f0/f/j;
...
.method public constructor <init>(Lokhttp3/x;Z)V
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/f0/f/j;->a:Lokhttp3/x;

    return-void
.end method

.method private a(Lokhttp3/b0;I)I
    .locals 1
...
.method private a(Lokhttp3/t;)Lokhttp3/a;
    ...
    .line 43
    invoke-virtual/range {p1 .. p1}, Lokhttp3/t;->h()Z
    ...
    .line 44
    iget-object v1, v0, Lokhttp3/f0/f/j;->a:Lokhttp3/x;

    invoke-virtual {v1}, Lokhttp3/x;->A()Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-virtual {v1}, Lokhttp3/x;->n()Ljavax/net/ssl/HostnameVerifier;

    move-result-object v1

    .line 46
    iget-object v3, v0, Lokhttp3/f0/f/j;->a:Lokhttp3/x;

    invoke-virtual {v3}, Lokhttp3/x;->d()Lokhttp3/g;
    ...
    invoke-virtual/range {p1 .. p1}, Lokhttp3/t;->k()I

    move-result v6

    iget-object v2, v0, Lokhttp3/f0/f/j;->a:Lokhttp3/x;
    ...
    invoke-virtual {v2}, Lokhttp3/x;->z()Ljavax/net/SocketFactory;
    ...
    .line 48
    invoke-virtual {v2}, Lokhttp3/x;->v()Lokhttp3/b;
    ...
    .line 49
    invoke-virtual {v2}, Lokhttp3/x;->u()Ljava/net/Proxy;
    ...
    invoke-virtual {v2}, Lokhttp3/x;->g()Ljava/util/List;

    move-result-object v15

    iget-object v2, v0, Lokhttp3/f0/f/j;->a:Lokhttp3/x;

    invoke-virtual {v2}, Lokhttp3/x;->w()Ljava/net/ProxySelector;
...
.method private a(Lokhttp3/b0;Lokhttp3/d0;)Lokhttp3/z;
    .locals 6
    ...
    .line 63
    :cond_0
    iget-object v0, p0, Lokhttp3/f0/f/j;->a:Lokhttp3/x;

    invoke-virtual {v0}, Lokhttp3/x;->y()Z
    ...
    .line 67
    invoke-direct {p0, p1, p2}, Lokhttp3/f0/f/j;->a(Lokhttp3/b0;I)I
    ...
    invoke-virtual {v0}, Lokhttp3/x;->u()Ljava/net/Proxy;
    ...
    invoke-virtual {v0}, Lokhttp3/x;->v()Lokhttp3/b;

    move-result-object v0

    invoke-interface {v0, p2, p1}, Lokhttp3/b;->a(Lokhttp3/d0;Lokhttp3/b0;)Lokhttp3/z;
    ...
    :cond_c
    :pswitch_0
    iget-object p2, p0, Lokhttp3/f0/f/j;->a:Lokhttp3/x;
    ...
    .line 81
    invoke-virtual {p1, p2}, Lokhttp3/b0;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p2}, Lokhttp3/t;->b(Ljava/lang/String;)Lokhttp3/t;
    ...
    .line 83
    :cond_f
    invoke-virtual {p2}, Lokhttp3/t;->o()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lokhttp3/t;->o()Ljava/lang/String;
    ...
    .line 89
    invoke-virtual {v0, v3, v4}, Lokhttp3/z$a;->a(Ljava/lang/String;Lokhttp3/a0;)Lokhttp3/z$a;
    ...
    .line 91
    :cond_12
    invoke-virtual {v0, v1, v4}, Lokhttp3/z$a;->a(Ljava/lang/String;Lokhttp3/a0;)Lokhttp3/z$a;
    ...
    .line 95
    :cond_13
    invoke-direct {p0, p1, p2}, Lokhttp3/f0/f/j;->a(Lokhttp3/b0;Lokhttp3/t;)Z
...
.method private a(Ljava/io/IOException;Lokhttp3/internal/connection/f;ZLokhttp3/z;)Z
    ...
    .line 52
    invoke-virtual {p4}, Lokhttp3/z;->a()Lokhttp3/a0;

    .line 53
    :cond_1
    invoke-direct {p0, p1, p3}, Lokhttp3/f0/f/j;->a(Ljava/io/IOException;Z)Z
...
.method private a(Lokhttp3/b0;Lokhttp3/t;)Z
    .locals 2
    ...
    invoke-virtual {p2}, Lokhttp3/t;->k()I
    ...
    .line 105
    invoke-virtual {p1}, Lokhttp3/t;->o()Ljava/lang/String;
...
.method public a(Lokhttp3/u$a;)Lokhttp3/b0;
    ...
    iget-object v1, p0, Lokhttp3/f0/f/j;->a:Lokhttp3/x;

    invoke-virtual {v1}, Lokhttp3/x;->f()Lokhttp3/j;
    ...
    invoke-direct {p0, v1}, Lokhttp3/f0/f/j;->a(Lokhttp3/t;)Lokhttp3/a;

    move-result-object v3

    iget-object v6, p0, Lokhttp3/f0/f/j;->c:Ljava/lang/Object;
    ...
    .line 11
    iput-object v9, p0, Lokhttp3/f0/f/j;->b:Lokhttp3/internal/connection/f;
    ...
    .line 12
    :goto_0
    iget-boolean v3, p0, Lokhttp3/f0/f/j;->d:Z

    if-nez v3, :cond_8

    .line 13
    :try_start_0
    invoke-virtual {p1, v0, v9, v11, v11}, Lokhttp3/f0/f/g;->a(Lokhttp3/z;Lokhttp3/internal/connection/f;Lokhttp3/f0/f/c;Lokhttp3/internal/connection/c;)Lokhttp3/b0;
    ...
    .line 15
    invoke-virtual {v1}, Lokhttp3/b0;->k()Lokhttp3/b0$a;

    move-result-object v1

    .line 16
    invoke-virtual {v1, v11}, Lokhttp3/b0$a;->a(Lokhttp3/c0;)Lokhttp3/b0$a;
    ...
    .line 18
    invoke-virtual {v0, v1}, Lokhttp3/b0$a;->c(Lokhttp3/b0;)Lokhttp3/b0$a;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v9}, Lokhttp3/internal/connection/f;->g()Lokhttp3/d0;

    move-result-object v1

    invoke-direct {p0, v0, v1}, Lokhttp3/f0/f/j;->a(Lokhttp3/b0;Lokhttp3/d0;)Lokhttp3/z;
    ...
    .line 23
    invoke-virtual {v12}, Lokhttp3/z;->a()Lokhttp3/a0;
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/f0/f/j;->a(Lokhttp3/b0;Lokhttp3/t;)Z
    ...
    .line 29
    :cond_2
    invoke-virtual {v9}, Lokhttp3/internal/connection/f;->b()Lokhttp3/f0/f/c;
    ...
    .line 36
    :goto_2
    invoke-direct {p0, v3, v9, v4, v0}, Lokhttp3/f0/f/j;->a(Ljava/io/IOException;Lokhttp3/internal/connection/f;ZLokhttp3/z;)Z
    ...
    invoke-direct {p0, v4, v9, v10, v0}, Lokhttp3/f0/f/j;->a(Ljava/io/IOException;Lokhttp3/internal/connection/f;ZLokhttp3/z;)Z
...
.method public a()V
    ...
    .line 1
    iput-boolean v0, p0, Lokhttp3/f0/f/j;->d:Z

    .line 2
    iget-object v0, p0, Lokhttp3/f0/f/j;->b:Lokhttp3/internal/connection/f;
...
.method public a(Ljava/lang/Object;)V
    ...
    .line 4
    iput-object p1, p0, Lokhttp3/f0/f/j;->c:Ljava/lang/Object;
...
.method public b()Z
    ...
    .line 1
    iget-boolean v0, p0, Lokhttp3/f0/f/j;->d:Z
