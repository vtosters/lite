...
.method private a(Lokio/d;Z)J
    ...
    .line 8
    iget-object v6, v6, Lokhttp3/w$b;->b:Lokhttp3/a0;
    ...
    invoke-interface {p1, v8}, Lokio/d;->a(Lokio/ByteString;)Lokio/d;
    ...
    invoke-interface {p1, v10}, Lokio/d;->c(Ljava/lang/String;)Lokio/d;
    ...
    invoke-interface {v10, v11}, Lokio/d;->c(Ljava/lang/String;)Lokio/d;
    ...
    .line 17
    :cond_1
    invoke-virtual {v6}, Lokhttp3/a0;->b()Lokhttp3/v;
    ...
    .line 18
    invoke-interface {p1, v8}, Lokio/d;->c(Ljava/lang/String;)Lokio/d;
    ...
    invoke-interface {v8, v7}, Lokio/d;->c(Ljava/lang/String;)Lokio/d;
    ...
    .line 21
    :cond_2
    invoke-virtual {v6}, Lokhttp3/a0;->a()J
    ...
    .line 22
    invoke-interface {p1, v9}, Lokio/d;->c(Ljava/lang/String;)Lokio/d;

    move-result-object v9

    .line 23
    invoke-interface {v9, v7, v8}, Lokio/d;->b(J)Lokio/d;
    ...
    .line 27
    :cond_5
    invoke-virtual {v6, p1}, Lokhttp3/a0;->a(Lokio/d;)V

    .line 28
    :goto_4
    sget-object v6, Lokhttp3/w;->h:[B

    invoke-interface {p1, v6}, Lokio/d;->write([B)Lokio/d;
    ...
    invoke-interface {p1, v1}, Lokio/d;->a(Lokio/ByteString;)Lokio/d;
