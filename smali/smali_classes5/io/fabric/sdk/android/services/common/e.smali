...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/fabric/sdk/android/services/common/e$c;,
...
.method public a()Lio/fabric/sdk/android/services/common/b;
    ...
    invoke-interface {v0, v4, v1}, Lio/fabric/sdk/android/k;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v3}, Lio/fabric/sdk/android/services/common/e$b;-><init>(Lio/fabric/sdk/android/services/common/e$a;)V
    ...
    .line 8
    :try_start_1
    iget-object v5, p0, Lio/fabric/sdk/android/services/common/e;->a:Landroid/content/Context;
    ...
    .line 9
    :try_start_2
    new-instance v2, Lio/fabric/sdk/android/services/common/e$c;

    .line 10
    invoke-virtual {v1}, Lio/fabric/sdk/android/services/common/e$b;->a()Landroid/os/IBinder;

    move-result-object v5

    invoke-direct {v2, v5}, Lio/fabric/sdk/android/services/common/e$c;-><init>(Landroid/os/IBinder;)V

    .line 11
    new-instance v5, Lio/fabric/sdk/android/services/common/b;

    invoke-virtual {v2}, Lio/fabric/sdk/android/services/common/e$c;->getId()Ljava/lang/String;

    move-result-object v6

    .line 12
    invoke-virtual {v2}, Lio/fabric/sdk/android/services/common/e$c;->Q()Z
    ...
    .line 13
    :try_start_3
    iget-object v2, p0, Lio/fabric/sdk/android/services/common/e;->a:Landroid/content/Context;
    ...
    invoke-interface {v5, v4, v6, v2}, Lio/fabric/sdk/android/k;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_4
    ...
    invoke-interface {v1, v4, v0}, Lio/fabric/sdk/android/k;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_5
    ...
    invoke-interface {v2, v4, v0, v1}, Lio/fabric/sdk/android/k;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v4, v2, v0}, Lio/fabric/sdk/android/k;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
