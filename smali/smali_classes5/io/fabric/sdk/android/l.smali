...
.method public constructor <init>(Ljava/util/concurrent/Future;Ljava/util/Collection;)V
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/l;->g:Lio/fabric/sdk/android/services/network/c;

    .line 3
    iput-object p1, p0, Lio/fabric/sdk/android/l;->I:Ljava/util/concurrent/Future;

    .line 4
    iput-object p2, p0, Lio/fabric/sdk/android/l;->J:Ljava/util/Collection;
...
.method private a(Lio/fabric/sdk/android/services/settings/o;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;
    ...
    invoke-virtual {v2, v1}, Lio/fabric/sdk/android/services/common/g;->d(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 22
    iget-object v1, v0, Lio/fabric/sdk/android/l;->F:Ljava/lang/String;
    ...
    iget-object v6, v0, Lio/fabric/sdk/android/l;->E:Ljava/lang/String;

    iget-object v7, v0, Lio/fabric/sdk/android/l;->D:Ljava/lang/String;

    iget-object v9, v0, Lio/fabric/sdk/android/l;->G:Ljava/lang/String;

    iget-object v11, v0, Lio/fabric/sdk/android/l;->H:Ljava/lang/String;
...
.method private a(Lio/fabric/sdk/android/services/settings/e;Lio/fabric/sdk/android/services/settings/o;Ljava/util/Collection;)Z
    ...
    .line 16
    new-instance p3, Lio/fabric/sdk/android/services/settings/y;

    invoke-virtual {p0}, Lio/fabric/sdk/android/l;->n()Ljava/lang/String;

    move-result-object v0

    iget-object p1, p1, Lio/fabric/sdk/android/services/settings/e;->b:Ljava/lang/String;

    iget-object v1, p0, Lio/fabric/sdk/android/l;->g:Lio/fabric/sdk/android/services/network/c;

    invoke-direct {p3, p0, v0, p1, v1}, Lio/fabric/sdk/android/services/settings/y;-><init>(Lio/fabric/sdk/android/h;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/c;)V

    .line 17
    invoke-virtual {p3, p2}, Lio/fabric/sdk/android/services/settings/y;->a(Lio/fabric/sdk/android/services/settings/d;)Z
...
.method private a(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    .line 6
    iget-object v0, p2, Lio/fabric/sdk/android/services/settings/e;->a:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lio/fabric/sdk/android/services/settings/r;->c()Z
    ...
    .line 12
    :cond_2
    iget-boolean v0, p2, Lio/fabric/sdk/android/services/settings/e;->e:Z
...
.method private b(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, p1, p3}, Lio/fabric/sdk/android/l;->a(Lio/fabric/sdk/android/services/settings/o;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;
    ...
    iget-object p2, p2, Lio/fabric/sdk/android/services/settings/e;->b:Ljava/lang/String;

    iget-object v1, p0, Lio/fabric/sdk/android/l;->g:Lio/fabric/sdk/android/services/network/c;

    invoke-direct {p3, p0, v0, p2, v1}, Lio/fabric/sdk/android/services/settings/i;-><init>(Lio/fabric/sdk/android/h;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/c;)V
...
.method private c(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, p2, p1, p3}, Lio/fabric/sdk/android/l;->a(Lio/fabric/sdk/android/services/settings/e;Lio/fabric/sdk/android/services/settings/o;Ljava/util/Collection;)Z
...
.method private o()Lio/fabric/sdk/android/services/settings/t;
    .locals 8
    ...
    iget-object v2, p0, Lio/fabric/sdk/android/h;->e:Lio/fabric/sdk/android/services/common/IdManager;

    iget-object v3, p0, Lio/fabric/sdk/android/l;->g:Lio/fabric/sdk/android/services/network/c;

    iget-object v4, p0, Lio/fabric/sdk/android/l;->D:Ljava/lang/String;

    iget-object v5, p0, Lio/fabric/sdk/android/l;->E:Ljava/lang/String;
    ...
    .line 4
    invoke-virtual {v7}, Lio/fabric/sdk/android/services/settings/r;->b()Z
...
.method protected c()Ljava/lang/Boolean;
    ...
    .line 3
    invoke-direct {p0}, Lio/fabric/sdk/android/l;->o()Lio/fabric/sdk/android/services/settings/t;
    ...
    .line 4
    :try_start_0
    iget-object v2, p0, Lio/fabric/sdk/android/l;->I:Ljava/util/concurrent/Future;
    ...
    .line 7
    :goto_0
    iget-object v3, p0, Lio/fabric/sdk/android/l;->J:Ljava/util/Collection;

    invoke-virtual {p0, v2, v3}, Lio/fabric/sdk/android/l;->a(Ljava/util/Map;Ljava/util/Collection;)Ljava/util/Map;

    .line 8
    iget-object v1, v1, Lio/fabric/sdk/android/services/settings/t;->a:Lio/fabric/sdk/android/services/settings/e;
    ...
    .line 10
    invoke-direct {p0, v0, v1, v2}, Lio/fabric/sdk/android/l;->a(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
...
.method protected m()Z
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/l;->h:Landroid/content/pm/PackageManager;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/l;->B:Ljava/lang/String;

    .line 4
    iget-object v1, p0, Lio/fabric/sdk/android/l;->h:Landroid/content/pm/PackageManager;

    iget-object v2, p0, Lio/fabric/sdk/android/l;->B:Ljava/lang/String;

    invoke-virtual {v1, v2, v0}, Landroid/content/pm/PackageManager;->getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;

    move-result-object v1

    iput-object v1, p0, Lio/fabric/sdk/android/l;->C:Landroid/content/pm/PackageInfo;

    .line 5
    iget-object v1, p0, Lio/fabric/sdk/android/l;->C:Landroid/content/pm/PackageInfo;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/l;->D:Ljava/lang/String;
