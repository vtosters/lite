...
.field final E:Lio/reactivex/Scheduler$c;
...
.method constructor <init>(Lio/reactivex/Observer;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;IZLio/reactivex/Scheduler$c;)V
    ...
    .line 4
    iput-object p5, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->B:Ljava/util/concurrent/TimeUnit;

    .line 5
    iput p6, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->C:I

    .line 6
    iput-boolean p7, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->D:Z

    .line 7
    iput-object p8, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->E:Lio/reactivex/Scheduler$c;
...
.method public a(Lio/reactivex/disposables/Disposable;)V
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->H:Lio/reactivex/disposables/Disposable;
    ...
    .line 3
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->H:Lio/reactivex/disposables/Disposable;
    ...
    .line 5
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->F:Ljava/util/Collection;
    ...
    .line 7
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->E:Lio/reactivex/Scheduler$c;

    iget-wide v4, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->h:J

    iget-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->B:Ljava/util/concurrent/TimeUnit;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->G:Lio/reactivex/disposables/Disposable;
    ...
    .line 11
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->E:Lio/reactivex/Scheduler$c;
...
.method public b()V
    ...
    .line 27
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->F:Ljava/util/Collection;

    const/4 v1, 0x0

    .line 28
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->F:Ljava/util/Collection;
...
.method public b(Ljava/lang/Object;)V
    ...
    iget v1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->C:I
    ...
    .line 7
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->F:Ljava/util/Collection;

    .line 8
    iget-wide v1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->I:J

    const-wide/16 v3, 0x1

    add-long/2addr v1, v3

    iput-wide v1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->I:J
    ...
    .line 10
    iget-boolean p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->D:Z

    if-eqz p1, :cond_2

    .line 11
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->G:Lio/reactivex/disposables/Disposable;
    ...
    .line 16
    iget-wide v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->J:J

    add-long/2addr v0, v3

    iput-wide v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->J:J
    ...
    .line 23
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->o()V
...
.method public run()V
    ...
    .line 3
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->F:Ljava/util/Collection;

    if-eqz v1, :cond_1

    .line 4
    iget-wide v2, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->I:J

    iget-wide v4, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$a;->J:J
