...
.method constructor <init>(Lio/reactivex/Observer;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->F:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 5
    iput-object p5, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->B:Ljava/util/concurrent/TimeUnit;

    .line 6
    iput-object p6, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->C:Lio/reactivex/Scheduler;
...
.method public a(Lio/reactivex/disposables/Disposable;)V
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->D:Lio/reactivex/disposables/Disposable;
    ...
    .line 3
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->D:Lio/reactivex/disposables/Disposable;
    ...
    .line 5
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->E:Ljava/util/Collection;
    ...
    .line 8
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->C:Lio/reactivex/Scheduler;

    iget-wide v4, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->h:J

    iget-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->B:Ljava/util/concurrent/TimeUnit;
    ...
    .line 9
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->F:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 12
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->o()V
...
.method public a(Ljava/lang/Throwable;)V
    ...
    .line 15
    :try_start_0
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->E:Ljava/util/Collection;
    ...
    .line 18
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->F:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public b()V
    ...
    .line 7
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->E:Ljava/util/Collection;

    const/4 v1, 0x0

    .line 8
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->E:Ljava/util/Collection;
    ...
    invoke-interface {v2, v0}, Lc/a/a0/b/SimpleQueue;->offer(Ljava/lang/Object;)Z
    ...
    invoke-static {v0, v2, v3, v1, p0}, Lio/reactivex/internal/util/QueueDrainHelper;->a(Lc/a/a0/b/SimplePlainQueue;Lio/reactivex/Observer;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/ObservableQueueDrain;)V
...
.method public run()V
    ...
    .line 3
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableBufferTimed$b;->E:Ljava/util/Collection;
