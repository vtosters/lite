...
# direct methods
.method constructor <init>(Lc/a/a0/b/ConditionalSubscriber;Lio/reactivex/Scheduler$c;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;-><init>(Lio/reactivex/Scheduler$c;ZI)V

    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lc/a/a0/b/ConditionalSubscriber;
...
.method public a(Le/b/Subscription;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Le/b/Subscription;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Le/b/Subscription;
    ...
    .line 7
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lc/a/a0/b/SimpleQueue;

    .line 8
    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->done:Z

    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lc/a/a0/b/ConditionalSubscriber;
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lc/a/a0/b/ConditionalSubscriber;

    invoke-interface {v0, p0}, Lio/reactivex/FlowableSubscriber;->a(Le/b/Subscription;)V
...
.method d()V
    ...
    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lc/a/a0/b/SimpleQueue;
    ...
    .line 8
    :goto_2
    invoke-virtual {p0, v11, v13, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->a(ZZLe/b/Subscriber;)Z
    ...
    .line 9
    :cond_4
    invoke-interface {v0, v12}, Lc/a/a0/b/ConditionalSubscriber;->c(Ljava/lang/Object;)Z
    ...
    .line 11
    iget-object v10, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Le/b/Subscription;

    invoke-interface {v10, v4, v5}, Le/b/Subscription;->a(J)V
    ...
    .line 14
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Le/b/Subscription;

    invoke-interface {v3}, Le/b/Subscription;->cancel()V

    .line 15
    invoke-interface {v1}, Lc/a/a0/b/SimpleQueue;->clear()V

    .line 16
    invoke-interface {v0, v2}, Le/b/Subscriber;->a(Ljava/lang/Throwable;)V

    .line 17
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->worker:Lio/reactivex/Scheduler$c;
    ...
    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->a(ZZLe/b/Subscriber;)Z
...
.method e()V
    ...
    .line 3
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lc/a/a0/b/ConditionalSubscriber;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Le/b/Subscriber;->b(Ljava/lang/Object;)V
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lc/a/a0/b/ConditionalSubscriber;

    invoke-interface {v1, v0}, Le/b/Subscriber;->a(Ljava/lang/Throwable;)V
...
.method f()V
    ...
    .line 10
    :cond_3
    invoke-interface {v0, v8}, Lc/a/a0/b/ConditionalSubscriber;->c(Ljava/lang/Object;)Z
    ...
    .line 13
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Le/b/Subscription;

    invoke-interface {v2}, Le/b/Subscription;->cancel()V
...
.method public poll()Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lc/a/a0/b/SimpleQueue;
    ...
    invoke-interface {v3, v1, v2}, Le/b/Subscription;->a(J)V
