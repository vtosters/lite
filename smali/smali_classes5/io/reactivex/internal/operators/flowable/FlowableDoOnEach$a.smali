...
# direct methods
.method constructor <init>(Lc/a/a0/b/ConditionalSubscriber;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->f:Lio/reactivex/functions/Consumer;

    .line 3
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->g:Lio/reactivex/functions/Consumer;

    .line 4
    iput-object p4, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->h:Lio/reactivex/functions/Action;

    .line 5
    iput-object p5, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->B:Lio/reactivex/functions/Action;
...
.method public a(Ljava/lang/Throwable;)V
    ...
    .line 4
    :try_start_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->g:Lio/reactivex/functions/Consumer;
    ...
    .line 6
    iget-object v3, p0, Lio/reactivex/internal/subscribers/BasicFuseableConditionalSubscriber;->a:Lc/a/a0/b/ConditionalSubscriber;
    ...
    :cond_1
    :try_start_1
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->B:Lio/reactivex/functions/Action;
...
.method public b()V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->h:Lio/reactivex/functions/Action;
    ...
    .line 11
    :try_start_1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->B:Lio/reactivex/functions/Action;
    ...
    .line 14
    invoke-virtual {p0, v0}, Lio/reactivex/internal/subscribers/BasicFuseableConditionalSubscriber;->b(Ljava/lang/Throwable;)V
...
.method public b(Ljava/lang/Object;)V
    ...
    :cond_1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->f:Lio/reactivex/functions/Consumer;
...
.method public poll()Ljava/lang/Object;
    ...
    .line 1
    :try_start_0
    iget-object v3, p0, Lio/reactivex/internal/subscribers/BasicFuseableConditionalSubscriber;->c:Lc/a/a0/b/QueueSubscription;
    ...
    .line 2
    :try_start_1
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->f:Lio/reactivex/functions/Consumer;
    ...
    .line 5
    :try_start_3
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->g:Lio/reactivex/functions/Consumer;
    ...
    .line 8
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$a;->B:Lio/reactivex/functions/Action;
