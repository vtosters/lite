...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/schedulers/j;->d:Ljava/util/concurrent/ScheduledExecutorService;

    .line 2
    sget-object v0, Lio/reactivex/internal/schedulers/j;->d:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v2, Lio/reactivex/internal/schedulers/j;->c:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/schedulers/j;->b:Ljava/util/concurrent/atomic/AtomicReference;
...
.method static a(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 1
    invoke-static {p0}, Lio/reactivex/internal/schedulers/i;->a(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public a()Lc/a/s$c;
    ...
    .line 2
    new-instance v0, Lio/reactivex/internal/schedulers/j$a;

    iget-object v1, p0, Lio/reactivex/internal/schedulers/j;->b:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lio/reactivex/internal/schedulers/j$a;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public a(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    .line 10
    iget-object p4, p0, Lio/reactivex/internal/schedulers/j;->b:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 14
    :goto_0
    invoke-virtual {p5, p1}, Lio/reactivex/internal/schedulers/c;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    .line 18
    :try_start_1
    iget-object p1, p0, Lio/reactivex/internal/schedulers/j;->b:Ljava/util/concurrent/atomic/AtomicReference;
