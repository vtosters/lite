...
.method public bridge synthetic H()Lokio/BufferedSink;
    .locals 0
    ...
    .line 1
    invoke-virtual {p0}, Lokio/Buffer;->H()Lokio/Buffer;
...
.method public O()J
    ...
    invoke-virtual {v1, v3, v4}, Lokio/Buffer;->b(J)Lokio/Buffer;
...
.method public P()Lokio/ByteString;
    ...
    invoke-virtual {p0}, Lokio/Buffer;->M()[B
...
.method public R()J
    ...
    invoke-virtual {v0, v4, v5}, Lokio/Buffer;->c(J)Lokio/Buffer;
...
.method a(Lokio/Options;Z)I
    ...
    .line 31
    iget-object v4, v5, Lokio/Segment;->f:Lokio/Segment;
    ...
    .line 39
    iget-object v3, v5, Lokio/Segment;->f:Lokio/Segment;
...
.method public a(BJJ)J
    ...
    .line 142
    iget-object v10, v7, Lokio/Segment;->a:[B

    .line 143
    iget v11, v7, Lokio/Segment;->c:I
...
.method public a(Lokio/ByteString;J)J
    ...
    .line 152
    iget-object v2, v6, Lokio/Buffer;->a:Lokio/Segment;
    ...
    .line 153
    :cond_0
    iget-wide v3, v6, Lokio/Buffer;->b:J
    ...
    .line 161
    iget-object v4, v5, Lokio/Segment;->a:[B

    .line 162
    iget v2, v5, Lokio/Segment;->c:I
    ...
    .line 166
    iget v0, v6, Lokio/Segment;->c:I

    iget v1, v6, Lokio/Segment;->b:I
    ...
    .line 167
    iget-object v5, v6, Lokio/Segment;->f:Lokio/Segment;
...
.method public a(Lokio/Sink;)J
    ...
    .line 44
    invoke-interface {p1, p0, v0, v1}, Lokio/Sink;->a(Lokio/Buffer;J)V
...
.method public a(Lokio/Source;)J
    ...
    .line 110
    invoke-interface {p1, p0, v2, v3}, Lokio/Source;->b(Lokio/Buffer;J)J
...
.method public a(Ljava/lang/String;II)Lokio/Buffer;
    ...
    .line 74
    invoke-virtual {p0, v2}, Lokio/Buffer;->b(I)Lokio/Segment;
...
.method public bridge synthetic a(Ljava/lang/String;II)Lokio/BufferedSink;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public bridge synthetic a(Lokio/ByteString;)Lokio/BufferedSink;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public a(JLokio/ByteString;II)Z
    ...
    .line 173
    invoke-virtual {p0, v2, v3}, Lokio/Buffer;->h(J)B
...
.method public b(Lokio/Buffer;J)J
    ...
    .line 25
    :cond_1
    invoke-virtual {p1, p0, p2, p3}, Lokio/Buffer;->a(Lokio/Buffer;J)V
...
.method public b(J)Lokio/Buffer;
    .locals 11
    ...
    .line 7
    invoke-virtual {p0, p1}, Lokio/Buffer;->c(Ljava/lang/String;)Lokio/Buffer;
    ...
    .line 8
    :cond_15
    invoke-virtual {p0, v4}, Lokio/Buffer;->b(I)Lokio/Segment;
...
.method public bridge synthetic b(J)Lokio/BufferedSink;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lokio/Buffer;->b(J)Lokio/Buffer;

    return-object p0
.end method

.method b(I)Lokio/Segment;
    .locals 3
...
.method public c(J)Lokio/Buffer;
    .locals 9
    ...
    .line 32
    invoke-virtual {p0, v0}, Lokio/Buffer;->b(I)Lokio/Segment;
...
.method public c(Ljava/lang/String;)Lokio/Buffer;
    .locals 2
...
.method public bridge synthetic c(J)Lokio/BufferedSink;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lokio/Buffer;->c(J)Lokio/Buffer;

    return-object p0
.end method

.method public bridge synthetic c(Ljava/lang/String;)Lokio/BufferedSink;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public d(J)Ljava/lang/String;
    ...
    .line 4
    invoke-virtual {p0, v4, v5}, Lokio/Buffer;->j(J)Ljava/lang/String;
    ...
    .line 7
    invoke-virtual {p0, v2, v3}, Lokio/Buffer;->j(J)Ljava/lang/String;
...
.method public e()I
    ...
    .line 4
    invoke-virtual {p0, v7, v8}, Lokio/Buffer;->h(J)B
...
.method public final g()Lokio/ByteString;
    ...
    .line 3
    invoke-virtual {p0, v1}, Lokio/Buffer;->a(I)Lokio/ByteString;
...
.method j(J)Ljava/lang/String;
    ...
    .line 2
    invoke-virtual {p0, v2, v3}, Lokio/Buffer;->i(J)Ljava/lang/String;
    ...
    .line 4
    :cond_0
    invoke-virtual {p0, p1, p2}, Lokio/Buffer;->i(J)Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    .line 1
    invoke-virtual {p0}, Lokio/Buffer;->g()Lokio/ByteString;
