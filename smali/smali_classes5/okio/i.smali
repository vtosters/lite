...
.method private a()V
    ...
    invoke-interface {v0, v1, v2}, Lokio/e;->f(J)V

    .line 2
    iget-object v0, v6, Lokio/i;->b:Lokio/e;

    invoke-interface {v0}, Lokio/e;->F()Lokio/c;
    ...
    .line 5
    invoke-direct {v6, v2, v1, v0}, Lokio/i;->a(Ljava/lang/String;II)V
    ...
    invoke-interface {v1, v11, v12}, Lokio/e;->f(J)V
    ...
    invoke-interface {v0, v9}, Lokio/e;->a(B)J
    ...
    invoke-interface {v0}, Lokio/e;->L()S

    move-result v0

    iget-object v1, v6, Lokio/i;->e:Ljava/util/zip/CRC32;
    ...
    invoke-direct {v6, v2, v0, v1}, Lokio/i;->a(Ljava/lang/String;II)V
...
.method private b()V
    ...
    invoke-interface {v0}, Lokio/e;->Q()I

    move-result v0

    iget-object v1, p0, Lokio/i;->e:Ljava/util/zip/CRC32;
    ...
    invoke-direct {p0, v1, v0, v2}, Lokio/i;->a(Ljava/lang/String;II)V
...
.method public b(Lokio/c;J)J
    ...
    .line 2
    invoke-direct {p0}, Lokio/i;->a()V

    .line 3
    iput v1, p0, Lokio/i;->a:I
    ...
    invoke-virtual {v0, p1, p2, p3}, Lokio/j;->b(Lokio/c;J)J
    ...
    .line 7
    invoke-direct/range {v5 .. v10}, Lokio/i;->a(Lokio/c;JJ)V

    return-wide p2

    .line 8
    :cond_2
    iput v4, p0, Lokio/i;->a:I

    .line 9
    :cond_3
    iget p1, p0, Lokio/i;->a:I

    if-ne p1, v4, :cond_5

    .line 10
    invoke-direct {p0}, Lokio/i;->b()V
    ...
    .line 12
    iget-object p1, p0, Lokio/i;->b:Lokio/e;

    invoke-interface {p1}, Lokio/e;->N()Z
