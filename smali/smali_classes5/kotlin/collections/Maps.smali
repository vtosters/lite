.class Lkotlin/collections/Maps;
.super Lkotlin/collections/MapsJVM;
.source "Maps.kt"
...
.method public static varargs a([Lkotlin/Pair;)Ljava/util/HashMap;
    ...
    invoke-static {v0, p0}, Lkotlin/collections/Maps;->a(Ljava/util/Map;[Lkotlin/Pair;)V
...
.method public static a(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/Maps;->a(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/Maps;->a(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    invoke-static {v0}, Lkotlin/collections/Maps;->b(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final a(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 14
    invoke-static {p1, p0}, Lkotlin/collections/Maps;->b(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static a(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lkotlin/collections/Maps;->b(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static a(Lkotlin/sequences/Sequence;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {p0, v0}, Lkotlin/collections/Maps;->a(Lkotlin/sequences/Sequence;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final a(Lkotlin/sequences/Sequence;Ljava/util/Map;)Ljava/util/Map;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    .line 17
    invoke-static {p1, p0}, Lkotlin/collections/Maps;->a(Ljava/util/Map;Lkotlin/sequences/Sequence;)V
...
.method public static final a([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 15
    invoke-static {p1, p0}, Lkotlin/collections/Maps;->a(Ljava/util/Map;[Lkotlin/Pair;)V

    return-object p1
.end method

.method public static final a(Ljava/util/Map;Lkotlin/sequences/Sequence;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static b(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 2
    invoke-static {p0, p1}, Lkotlin/collections/MapWithDefault1;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs b([Lkotlin/Pair;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/Maps;->a([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final b(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 6
    :cond_0
    invoke-static {p0}, Lkotlin/collections/MapsJVM;->a(Ljava/util/Map;)Ljava/util/Map;
