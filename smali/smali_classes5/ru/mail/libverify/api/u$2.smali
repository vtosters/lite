...
.method public final a(Ljava/lang/String;Lru/mail/libverify/api/VerificationApi$VerificationStateDescriptor;)V
    ...
    invoke-virtual {v7, v9, v8}, Lru/mail/libverify/a/b$b;->a(Ljava/lang/String;Ljava/lang/String;)Lru/mail/libverify/a/b$b;
    ...
    invoke-virtual {v8}, Lru/mail/libverify/api/VerificationApi$VerificationStateDescriptor;->getSource()Lru/mail/libverify/api/VerificationApi$VerificationSource;
    ...
    const-string v9, "VerificationSource"
    ...
    const-string p2, "temporary session %s state has been removed after completion (%s)"
    ...
    const-string v2, "session %s state changed to %s"
...
.method public final a(Lru/mail/libverify/requests/d;Ljava/lang/Throwable;)V
    ...
    const-string v2, "session received server failure in api %s"
...
.method public final a(Lru/mail/libverify/requests/response/ClientApiResponseBase;)V
    ...
    invoke-virtual {v1}, Lru/mail/libverify/requests/d;->l()Ljava/lang/String;
    ...
    const-string v2, "session received server error in api %s"
...
.method public final b()Lru/mail/libverify/sms/g;
    ...
    iget-object v3, v2, Lru/mail/libverify/api/u;->b:Lru/mail/libverify/utils/b;

    invoke-static {v2}, Lru/mail/libverify/api/u;->o(Lru/mail/libverify/api/u;)Ljava/util/concurrent/ThreadPoolExecutor;

    move-result-object v2

    invoke-direct {v0, v1, v3, v2}, Lru/mail/libverify/sms/h;-><init>(Lru/mail/libverify/storage/k;Landroid/os/Handler;Ljava/util/concurrent/ExecutorService;)V
