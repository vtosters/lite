...
.method private a(Ljava/util/List;)V
    ...
    const-string v2, "account data %s check completed, sms found %d"
...
.method private a(Lru/mail/libverify/api/VerificationApi$AccountCheckResult;)V
    ...
    const-string v2, "failed to check account data %s, error %s"

    invoke-static {v1, v2, v0}, Lru/mail/libverify/utils/d;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static b(Lru/mail/libverify/requests/response/SmsInfo;Lru/mail/libverify/api/f$a;Lru/mail/libverify/api/a$a;)Lru/mail/libverify/sms/c$a;
    ...
    .param p0    # Lru/mail/libverify/requests/response/SmsInfo;
        ...
        .end annotation
    .end param
    .param p1    # Lru/mail/libverify/api/f$a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p2    # Lru/mail/libverify/api/a$a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method private g()V
    ...
    const-string v0, "no application json"
    ...
    const-string v0, "application check has been already completed"
    ...
    const-string v2, "start sms finding process for the account data %s"
    ...
    const-string v2, "sms finding process for the account data %s has been already started"
...
.method private h()V
    ...
    const-string v2, "account_check_time"
...
.method final a()V
    ...
    iget-object v1, p0, Lru/mail/libverify/api/a;->f:Lru/mail/libverify/api/g;
    ...
    iput-object v1, p0, Lru/mail/libverify/api/a;->a:Lru/mail/libverify/requests/response/SmsInfo;

    iput-object v1, p0, Lru/mail/libverify/api/a;->h:Ljava/util/List;

    iget-object v2, p0, Lru/mail/libverify/api/a;->i:Ljava/util/concurrent/Future;
...
.method final a(Ljava/lang/String;Lru/mail/libverify/api/VerificationApi$AccountCheckListener;)V
    ...
    const-string p1, "account data %s check dismissed by timeout"

    invoke-static {v1, p1, p2}, Lru/mail/libverify/utils/d;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v2, "account data %s check started"
...
.method public final a(Landroid/os/Message;)Z
    ...
    :goto_0
    iput-object v3, p0, Lru/mail/libverify/api/a;->i:Ljava/util/concurrent/Future;
...
.method final b()V
    ...
    invoke-direct {v0, v2}, Lru/mail/libverify/api/a$a;-><init>(B)V

    new-instance v3, Lru/mail/libverify/api/f$a;

    invoke-direct {v3}, Lru/mail/libverify/api/f$a;-><init>()V

    iget-object v4, p0, Lru/mail/libverify/api/a;->a:Lru/mail/libverify/requests/response/SmsInfo;

    invoke-virtual {v4}, Lru/mail/libverify/requests/response/SmsInfo;->getSmsTemplates()[Ljava/lang/String;

    move-result-object v4

    iput-object v4, v3, Lru/mail/libverify/api/f$a;->b:[Ljava/lang/String;

    iget-object v4, p0, Lru/mail/libverify/api/a;->a:Lru/mail/libverify/requests/response/SmsInfo;

    invoke-static {v4, v3, v0}, Lru/mail/libverify/api/a;->b(Lru/mail/libverify/requests/response/SmsInfo;Lru/mail/libverify/api/f$a;Lru/mail/libverify/api/a$a;)Lru/mail/libverify/sms/c$a;

    move-result-object v3

    iget-object v4, p0, Lru/mail/libverify/api/a;->f:Lru/mail/libverify/api/g;

    invoke-interface {v4}, Lru/mail/libverify/api/g;->a()Lru/mail/libverify/storage/k;

    move-result-object v4

    invoke-interface {v4}, Lru/mail/libverify/storage/k;->r()Lru/mail/libverify/sms/c;

    move-result-object v4

    iget-object v5, p0, Lru/mail/libverify/api/a;->d:Ljava/util/Map;

    invoke-interface {v5}, Ljava/util/Map;->values()Ljava/util/Collection;

    move-result-object v5

    invoke-interface {v4, v3, v5}, Lru/mail/libverify/sms/c;->a(Lru/mail/libverify/sms/c$a;Ljava/util/Collection;)Ljava/util/List;

    move-result-object v3

    invoke-static {v3}, Lru/mail/libverify/api/a;->b(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-interface {v0, v3}, Lru/mail/libverify/api/b;->a(Ljava/lang/String;)V
    :try_end_1
    ...
    :catchall_0
    :try_start_2
    const-string v0, "failed to process intercepted sms"
    ...
    :cond_3
    :goto_0
    const-string v0, "no intercepted sms"
...
.method final d()V
    ...
    const-string v0, "account_check_intercepted_sms"
    ...
    const-string v2, "account_check_app_json"

    invoke-interface {v1, v2}, Lru/mail/libverify/storage/o;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lru/mail/libverify/api/a;->c:Ljava/lang/String;

    :cond_0
    iget-object v1, p0, Lru/mail/libverify/api/a;->d:Ljava/util/Map;
    ...
    invoke-interface {v1, v0}, Lru/mail/libverify/storage/o;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-class v2, Lru/mail/libverify/sms/SmsItem;

    invoke-static {v1, v2}, Lru/mail/libverify/utils/json/a;->c(Ljava/lang/String;Ljava/lang/Class;)Ljava/util/HashMap;

    move-result-object v1

    iput-object v1, p0, Lru/mail/libverify/api/a;->d:Ljava/util/Map;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v2, "failed to restore intercepted sms"
    ...
    invoke-interface {v1, v0}, Lru/mail/libverify/storage/o;->c(Ljava/lang/String;)Lru/mail/libverify/storage/o;
