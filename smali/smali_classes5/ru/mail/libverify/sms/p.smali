...
.method public constructor <init>(Lru/mail/libverify/storage/k;Lru/mail/libverify/sms/o;Landroid/os/Handler;)V
    ...
    .param p1    # Lru/mail/libverify/storage/k;
        ...
        .end annotation
    .end param
    .param p2    # Lru/mail/libverify/sms/o;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method private b()V
    ...
    iget-object v0, p0, Lru/mail/libverify/sms/p;->h:Lcom/google/android/gms/tasks/g;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/auth/c/d/c;->startSmsRetriever()Lcom/google/android/gms/tasks/g;

    move-result-object v0

    iput-object v0, p0, Lru/mail/libverify/sms/p;->h:Lcom/google/android/gms/tasks/g;

    iget-object v0, p0, Lru/mail/libverify/sms/p;->h:Lcom/google/android/gms/tasks/g;

    new-instance v2, Lru/mail/libverify/sms/p$1;

    invoke-direct {v2, p0}, Lru/mail/libverify/sms/p$1;-><init>(Lru/mail/libverify/sms/p;)V

    invoke-virtual {v0, v2}, Lcom/google/android/gms/tasks/g;->a(Lcom/google/android/gms/tasks/c;)Lcom/google/android/gms/tasks/g;

    iget-object v0, p0, Lru/mail/libverify/sms/p;->h:Lcom/google/android/gms/tasks/g;

    new-instance v2, Lru/mail/libverify/sms/p$2;

    invoke-direct {v2, p0}, Lru/mail/libverify/sms/p$2;-><init>(Lru/mail/libverify/sms/p;)V

    invoke-virtual {v0, v2}, Lcom/google/android/gms/tasks/g;->a(Lcom/google/android/gms/tasks/d;)Lcom/google/android/gms/tasks/g;
    :try_end_0
    ...
    :cond_0
    const-string v0, "SmsRetrieverClient has been already subscribed"
...
.method static synthetic c(Lru/mail/libverify/sms/p;)Lcom/google/android/gms/tasks/g;
    .locals 1
...
.method public final a(ILjava/lang/String;)V
    ...
    const-string v2, "received status: %s with sms text: %s"
...
.method public final a(Lru/mail/libverify/sms/n$a;)V
    .locals 1
    .param p1    # Lru/mail/libverify/sms/n$a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public final a()Z
    ...
    :goto_1
    const-string v2, "SmsRetrieverManager"

    if-eqz v0, :cond_2

    const-string v0, "no reason to use sms retriever (has permissions)"
    ...
    const-string v0, "there were an error in sms retriever api"
