...
.method private d(Lru/mail/libverify/requests/response/FetcherInfo;)V
    ...
    invoke-interface {v2, v1, p1}, Lru/mail/libverify/storage/o;->a(Ljava/lang/String;Ljava/lang/String;)Lru/mail/libverify/storage/o;
...
.method public final a(Landroid/os/Message;)Z
    ...
    :pswitch_5
    const-string v0, "server info received from fetcher"
    ...
    sget-object v2, Lru/mail/libverify/api/v;->ARG1:Ljava/lang/String;
    ...
    iget-object v2, p0, Lru/mail/libverify/fetcher/d;->b:Lru/mail/libverify/fetcher/e;

    iget-object v3, p0, Lru/mail/libverify/fetcher/d;->a:Lru/mail/libverify/api/g;

    invoke-interface {v3}, Lru/mail/libverify/api/g;->a()Lru/mail/libverify/storage/k;

    move-result-object v3

    invoke-interface {v3, v0, p1}, Lru/mail/libverify/storage/k;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-interface {v2, p1}, Lru/mail/libverify/fetcher/e;->a(Ljava/lang/String;)V
    :try_end_0
    ...
    :goto_0
    const-string v0, "unexpected error during fetcher message decryption"

    goto :goto_2

    :goto_1
    const-string v0, "fetcher message decryption error"
...
.method public final declared-synchronized a(Lru/mail/libverify/fetcher/d$b;Ljava/lang/String;Z)Z
    ...
    iget-object v2, p0, Lru/mail/libverify/fetcher/d;->c:Lru/mail/libverify/fetcher/d$b;
...
.method final e()V
    ...
    invoke-interface {v3}, Lru/mail/libverify/api/g;->c()Lru/mail/libverify/storage/o;

    move-result-object v3

    const-string v4, "fetcher_state"
    ...
    invoke-static {v3}, Lru/mail/libverify/fetcher/d$b;->valueOf(Ljava/lang/String;)Lru/mail/libverify/fetcher/d$b;

    move-result-object v3

    iput-object v3, p0, Lru/mail/libverify/fetcher/d;->c:Lru/mail/libverify/fetcher/d$b;

    :cond_2
    :try_start_0
    const-class v3, Lru/mail/libverify/requests/response/FetcherInfo;

    invoke-static {v1, v3}, Lru/mail/libverify/utils/json/a;->a(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lru/mail/libverify/requests/response/FetcherInfo;

    iput-object v1, p0, Lru/mail/libverify/fetcher/d;->d:Lru/mail/libverify/requests/response/FetcherInfo;
    ...
    iget-object v6, p0, Lru/mail/libverify/fetcher/d;->d:Lru/mail/libverify/requests/response/FetcherInfo;

    aput-object v6, v3, v5

    const/4 v5, 0x1

    iget-object v6, p0, Lru/mail/libverify/fetcher/d;->c:Lru/mail/libverify/fetcher/d$b;
    ...
    sget-object v3, Lru/mail/libverify/fetcher/d$b;->NOT_ACTIVE:Lru/mail/libverify/fetcher/d$b;
    ...
    invoke-interface {v3, v2}, Lru/mail/libverify/storage/o;->c(Ljava/lang/String;)Lru/mail/libverify/storage/o;

    move-result-object v2

    invoke-interface {v2, v4}, Lru/mail/libverify/storage/o;->c(Ljava/lang/String;)Lru/mail/libverify/storage/o;
    ...
    invoke-static {v0, v2, v1}, Lru/mail/libverify/utils/c;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
