...
.method public constructor <init>(Lru/mail/libverify/api/g;Lru/mail/libverify/notifications/d;)V
    ...
    .param p1    # Lru/mail/libverify/api/g;
        ...
        .end annotation
    .end param
    .param p2    # Lru/mail/libverify/notifications/d;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method private a(Ljava/lang/String;Landroid/app/Notification;)V
    ...
    invoke-virtual {v1, p1, v3, p2}, Landroid/app/NotificationManager;->notify(Ljava/lang/String;ILandroid/app/Notification;)V
    :try_end_0
    ...
    const-string p2, "safeNotify error"
...
.method private a(Lru/mail/libverify/notifications/e;)V
    ...
    const-string v3, "ru.mail.libverify.notifications.high"

    const-string v4, "libverify notifications high"
    ...
    :cond_0
    invoke-virtual {p1}, Lru/mail/libverify/notifications/e;->c()Landroidx/core/app/NotificationCompat$Builder;
...
.method public final a(Lru/mail/libverify/gcm/ServerNotificationMessage;Z)V
    ...
    invoke-virtual {v0}, Lru/mail/libverify/notifications/g;->b()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lru/mail/libverify/notifications/g;->f()Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-virtual {v0}, Lru/mail/libverify/notifications/g;->g()Ljava/lang/Long;
    ...
    const-string v3, "notification %s ongoing timeout %d"
