...
.method public constructor <init>(Lru/mail/libverify/api/g;Lru/mail/libverify/storage/a/f;)V
    ...
    .param p1    # Lru/mail/libverify/api/g;
        ...
        .end annotation
    .end param
    .param p2    # Lru/mail/libverify/storage/a/f;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method private a(JLjava/lang/Long;Ljava/lang/Integer;)I
    ...
    const-string v6, "load sms items offset %s, count %s"

    invoke-static {v5, v6, v2}, Lru/mail/libverify/utils/d;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v2, v1, Lru/mail/libverify/storage/a/e;->d:Lru/mail/libverify/storage/a/b;
    ...
    invoke-direct {v1, v5, v0}, Lru/mail/libverify/storage/a/e;->b(Ljava/lang/Long;Ljava/lang/String;)Lru/mail/libverify/storage/a/c;

    move-result-object v0

    if-eqz v0, :cond_3

    new-instance v5, Lru/mail/libverify/storage/a/d;

    invoke-virtual {v0}, Lru/mail/libverify/storage/a/c;->getFrom()Ljava/lang/String;

    move-result-object v8

    move-object v7, v5

    invoke-direct/range {v7 .. v15}, Lru/mail/libverify/storage/a/d;-><init>(Ljava/lang/String;Ljava/lang/String;JJJ)V

    iput-boolean v4, v5, Lru/mail/libverify/storage/a/d;->a:Z

    invoke-virtual {v0, v5}, Lru/mail/libverify/storage/a/c;->a(Lru/mail/libverify/storage/a/d;)V
    ...
    const-string v6, "Found a reference to not existing dialog id %d"
...
.method private a(Lru/mail/libverify/storage/a/c;Ljava/lang/Long;Ljava/lang/Integer;)I
    .locals 6
    .param p1    # Lru/mail/libverify/storage/a/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    const-string p1, "load items is not necessary for dialog %s"

    invoke-static {v1, p1, p2}, Lru/mail/libverify/utils/d;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v4, v5, p2, p3}, Lru/mail/libverify/storage/a/e;->a(JLjava/lang/Long;Ljava/lang/Integer;)I
    ...
    invoke-static {v1, v0, p3}, Lru/mail/libverify/utils/d;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iput-boolean v3, p1, Lru/mail/libverify/storage/a/c;->d:Z
...
.method private a()V
    ...
    const-string v0, "database has been dropped successfully"
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/util/HashMap;[Ljava/lang/String;[J[Ljava/lang/String;[J)V
    ...
    invoke-direct {v0, v4, v7}, Lru/mail/libverify/storage/a/e;->b(Ljava/lang/Long;Ljava/lang/String;)Lru/mail/libverify/storage/a/c;

    move-result-object v4

    if-eqz v4, :cond_1

    iget-object v7, v0, Lru/mail/libverify/storage/a/e;->h:Landroid/database/sqlite/SQLiteStatement;

    if-nez v7, :cond_0

    sget-object v7, Lru/mail/libverify/storage/a/b;->e:Ljava/lang/String;
    ...
    iput-object v7, v0, Lru/mail/libverify/storage/a/e;->h:Landroid/database/sqlite/SQLiteStatement;
    ...
    invoke-virtual {v7, v6, v9, v10}, Landroid/database/sqlite/SQLiteStatement;->bindLong(IJ)V

    const/4 v6, 0x4

    aget-object v9, p5, v3

    invoke-virtual {v7, v6, v9}, Landroid/database/sqlite/SQLiteStatement;->bindString(ILjava/lang/String;)V

    aget-wide v9, p6, v3

    invoke-virtual {v7, v5, v9, v10}, Landroid/database/sqlite/SQLiteStatement;->bindLong(IJ)V

    const/4 v5, 0x3

    invoke-virtual {v4}, Lru/mail/libverify/storage/a/c;->getId()J
    ...
    invoke-direct/range {v11 .. v19}, Lru/mail/libverify/storage/a/d;-><init>(Ljava/lang/String;Ljava/lang/String;JJJ)V

    invoke-virtual {v4, v5}, Lru/mail/libverify/storage/a/c;->a(Lru/mail/libverify/storage/a/d;)V
    ...
    const-string v5, "Failed to get dialog with name "
    ...
    const-string v2, "%d sms inserted into %d dialogs"
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Lru/mail/libverify/storage/a/c;Lru/mail/libverify/api/VerificationApi$SmsItem;Z)V
    ...
    .param p1    # Landroid/database/sqlite/SQLiteDatabase;
        ...
        .end annotation
    .end param
    .param p2    # Lru/mail/libverify/storage/a/c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p3    # Lru/mail/libverify/api/VerificationApi$SmsItem;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    ...
    const-string v3, "dialog %s marked as unread"

    invoke-static {v0, v3, p4}, Lru/mail/libverify/utils/d;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string p1, "dialog %s updated with last sms %s"

    invoke-static {v0, p1, p4}, Lru/mail/libverify/utils/d;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private a(Ljava/lang/Long;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v2}, Lru/mail/libverify/storage/a/e;->b(Ljava/lang/Long;Ljava/lang/String;)Lru/mail/libverify/storage/a/c;
    ...
    :cond_0
    invoke-direct {p0, v2, p2}, Lru/mail/libverify/storage/a/e;->b(Ljava/lang/Long;Ljava/lang/String;)Lru/mail/libverify/storage/a/c;
    ...
    :cond_1
    iget-object v2, p0, Lru/mail/libverify/storage/a/e;->d:Lru/mail/libverify/storage/a/b;
    ...
    iget-object v4, p0, Lru/mail/libverify/storage/a/e;->k:Landroid/database/sqlite/SQLiteStatement;

    if-nez v4, :cond_2

    sget-object v4, Lru/mail/libverify/storage/a/b;->c:Ljava/lang/String;
    ...
    iput-object v4, p0, Lru/mail/libverify/storage/a/e;->k:Landroid/database/sqlite/SQLiteStatement;
    ...
    invoke-virtual {v4, v3, v5, v6}, Landroid/database/sqlite/SQLiteStatement;->bindLong(IJ)V
    ...
    iget-object v4, p0, Lru/mail/libverify/storage/a/e;->l:Landroid/database/sqlite/SQLiteStatement;

    if-nez v4, :cond_3

    sget-object v4, Lru/mail/libverify/storage/a/b;->f:Ljava/lang/String;

    invoke-virtual {v2, v4}, Landroid/database/sqlite/SQLiteDatabase;->compileStatement(Ljava/lang/String;)Landroid/database/sqlite/SQLiteStatement;

    move-result-object v4

    iput-object v4, p0, Lru/mail/libverify/storage/a/e;->l:Landroid/database/sqlite/SQLiteStatement;
    ...
    iget-object v4, p0, Lru/mail/libverify/storage/a/e;->e:Ljava/util/TreeMap;
    ...
    iget-object v4, p0, Lru/mail/libverify/storage/a/e;->f:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lru/mail/libverify/storage/a/e;->a:Lru/mail/libverify/storage/a/f;

    invoke-interface {p1}, Lru/mail/libverify/api/VerificationApi$SmsDialogItem;->getFrom()Ljava/lang/String;

    move-result-object v5

    invoke-interface {v4, v5}, Lru/mail/libverify/storage/a/f;->b(Ljava/lang/String;)V
    ...
    :cond_4
    :try_start_3
    new-instance v4, Landroid/database/sqlite/SQLiteConstraintException;

    new-instance v5, Ljava/lang/StringBuilder;

    const-string v6, "Failed to remove sms for dialog "
    ...
    invoke-direct {v4, p1}, Landroid/database/sqlite/SQLiteConstraintException;-><init>(Ljava/lang/String;)V
    ...
    const-string v6, "Failed to remove sms dialog "
    ...
    const-string p2, "failed to remove sms dialog %s"

    invoke-static {v1, p1, p2, v2}, Lru/mail/libverify/utils/d;->a(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private a(Ljava/lang/Long;Ljava/lang/String;J)V
    ...
    :cond_1
    iget-object v5, p0, Lru/mail/libverify/storage/a/e;->d:Lru/mail/libverify/storage/a/b;
    ...
    iget-object v6, p0, Lru/mail/libverify/storage/a/e;->m:Landroid/database/sqlite/SQLiteStatement;

    if-nez v6, :cond_2

    sget-object v6, Lru/mail/libverify/storage/a/b;->g:Ljava/lang/String;
    ...
    iput-object v6, p0, Lru/mail/libverify/storage/a/e;->m:Landroid/database/sqlite/SQLiteStatement;

    :cond_2
    iget-object v6, p0, Lru/mail/libverify/storage/a/e;->m:Landroid/database/sqlite/SQLiteStatement;

    invoke-virtual {v6, v4, p3, p4}, Landroid/database/sqlite/SQLiteStatement;->bindLong(IJ)V
    ...
    invoke-static {v1, v6, v7}, Lru/mail/libverify/utils/d;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p2, p3, p4}, Lru/mail/libverify/storage/a/c;->a(J)V

    invoke-virtual {p2, v4}, Lru/mail/libverify/storage/a/c;->a(Z)Lru/mail/libverify/api/VerificationApi$SmsItem;

    move-result-object v6

    if-eqz v6, :cond_3

    invoke-direct {p0, v5, p2, v6, v3}, Lru/mail/libverify/storage/a/e;->a(Landroid/database/sqlite/SQLiteDatabase;Lru/mail/libverify/storage/a/c;Lru/mail/libverify/api/VerificationApi$SmsItem;Z)V
    ...
    invoke-direct {p0, v6, v7, v2, v8}, Lru/mail/libverify/storage/a/e;->a(JLjava/lang/Long;Ljava/lang/Integer;)I
    ...
    invoke-direct {p0, v5, p2, v2, v3}, Lru/mail/libverify/storage/a/e;->a(Landroid/database/sqlite/SQLiteDatabase;Lru/mail/libverify/storage/a/c;Lru/mail/libverify/api/VerificationApi$SmsItem;Z)V
    ...
    iget-object v2, p0, Lru/mail/libverify/storage/a/e;->a:Lru/mail/libverify/storage/a/f;

    invoke-virtual {p2}, Lru/mail/libverify/storage/a/c;->getFrom()Ljava/lang/String;

    move-result-object v6

    invoke-interface {v2, v6}, Lru/mail/libverify/storage/a/f;->c(Ljava/lang/String;)V

    const-string v2, "dialog %s updated after sms removal"
    ...
    const-string v2, "Failed to remove sms "
    ...
    invoke-direct {p2, v2}, Landroid/database/sqlite/SQLiteConstraintException;-><init>(Ljava/lang/String;)V
    ...
    const-string p1, "failed to remove sms from dialog %d %d"

    invoke-static {v1, p2, p1, v0}, Lru/mail/libverify/utils/d;->a(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private a([Ljava/lang/String;[Ljava/lang/String;[J[J)V
    ...
    const-string v1, "insert sms from %s text %s timestamp %d (%d)"
    ...
    invoke-static {v9, v1, v2}, Lru/mail/libverify/utils/d;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    goto :goto_0

    :cond_0
    const-string v1, "insert sms %d sms"
    ...
    invoke-direct {p0, v13, v14}, Lru/mail/libverify/storage/a/e;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/util/HashMap;)V

    invoke-virtual {v13}, Landroid/database/sqlite/SQLiteDatabase;->setTransactionSuccessful()V

    invoke-direct {p0, v14}, Lru/mail/libverify/storage/a/e;->a(Ljava/util/HashMap;)V
    ...
    const-string v1, "sms from %s text %s has been inserted"
    ...
    :cond_2
    const-string v1, "sms inserted count %d"
    ...
    const-string v1, "Failed to insert sms"

    invoke-static {v9, v1, v0}, Lru/mail/libverify/utils/d;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private b(Ljava/lang/Long;Ljava/lang/String;)Lru/mail/libverify/storage/a/c;
    ...
    iget-object v3, v1, Lru/mail/libverify/storage/a/e;->e:Ljava/util/TreeMap;

    const-string v4, "Dialog %s has been already added"

    const/4 v5, 0x2

    const-string v6, "SmsStorage"
    ...
    const-string v3, "read dialogs from db"

    invoke-static {v6, v3}, Lru/mail/libverify/utils/d;->c(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v3, Ljava/util/TreeMap;

    invoke-direct {v3}, Ljava/util/TreeMap;-><init>()V

    iput-object v3, v1, Lru/mail/libverify/storage/a/e;->e:Ljava/util/TreeMap;

    new-instance v3, Ljava/util/HashMap;

    invoke-direct {v3}, Ljava/util/HashMap;-><init>()V

    iput-object v3, v1, Lru/mail/libverify/storage/a/e;->f:Ljava/util/HashMap;

    :try_start_0
    iget-object v3, v1, Lru/mail/libverify/storage/a/e;->d:Lru/mail/libverify/storage/a/b;

    invoke-virtual {v3}, Landroid/database/sqlite/SQLiteOpenHelper;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v3

    sget-object v10, Lru/mail/libverify/storage/a/b;->h:Ljava/lang/String;

    invoke-virtual {v3, v10, v7}, Landroid/database/sqlite/SQLiteDatabase;->rawQuery(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    new-instance v8, Lru/mail/libverify/storage/a/c;

    invoke-direct {v8, v12, v10, v11}, Lru/mail/libverify/storage/a/c;-><init>(Ljava/lang/String;J)V

    iput-object v15, v8, Lru/mail/libverify/storage/a/c;->b:Ljava/lang/String;

    iput-wide v13, v8, Lru/mail/libverify/storage/a/c;->a:J

    invoke-virtual {v5}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v5

    iput-boolean v5, v8, Lru/mail/libverify/storage/a/c;->c:Z

    iget-object v5, v1, Lru/mail/libverify/storage/a/e;->e:Ljava/util/TreeMap;

    invoke-static {v10, v11}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v13

    invoke-virtual {v5, v13, v8}, Ljava/util/TreeMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v5, v1, Lru/mail/libverify/storage/a/e;->f:Ljava/util/HashMap;
    ...
    :cond_6
    :goto_2
    const-string v0, "found dialogs count %d"

    new-array v5, v9, [Ljava/lang/Object;

    iget-object v8, v1, Lru/mail/libverify/storage/a/e;->e:Ljava/util/TreeMap;
    ...
    invoke-static {v6, v0, v5}, Lru/mail/libverify/utils/d;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iget-object v0, v1, Lru/mail/libverify/storage/a/e;->f:Ljava/util/HashMap;
    ...
    check-cast v7, Lru/mail/libverify/storage/a/c;
    ...
    iget-object v0, v1, Lru/mail/libverify/storage/a/e;->d:Lru/mail/libverify/storage/a/b;
    ...
    :try_start_2
    iget-object v0, v1, Lru/mail/libverify/storage/a/e;->g:Landroid/database/sqlite/SQLiteStatement;
    ...
    iput-object v0, v1, Lru/mail/libverify/storage/a/e;->g:Landroid/database/sqlite/SQLiteStatement;

    :cond_b
    iget-object v0, v1, Lru/mail/libverify/storage/a/e;->g:Landroid/database/sqlite/SQLiteStatement;

    invoke-virtual {v0, v9, v2}, Landroid/database/sqlite/SQLiteStatement;->bindString(ILjava/lang/String;)V

    invoke-virtual {v0}, Landroid/database/sqlite/SQLiteStatement;->executeInsert()J

    move-result-wide v7

    new-instance v0, Lru/mail/libverify/storage/a/c;

    invoke-direct {v0, v2, v7, v8}, Lru/mail/libverify/storage/a/c;-><init>(Ljava/lang/String;J)V
    ...
    const-string v4, "added dialog from %s %s"
    ...
    invoke-static {v6, v4, v5}, Lru/mail/libverify/utils/d;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private b(Ljava/lang/String;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Integer;Lru/mail/libverify/api/VerificationApi$SmsListener;)V
    ...
    invoke-direct {p0, v3, v4, v4}, Lru/mail/libverify/storage/a/e;->a(Lru/mail/libverify/storage/a/c;Ljava/lang/Long;Ljava/lang/Integer;)I

    new-instance p3, Ljava/util/ArrayList;

    iget-object p4, v3, Lru/mail/libverify/storage/a/c;->e:Lru/mail/libverify/storage/a/a;
    ...
    iget-object v4, v3, Lru/mail/libverify/storage/a/c;->e:Lru/mail/libverify/storage/a/a;

    invoke-virtual {v4, p4}, Lru/mail/libverify/storage/a/a;->a(I)Lru/mail/libverify/storage/a/a$a;

    move-result-object v4

    check-cast v4, Lru/mail/libverify/storage/a/d;

    iget-boolean v5, v4, Lru/mail/libverify/storage/a/d;->a:Z
    ...
    const-string v4, "all %d sms:\n%s"

    const/4 v5, 0x2

    new-array v5, v5, [Ljava/lang/Object;

    iget-object v6, v3, Lru/mail/libverify/storage/a/c;->e:Lru/mail/libverify/storage/a/a;

    iget-object v6, v6, Lru/mail/libverify/storage/a/a;->a:Ljava/util/ArrayList;
    ...
    invoke-static {p4, v4, v5}, Lru/mail/libverify/utils/d;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v3, p3}, Lru/mail/libverify/storage/a/c;->a(I)Ljava/util/List;
    ...
    invoke-direct {p0, v3, v4, p4}, Lru/mail/libverify/storage/a/e;->a(Lru/mail/libverify/storage/a/c;Ljava/lang/Long;Ljava/lang/Integer;)I
    ...
    iget-object v6, v3, Lru/mail/libverify/storage/a/c;->f:Ljava/util/TreeMap;
    ...
    check-cast v4, Lru/mail/libverify/api/VerificationApi$SmsItem;

    check-cast v4, Lru/mail/libverify/storage/a/d;

    if-nez v4, :cond_4

    invoke-direct {p0, v3, p3, p4}, Lru/mail/libverify/storage/a/e;->a(Lru/mail/libverify/storage/a/c;Ljava/lang/Long;Ljava/lang/Integer;)I
    ...
    :goto_1
    invoke-virtual {v3, v4, v5, p3}, Lru/mail/libverify/storage/a/c;->a(JI)Ljava/util/List;
    ...
    invoke-virtual {v3, v4, p3}, Lru/mail/libverify/storage/a/c;->a(Lru/mail/libverify/storage/a/d;I)Ljava/util/List;
    ...
    invoke-virtual {v4}, Lru/mail/libverify/storage/a/d;->getId()J
    ...
    :cond_5
    :goto_2
    invoke-virtual {v3}, Lru/mail/libverify/storage/a/c;->hasUnread()Z
    ...
    iget-object v4, p0, Lru/mail/libverify/storage/a/e;->j:Landroid/database/sqlite/SQLiteStatement;

    if-nez v4, :cond_6

    sget-object v4, Lru/mail/libverify/storage/a/b;->d:Ljava/lang/String;

    invoke-virtual {p4, v4}, Landroid/database/sqlite/SQLiteDatabase;->compileStatement(Ljava/lang/String;)Landroid/database/sqlite/SQLiteStatement;

    move-result-object v4

    iput-object v4, p0, Lru/mail/libverify/storage/a/e;->j:Landroid/database/sqlite/SQLiteStatement;

    :cond_6
    iget-object v4, p0, Lru/mail/libverify/storage/a/e;->j:Landroid/database/sqlite/SQLiteStatement;

    invoke-virtual {v3}, Lru/mail/libverify/storage/a/c;->getId()J

    move-result-wide v5

    invoke-virtual {v4, v2, v5, v6}, Landroid/database/sqlite/SQLiteStatement;->bindLong(IJ)V
    ...
    iput-boolean v1, v3, Lru/mail/libverify/storage/a/c;->c:Z
    ...
    invoke-virtual {v3}, Lru/mail/libverify/storage/a/c;->getFrom()Ljava/lang/String;
    ...
    invoke-direct {p0, v3}, Lru/mail/libverify/storage/a/e;->a(Lru/mail/libverify/api/VerificationApi$SmsDialogItem;)V
    ...
    invoke-interface {v4, v3}, Lru/mail/libverify/storage/a/f;->d(Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v5, "Failed to update sms dialog "
    ...
    invoke-direct {p3, v3}, Landroid/database/sqlite/SQLiteConstraintException;-><init>(Ljava/lang/String;)V
    ...
    const-string p1, "failed to query sms for dialog %s"

    invoke-static {v0, p3, p1, p4}, Lru/mail/libverify/utils/d;->a(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final a(Landroid/os/Message;)Z
    ...
    sget-object v3, Lru/mail/libverify/storage/a/g;->ARG2:Ljava/lang/String;
    ...
    sget-object v4, Lru/mail/libverify/storage/a/g;->ARG3:Ljava/lang/String;
    ...
    sget-object v4, Lru/mail/libverify/storage/a/g;->ARG4:Ljava/lang/String;

    invoke-virtual {p1, v4}, Landroid/os/Bundle;->getLongArray(Ljava/lang/String;)[J

    move-result-object p1

    invoke-direct {p0, v0, v2, v3, p1}, Lru/mail/libverify/storage/a/e;->a([Ljava/lang/String;[Ljava/lang/String;[J[J)V
    ...
    sget-object v3, Lru/mail/libverify/storage/a/g;->ARG1:Ljava/lang/String;

    invoke-virtual {p1, v3}, Landroid/os/Bundle;->getLong(Ljava/lang/String;)J

    move-result-wide v3

    invoke-direct {p0, v2, v0, v3, v4}, Lru/mail/libverify/storage/a/e;->a(Ljava/lang/Long;Ljava/lang/String;J)V
    ...
    invoke-direct {p0, v0, v2, v3, v4}, Lru/mail/libverify/storage/a/e;->a(Ljava/lang/Long;Ljava/lang/String;J)V
    ...
    invoke-direct {p0, v2, p1}, Lru/mail/libverify/storage/a/e;->a(Ljava/lang/Long;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v2}, Lru/mail/libverify/storage/a/e;->a(Ljava/lang/Long;Ljava/lang/String;)V
    ...
    check-cast v9, Lru/mail/libverify/api/VerificationApi$SmsListener;

    move-object v4, p0

    invoke-direct/range {v4 .. v9}, Lru/mail/libverify/storage/a/e;->b(Ljava/lang/String;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Integer;Lru/mail/libverify/api/VerificationApi$SmsListener;)V
