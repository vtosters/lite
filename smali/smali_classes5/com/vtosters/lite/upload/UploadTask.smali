...
.super Lcom/vtosters/lite/l0/VkInstantJob;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        ">",
        "Lcom/vtosters/lite/l0/VkInstantJob;"
    }
.end annotation
...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0}, Lcom/vtosters/lite/l0/VkInstantJob;-><init>()V

    const/4 v0, 0x1

    .line 2
    iput v0, p0, Lcom/vtosters/lite/upload/UploadTask;->e:I
    ...
    iget v1, p0, Lcom/vtosters/lite/upload/UploadTask;->b:I
...
.method public a(Lcom/vtosters/lite/l0/JobsPayload;)V
    .locals 2

    .line 4
    sget-object p1, Lcom/vk/pushes/NotificationChannelsController;->c:Lcom/vk/pushes/NotificationChannelsController;
    ...
    invoke-virtual {p1, v0, v1}, Lcom/vk/pushes/NotificationChannelsController;->a(Landroid/content/Context;Z)V

    return-void
.end method

.method public a(Lcom/vtosters/lite/l0/JobsPayload;Lcom/vk/instantjobs/InstantJob$b;)V
    .locals 0
    ...
    invoke-virtual {p1, p0}, Lcom/vtosters/lite/upload/Upload;->a(Lcom/vtosters/lite/upload/UploadTask;)V

    return-void
.end method

.method public a(Lcom/vtosters/lite/l0/JobsPayload;Ljava/lang/Throwable;)V
    .locals 1
...
.method public a(Lcom/vtosters/lite/l0/JobsPayload;Ljava/util/Map;Landroidx/core/app/NotificationCompat$Builder;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/vtosters/lite/l0/JobsPayload;",
            "Ljava/util/Map<",
    ...
    invoke-virtual {p1, p0, p3}, Lcom/vtosters/lite/upload/UploadNotification;->a(Lcom/vtosters/lite/upload/UploadTask;Landroidx/core/app/NotificationCompat$Builder;)V
...
.method public b(Lcom/vtosters/lite/l0/JobsPayload;)Ljava/lang/String;
    .locals 0
...
.method public c(Lcom/vtosters/lite/l0/JobsPayload;)I
    .locals 0
...
.method public e()Lcom/vk/instantjobs/InstantJob$NotificationShowCondition;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/vtosters/lite/upload/UploadTask;->s()Z
...
.method public abstract p()Lcom/vk/dto/common/data/UploadServer;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
        }
...
.method public q()I
    ...
    .line 1
    iget v0, p0, Lcom/vtosters/lite/upload/UploadTask;->e:I
...
.method public t()V
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0}, Lcom/vtosters/lite/upload/UploadTask;->l()V

    const/4 v1, 0x0

    .line 2
    :goto_0
    invoke-virtual {p0}, Lcom/vtosters/lite/upload/UploadTask;->q()I
    ...
    .line 3
    invoke-virtual {p0}, Lcom/vtosters/lite/upload/UploadTask;->p()Lcom/vk/dto/common/data/UploadServer;

    move-result-object v2

    .line 4
    invoke-virtual {v2}, Lcom/vk/dto/common/data/UploadServer;->b()Ljava/lang/String;
    ...
    .line 5
    :try_start_1
    invoke-virtual {p0, v3}, Lcom/vtosters/lite/upload/UploadTask;->b(Ljava/lang/String;)V
    :try_end_1
    ...
    .line 6
    :try_start_2
    invoke-virtual {v2}, Lcom/vk/dto/common/data/UploadServer;->a()Ljava/lang/String;
    ...
    .line 8
    :try_start_3
    invoke-virtual {p0, v2}, Lcom/vtosters/lite/upload/UploadTask;->a(Ljava/lang/String;)V

    .line 9
    invoke-virtual {p0, v2}, Lcom/vtosters/lite/upload/UploadTask;->b(Ljava/lang/String;)V
    :try_end_3
    ...
    .line 12
    :cond_2
    invoke-virtual {p0}, Lcom/vtosters/lite/upload/UploadTask;->u()Landroid/os/Parcelable;

    move-result-object v1

    .line 13
    invoke-virtual {p0, v1}, Lcom/vtosters/lite/upload/UploadTask;->a(Landroid/os/Parcelable;)V

    .line 14
    iget-object v2, p0, Lcom/vtosters/lite/upload/UploadTask;->d:Lcom/vtosters/lite/upload/UploadNotification;

    invoke-virtual {v2, p0, v1}, Lcom/vtosters/lite/upload/UploadNotification;->a(Lcom/vtosters/lite/upload/UploadTask;Landroid/os/Parcelable;)V
    :try_end_4
