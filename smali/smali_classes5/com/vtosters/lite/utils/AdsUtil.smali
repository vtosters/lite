...
# direct methods
.method public static a()Lb/h/c/b/AdsParams;
    .locals 5

    .line 89
    new-instance v0, Lb/h/c/b/AdsParams;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lb/h/c/b/AdsParams;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic a(ILjava/lang/String;Ljava/lang/String;Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;Ljava/lang/Boolean;)V
    ...
    .line 72
    new-instance p6, Lcom/vk/api/groups/GroupsJoin;

    const/4 v0, 0x0

    const/4 v1, 0x0

    invoke-direct {p6, p0, v1, v0}, Lcom/vk/api/groups/GroupsJoin;-><init>(IZLjava/lang/String;)V

    .line 73
    invoke-virtual {p6, p1}, Lcom/vk/api/groups/GroupsJoin;->d(Ljava/lang/String;)Lcom/vk/api/groups/GroupsJoin;

    .line 74
    invoke-virtual {p6, p2}, Lcom/vk/api/groups/GroupsJoin;->e(Ljava/lang/String;)Lcom/vk/api/groups/GroupsJoin;

    .line 75
    new-instance p0, Lcom/vtosters/lite/utils/AdsUtil$a;

    invoke-direct {p0, v0, p3, p4, p5}, Lcom/vtosters/lite/utils/AdsUtil$a;-><init>(Landroid/content/Context;Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;)V

    invoke-virtual {p6, p0}, Lcom/vk/api/base/ApiRequest;->a(Lcom/vk/api/base/ApiCallback;)Lcom/vk/api/base/ApiCallbackDisposable;

    move-result-object p0

    .line 76
    invoke-virtual {p0, p3}, Lcom/vk/api/base/ApiCallbackDisposable;->a(Landroid/content/Context;)Lcom/vk/api/base/ApiCallbackDisposable;
...
.method private static a(Landroid/content/Context;ILcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;)V
    ...
    invoke-virtual {v7, v8}, Lio/reactivex/Observable;->f(Lio/reactivex/functions/Consumer;)Lio/reactivex/disposables/Disposable;
...
.method public static a(Landroid/content/Context;Lcom/vk/dto/discover/ads/AdsCompact;)V
    ...
    invoke-static {p1, p0}, Lcom/vk/extensions/ActionExt;->a(Lcom/vk/dto/common/Action;Landroid/content/Context;)Z
    ...
    invoke-static {p0, v0, p1}, Lcom/vtosters/lite/utils/AdsUtil;->a(Landroid/content/Context;Ljava/lang/String;Z)V
...
.method static synthetic a(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/vtosters/lite/utils/AdsUtil;->c(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;)V
...
.method public static a(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;Ljava/lang/String;)V
    ...
    .line 62
    invoke-static {p0}, Lcom/vtosters/lite/data/Analytics;->c(Ljava/lang/String;)Lcom/vtosters/lite/data/Analytics$l;
    ...
    .line 63
    invoke-virtual {p0, p1, p3}, Lcom/vtosters/lite/data/Analytics$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vtosters/lite/data/Analytics$l;
    ...
    invoke-virtual {p0, p2, p1}, Lcom/vtosters/lite/data/Analytics$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vtosters/lite/data/Analytics$l;

    .line 65
    invoke-virtual {p0}, Lcom/vtosters/lite/data/Analytics$l;->e()Lcom/vtosters/lite/data/Analytics$l;

    goto :goto_2

    .line 66
    :cond_2
    invoke-static {p0, p1, p2}, Lcom/vtosters/lite/utils/AdsUtil;->d(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;)V
    ...
    invoke-static {p0, p3, p1, p2}, Lcom/vtosters/lite/utils/AdsUtil;->a(Landroid/content/Context;ILcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;)V
...
.method public static a(Landroid/content/Context;Lcom/vtosters/lite/attachments/PrettyCardAttachment$Card;)V
    ...
    invoke-static {p0, v0, v1, p1}, Lcom/vk/common/links/LinkUtils;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static a(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)V
    ...
    .line 21
    invoke-static {p0, p3}, Lcom/vk/common/links/LinkUtils;->b(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 22
    invoke-static {p0, p3}, Lcom/vk/common/links/LinkUtils;->c(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 23
    invoke-static {p0, p3}, Lcom/vk/common/links/LinkUtils;->d(Landroid/content/Context;Ljava/lang/String;)V

    goto :goto_0

    .line 24
    :cond_3
    invoke-static {p0, p3}, Lcom/vk/common/links/LinkUtils;->a(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 35
    invoke-static {v10}, Lcom/vtosters/lite/data/Analytics;->a(Lcom/vk/statistic/StatisticUrl;)V
    ...
    .line 36
    invoke-static {v10}, Lcom/vtosters/lite/data/Analytics;->c(Ljava/lang/String;)Lcom/vtosters/lite/data/Analytics$l;

    move-result-object v10

    .line 37
    invoke-virtual {v10, v5, p1}, Lcom/vtosters/lite/data/Analytics$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vtosters/lite/data/Analytics$l;

    .line 38
    invoke-virtual {v10, v4, v3}, Lcom/vtosters/lite/data/Analytics$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vtosters/lite/data/Analytics$l;

    .line 39
    invoke-virtual {v10}, Lcom/vtosters/lite/data/Analytics$l;->e()Lcom/vtosters/lite/data/Analytics$l;
    :try_end_0
    ...
    .line 44
    invoke-virtual {v2, v5, p1}, Lcom/vtosters/lite/data/Analytics$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vtosters/lite/data/Analytics$l;

    .line 45
    invoke-virtual {v2, v4, v3}, Lcom/vtosters/lite/data/Analytics$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vtosters/lite/data/Analytics$l;

    .line 46
    invoke-virtual {v2}, Lcom/vtosters/lite/data/Analytics$l;->e()Lcom/vtosters/lite/data/Analytics$l;
    ...
    .line 50
    invoke-virtual {v0, v5, p1}, Lcom/vtosters/lite/data/Analytics$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vtosters/lite/data/Analytics$l;
...
.method public static a(Ljava/util/List;Ljava/lang/String;Z)V
    ...
    .line 14
    invoke-static {p1}, Lcom/vtosters/lite/data/Analytics;->a(Lcom/vk/statistic/StatisticUrl;)V
...
.method public static b(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, v0}, Lcom/vtosters/lite/utils/AdsUtil;->a(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;Ljava/lang/String;)V
...
.method private static c(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vtosters/lite/data/PostInteract;)V
    ...
    .line 2
    :goto_0
    new-instance v0, Lcom/vk/common/links/LinkProcessor$b$a;

    invoke-direct {v0}, Lcom/vk/common/links/LinkProcessor$b$a;-><init>()V

    if-eqz p2, :cond_1

    .line 3
    invoke-virtual {v0, p2}, Lcom/vk/common/links/LinkProcessor$b$a;->b(Ljava/lang/String;)Lcom/vk/common/links/LinkProcessor$b$a;
    ...
    .line 5
    invoke-virtual {v0, p2}, Lcom/vk/common/links/LinkProcessor$b$a;->a(Ljava/lang/String;)Lcom/vk/common/links/LinkProcessor$b$a;
    ...
    invoke-virtual {v0}, Lcom/vk/common/links/LinkProcessor$b$a;->a()Lcom/vk/common/links/LinkProcessor$b;

    move-result-object v0

    invoke-static {p0, p2, v1, p1, v0}, Lcom/vk/common/links/LinkUtils;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Lcom/vk/common/links/LinkProcessor$b;)V
