...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/vtosters/lite/im/notifications/MsgUpdateHandler;->a:Lcom/vtosters/lite/im/notifications/InfoLoader;
    ...
    iput-object v0, p0, Lcom/vtosters/lite/im/notifications/MsgUpdateHandler;->b:Ljava/util/concurrent/ExecutorService;
...
.method private final b(Landroid/content/Context;Lcom/vk/im/engine/ImEngine;II)V
    ...
    .line 1
    iget-object v0, p0, Lcom/vtosters/lite/im/notifications/MsgUpdateHandler;->a:Lcom/vtosters/lite/im/notifications/InfoLoader;
    ...
    invoke-virtual {p2, p1, p3, v0, v2}, Lcom/vk/pushes/j/MessageNotificationHelper;->a(Landroid/content/Context;IIZ)V

    .line 6
    sget-object p2, Lcom/vk/pushes/j/BusinessNotifyNotificationHelper;->INSTANCE:Lcom/vk/pushes/j/BusinessNotifyNotificationHelper;

    invoke-virtual {v1}, Lcom/vk/im/engine/models/messages/Msg;->C1()I

    move-result p3

    invoke-virtual {p2, p1, p3, p4}, Lcom/vk/pushes/j/BusinessNotifyNotificationHelper;->a(Landroid/content/Context;II)V
    :try_end_0
    ...
    .line 12
    invoke-virtual {p2}, Lcom/vtosters/lite/im/notifications/Notify;->g()I

    move-result v3

    .line 13
    invoke-virtual {p2}, Lcom/vtosters/lite/im/notifications/Notify;->l()Ljava/lang/String;

    move-result-object v4

    .line 14
    invoke-virtual {p2}, Lcom/vtosters/lite/im/notifications/Notify;->a()Ljava/lang/String;
    ...
    .line 15
    invoke-virtual/range {v0 .. v5}, Lcom/vk/pushes/j/MessageNotificationHelper;->a(Landroid/content/Context;IILjava/lang/String;Ljava/lang/String;)V
...
.method public final declared-synchronized a()V
    ...
    .line 5
    :try_start_0
    iput-boolean v0, p0, Lcom/vtosters/lite/im/notifications/MsgUpdateHandler;->c:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(Landroid/content/Context;Lcom/vk/im/engine/ImEngine;II)V
    ...
    .line 2
    :try_start_0
    iget-boolean v0, p0, Lcom/vtosters/lite/im/notifications/MsgUpdateHandler;->c:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Lcom/vtosters/lite/im/notifications/MsgUpdateHandler;->b:Ljava/util/concurrent/ExecutorService;
