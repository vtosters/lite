...
.field private final h:Lcom/vk/im/engine/models/ImExperiments;
...
.method public constructor <init>(Lcom/vk/im/engine/models/ImExperiments;)V
    ...
    iput-object p1, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->h:Lcom/vk/im/engine/models/ImExperiments;
    ...
    iput-object p1, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->a:Ljava/util/ArrayList;

    .line 3
    new-instance p1, Lcom/vtosters/lite/im/ImAudioPlayer$a;

    invoke-direct {p1, p0}, Lcom/vtosters/lite/im/ImAudioPlayer$a;-><init>(Lcom/vtosters/lite/im/ImAudioPlayer;)V

    iput-object p1, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->b:Lcom/vtosters/lite/im/ImAudioPlayer$a;
    ...
    iput-object p1, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->c:Lcom/vk/music/player/PlayerModel;
    ...
    iput-object p1, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->d:Ljava/util/ArrayList;

    .line 6
    iget-object p1, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->d:Ljava/util/ArrayList;
...
.method public static final synthetic a(Lcom/vtosters/lite/im/ImAudioPlayer;)Lcom/vk/im/ui/media/audio/AudioTrack;
    .locals 0
...
.method private final a(Ljava/util/List;I)V
    ...
    .line 32
    iget-object v0, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->c:Lcom/vk/music/player/PlayerModel;

    sget-object v1, Lcom/vk/music/common/MusicPlaybackLaunchContext;->f0:Lcom/vk/music/common/MusicPlaybackLaunchContext;

    invoke-interface {v0, p2, p1, v1}, Lcom/vk/music/player/PlayerModel;->b(Lcom/vk/dto/music/MusicTrack;Ljava/util/List;Lcom/vk/music/common/MusicPlaybackLaunchContext;)V
...
.method private final b()Ljava/util/List;
    ...
    .line 4
    iget-object v0, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->d:Ljava/util/ArrayList;
...
.method public static final synthetic b(Lcom/vtosters/lite/im/ImAudioPlayer;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lcom/vtosters/lite/im/ImAudioPlayer;->c()V
...
.method private final c()V
    ...
    .line 2
    iget-object v1, v0, Lcom/vtosters/lite/im/ImAudioPlayer;->c:Lcom/vk/music/player/PlayerModel;

    invoke-interface {v1}, Lcom/vk/music/player/PlayerModel;->Q()Lcom/vk/music/player/PlayState;

    move-result-object v1

    .line 3
    iget-object v2, v0, Lcom/vtosters/lite/im/ImAudioPlayer;->c:Lcom/vk/music/player/PlayerModel;
    ...
    .line 5
    iget-object v4, v0, Lcom/vtosters/lite/im/ImAudioPlayer;->c:Lcom/vk/music/player/PlayerModel;

    invoke-interface {v4}, Lcom/vk/music/player/PlayerModel;->x0()Ljava/util/List;
    ...
    invoke-direct/range {v5 .. v12}, Lcom/vk/im/ui/media/audio/AudioTrack;-><init>(Lcom/vk/dto/music/MusicTrack;ZZFFILkotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 8
    invoke-virtual {v2}, Lcom/vk/music/player/TrackInfo;->c()I
    ...
    .line 11
    invoke-virtual {v2}, Lcom/vk/music/player/TrackInfo;->h()I
    ...
    .line 12
    iput-object v3, v0, Lcom/vtosters/lite/im/ImAudioPlayer;->e:Lcom/vk/im/ui/media/audio/AudioTrack;

    .line 13
    iget-object v1, v0, Lcom/vtosters/lite/im/ImAudioPlayer;->d:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v4}, Lcom/vtosters/lite/im/ImAudioPlayer;->a(Lcom/vk/dto/music/MusicTrack;)Lcom/vk/im/ui/media/audio/AudioTrack;
    ...
    .line 19
    invoke-direct/range {p0 .. p0}, Lcom/vtosters/lite/im/ImAudioPlayer;->d()V
    ...
    :cond_4
    :goto_3
    invoke-direct/range {p0 .. p0}, Lcom/vtosters/lite/im/ImAudioPlayer;->g()V
...
.method public static final synthetic c(Lcom/vtosters/lite/im/ImAudioPlayer;)V
    ...
    .line 1
    invoke-direct {p0}, Lcom/vtosters/lite/im/ImAudioPlayer;->d()V
...
.method private final d()V
    ...
    invoke-interface {v2, p0}, Lcom/vk/im/ui/media/audio/AudioPlayerListener;->a(Lcom/vk/im/ui/media/audio/AudioPlayer;)V
...
.method public a(Ljava/util/List;Lcom/vk/im/ui/media/audio/AudioTrack;)V
    ...
    .line 14
    invoke-direct {p0}, Lcom/vtosters/lite/im/ImAudioPlayer;->b()Ljava/util/List;

    move-result-object v0

    .line 15
    invoke-static {v0}, Lcom/vk/music/n/AudioPlayerUtils;->a(Ljava/util/Collection;)Ljava/util/List;
    ...
    .line 17
    iget-object v1, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->c:Lcom/vk/music/player/PlayerModel;

    invoke-interface {v1}, Lcom/vk/music/player/PlayerModel;->stop()V

    .line 18
    invoke-direct {p0}, Lcom/vtosters/lite/im/ImAudioPlayer;->g()V

    .line 19
    iget-object v1, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->h:Lcom/vk/im/engine/models/ImExperiments;

    invoke-interface {v1}, Lcom/vk/im/engine/models/ImExperiments;->f()Z
    ...
    iput-object p2, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->e:Lcom/vk/im/ui/media/audio/AudioTrack;

    .line 28
    invoke-direct {p0, v0, v3}, Lcom/vtosters/lite/im/ImAudioPlayer;->a(Ljava/util/List;I)V
    ...
    :cond_d
    :goto_8
    iget-object p1, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->c:Lcom/vk/music/player/PlayerModel;
...
.method public acquire()V
    ...
    iget-object v2, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->b:Lcom/vtosters/lite/im/ImAudioPlayer$a;

    invoke-interface {v1, v2, v0}, Lcom/vk/music/player/PlayerModel;->a(Lcom/vk/music/player/PlayerListener;Z)V
...
.method public f()V
    ...
    .line 1
    iget-object v0, p0, Lcom/vtosters/lite/im/ImAudioPlayer;->h:Lcom/vk/im/engine/models/ImExperiments;
