.class public final Lcom/vkontakte/android/utils/b;
...
.method private static a(Lcom/vkontakte/android/data/PostInteract;)Ljava/lang/String;
    .locals 2
    .param p0    # Lcom/vkontakte/android/data/PostInteract;
    ...
    .line 77
    invoke-virtual {p0}, Lcom/vkontakte/android/data/PostInteract;->t1()Ljava/lang/String;
...
.method static synthetic a(ILjava/lang/String;Ljava/lang/String;Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;Ljava/lang/Boolean;)V
    .locals 2
    .param p5    # Lcom/vkontakte/android/data/PostInteract;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    ...
    .line 75
    new-instance p0, Lcom/vkontakte/android/utils/b$a;

    invoke-direct {p0, v0, p3, p4, p5}, Lcom/vkontakte/android/utils/b$a;-><init>(Landroid/content/Context;Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;)V
...
.method private static a(Landroid/content/Context;ILcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;)V
    .locals 9
    .param p3    # Lcom/vkontakte/android/data/PostInteract;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    ...
    .line 69
    invoke-static {p3}, Lcom/vkontakte/android/utils/b;->a(Lcom/vkontakte/android/data/PostInteract;)Ljava/lang/String;
    ...
    .line 70
    invoke-virtual {p3}, Lcom/vkontakte/android/data/PostInteract;->s1()Ljava/lang/String;
    ...
    new-instance v8, Lcom/vkontakte/android/utils/a;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/vkontakte/android/utils/a;-><init>(ILjava/lang/String;Ljava/lang/String;Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;)V
...
.method public static a(Landroid/content/Context;Lcom/vk/dto/discover/ads/AdsCompact;)V
    ...
    invoke-static {p0, v0, p1}, Lcom/vkontakte/android/utils/b;->a(Landroid/content/Context;Ljava/lang/String;Z)V

    :goto_0
    return-void
.end method

.method static synthetic a(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2}, Lcom/vkontakte/android/utils/b;->c(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;)V

    return-void
.end method

.method public static a(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;Ljava/lang/String;)V
    .locals 5
    ...
    .line 62
    invoke-static {p0}, Lcom/vkontakte/android/data/n;->c(Ljava/lang/String;)Lcom/vkontakte/android/data/n$l;
    ...
    .line 63
    invoke-virtual {p0, p1, p3}, Lcom/vkontakte/android/data/n$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vkontakte/android/data/n$l;
    ...
    invoke-virtual {p0, p2, p1}, Lcom/vkontakte/android/data/n$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vkontakte/android/data/n$l;

    .line 65
    invoke-virtual {p0}, Lcom/vkontakte/android/data/n$l;->e()Lcom/vkontakte/android/data/n$l;

    goto :goto_2

    .line 66
    :cond_2
    invoke-static {p0, p1, p2}, Lcom/vkontakte/android/utils/b;->d(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;)V
    ...
    invoke-static {p0, p3, p1, p2}, Lcom/vkontakte/android/utils/b;->a(Landroid/content/Context;ILcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;)V
...
.method public static a(Landroid/content/Context;Lcom/vk/dto/newsfeed/entries/ShitAttachment;)V
    ...
    invoke-static {v0, v1, v2}, Lcom/vkontakte/android/utils/b;->a(Ljava/util/List;Ljava/lang/String;Z)V
    ...
    invoke-static {p0, v0, v1, p1}, Lcom/vkontakte/android/utils/b;->a(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)V
...
.method public static a(Landroid/content/Context;Lcom/vkontakte/android/attachments/PrettyCardAttachment$Card;)V
    ...
    .line 59
    iget-object v0, p1, Lcom/vkontakte/android/attachments/PrettyCardAttachment$Card;->d:Lcom/vk/dto/newsfeed/AwayLink;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 35
    invoke-static {v10}, Lcom/vkontakte/android/data/n;->a(Lcom/vk/statistic/StatisticUrl;)V
    ...
    .line 36
    invoke-static {v10}, Lcom/vkontakte/android/data/n;->c(Ljava/lang/String;)Lcom/vkontakte/android/data/n$l;

    move-result-object v10

    .line 37
    invoke-virtual {v10, v5, p1}, Lcom/vkontakte/android/data/n$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vkontakte/android/data/n$l;

    .line 38
    invoke-virtual {v10, v4, v3}, Lcom/vkontakte/android/data/n$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vkontakte/android/data/n$l;

    .line 39
    invoke-virtual {v10}, Lcom/vkontakte/android/data/n$l;->e()Lcom/vkontakte/android/data/n$l;
    :try_end_0
    ...
    .line 44
    invoke-virtual {v2, v5, p1}, Lcom/vkontakte/android/data/n$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vkontakte/android/data/n$l;

    .line 45
    invoke-virtual {v2, v4, v3}, Lcom/vkontakte/android/data/n$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vkontakte/android/data/n$l;
    ...
    const-class v9, Lcom/vkontakte/android/PackageAddedReceiver;
    ...
    .line 50
    invoke-virtual {v0, v5, p1}, Lcom/vkontakte/android/data/n$l;->a(Ljava/lang/String;Ljava/lang/Object;)Lcom/vkontakte/android/data/n$l;
...
.method public static a(Ljava/util/List;Ljava/lang/String;Z)V
    ...
    .line 14
    invoke-static {p1}, Lcom/vkontakte/android/data/n;->a(Lcom/vk/statistic/StatisticUrl;)V
...
.method public static b(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;)V
    .locals 1
    .param p2    # Lcom/vkontakte/android/data/PostInteract;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    .line 1
    invoke-static {p0, p1, p2, v0}, Lcom/vkontakte/android/utils/b;->a(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;Ljava/lang/String;)V

    return-void
.end method

.method private static c(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;)V
    .locals 2
    .param p2    # Lcom/vkontakte/android/data/PostInteract;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    .line 1
    invoke-virtual {p2}, Lcom/vkontakte/android/data/PostInteract;->s1()Ljava/lang/String;
...
.method private static d(Landroid/content/Context;Lcom/vk/dto/newsfeed/ButtonAction;Lcom/vkontakte/android/data/PostInteract;)V
    .locals 0
