...
.method public constructor <init>(Lcom/vk/im/engine/models/e;)V
    ...
    iput-object p1, p0, Lcom/vkontakte/android/im/bridge/g;->b:Lcom/vk/im/engine/models/e;
...
.method private final a(Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 23
    invoke-direct {p0}, Lcom/vkontakte/android/im/bridge/g;->a()Landroid/graphics/Bitmap;
    ...
    .line 24
    sget-object p1, Lcom/vk/im/ui/p/f;->a:Lcom/vk/im/ui/p/f$a;

    invoke-virtual {p1}, Lcom/vk/im/ui/p/f$a;->a()Landroid/content/ComponentName;
...
.method public a(Landroid/content/Context;I)Landroid/content/Context;
    ...
    .line 35
    sget-object v0, Lcom/vkontakte/android/utils/e;->a:Lcom/vkontakte/android/utils/e;

    invoke-virtual {v0, p1, p2}, Lcom/vkontakte/android/utils/e;->a(Landroid/content/Context;I)Landroid/content/Context;
...
.method public a(Landroid/content/Intent;Landroid/content/Context;)Landroid/content/Intent;
    ...
    invoke-direct {p0, p1}, Lcom/vkontakte/android/im/bridge/g;->a(Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 20
    :cond_0
    iget-object v0, p0, Lcom/vkontakte/android/im/bridge/g;->b:Lcom/vk/im/engine/models/e;
    ...
    new-instance p1, Lcom/vk/im/ui/fragments/d$a;

    invoke-direct {p1}, Lcom/vk/im/ui/fragments/d$a;-><init>()V

    invoke-virtual {p1, p2}, Lcom/vk/navigation/o;->b(Landroid/content/Context;)Landroid/content/Intent;
...
.method public a(Landroid/content/Intent;Landroid/content/Context;Z)Landroid/content/Intent;
    ...
    .line 3
    invoke-direct {p0, p2}, Lcom/vkontakte/android/im/bridge/g;->a(Ljava/lang/String;)Landroid/content/Intent;

    move-result-object p2

    .line 4
    sget-object p3, Lcom/vk/navigation/o;->R0:Lcom/vk/navigation/o$b;

    invoke-virtual {p3, p1}, Lcom/vk/navigation/o$b;->a(Landroid/content/Intent;)Landroid/os/Bundle;

    move-result-object p1

    .line 5
    sget-object p3, Lcom/vk/navigation/q;->Q:Ljava/lang/String;
    ...
    .line 6
    sget-object p3, Lcom/vk/navigation/q;->W:Ljava/lang/String;
    ...
    .line 7
    sget-object p3, Lcom/vk/navigation/q;->X:Ljava/lang/String;
    ...
    .line 8
    sget-object p3, Lcom/vk/navigation/q;->Y:Ljava/lang/String;
    ...
    .line 9
    sget-object p3, Lcom/vk/navigation/q;->d0:Ljava/lang/String;
    ...
    .line 10
    sget-object p3, Lcom/vk/navigation/q;->c0:Ljava/lang/String;
    ...
    .line 11
    :cond_6
    iget-object p3, p0, Lcom/vkontakte/android/im/bridge/g;->b:Lcom/vk/im/engine/models/e;

    invoke-interface {p3}, Lcom/vk/im/engine/models/e;->d()Z
    ...
    const-class p3, Lcom/vkontakte/android/InstallVKMeActivity;
...
.method public a(Landroid/content/Context;)V
    ...
    .line 15
    invoke-direct {p0, v0}, Lcom/vkontakte/android/im/bridge/g;->a(Ljava/lang/String;)Landroid/content/Intent;
