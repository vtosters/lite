.class public final Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask$b;,
        Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask$VideoCompressException;,
        Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask$a;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask$a;-><init>(Lkotlin/jvm/internal/i;)V
...
.method public constructor <init>(ILandroid/net/Uri;)V
    ...
    .line 2
    invoke-direct {p0, p2, v0}, Lcom/vkontakte/android/upload/l/j;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iput p1, p0, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask;->t:I

    return-void
.end method

.method public static final synthetic a(Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask;)Ljava/lang/String;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/vkontakte/android/upload/l/j;->f:Ljava/lang/String;
...
.method public final B()I
    ...
    .line 1
    iget v0, p0, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask;->t:I
...
.method public a(Landroid/os/Parcelable;)V
    ...
    iget-object v1, p0, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask;->s:Lorg/json/JSONObject;
...
.method public a(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    .line 7
    instance-of v0, p2, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask$VideoCompressException;
    ...
    .line 11
    invoke-super {p0, p1, p2}, Lcom/vkontakte/android/l0/e;->a(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method protected c(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask;->s:Lorg/json/JSONObject;
    :try_end_0
...
.method public p()Lcom/vk/dto/common/data/i;
    ...
    iget v4, v14, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask;->t:I
...
.method protected z()Ljava/lang/String;
    ...
    .line 14
    new-instance v1, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask$VideoCompressException;

    invoke-direct {v1, v0}, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask$VideoCompressException;-><init>(Ljava/lang/Throwable;)V

    invoke-virtual {p0, v8, v1}, Lcom/vkontakte/android/upload/tasks/cover/CoverVideoUploadTask;->a(Ljava/lang/Object;Ljava/lang/Throwable;)V

    .line 15
    invoke-virtual {p0, v7}, Lcom/vkontakte/android/upload/j;->a(Z)V
