.class public final Lcom/vkontakte/android/upload/l/p;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/upload/l/p$a;
    }
.end annotation
...
.method public constructor <init>(Ljava/lang/String;IZFFFF)V
    ...
    .line 1
    invoke-direct {p0, p1, v0, v1}, Lcom/vkontakte/android/upload/l/m;-><init>(Ljava/lang/String;Ljava/lang/String;Z)V

    iput p2, p0, Lcom/vkontakte/android/upload/l/p;->n:I

    iput-boolean p3, p0, Lcom/vkontakte/android/upload/l/p;->o:Z

    iput p4, p0, Lcom/vkontakte/android/upload/l/p;->p:F

    iput p5, p0, Lcom/vkontakte/android/upload/l/p;->q:F

    iput p6, p0, Lcom/vkontakte/android/upload/l/p;->r:F

    iput p7, p0, Lcom/vkontakte/android/upload/l/p;->s:F

    return-void
.end method

.method public static final synthetic a(Lcom/vkontakte/android/upload/l/p;)Z
    .locals 0

    .line 1
    iget-boolean p0, p0, Lcom/vkontakte/android/upload/l/p;->o:Z

    return p0
.end method

.method public static final synthetic b(Lcom/vkontakte/android/upload/l/p;)I
    .locals 0

    .line 1
    iget p0, p0, Lcom/vkontakte/android/upload/l/p;->n:I

    return p0
.end method

.method public static final synthetic c(Lcom/vkontakte/android/upload/l/p;)F
    .locals 0

    .line 1
    iget p0, p0, Lcom/vkontakte/android/upload/l/p;->s:F

    return p0
.end method

.method public static final synthetic d(Lcom/vkontakte/android/upload/l/p;)F
    .locals 0

    .line 1
    iget p0, p0, Lcom/vkontakte/android/upload/l/p;->p:F

    return p0
.end method

.method public static final synthetic e(Lcom/vkontakte/android/upload/l/p;)F
    .locals 0

    .line 1
    iget p0, p0, Lcom/vkontakte/android/upload/l/p;->r:F
...
.method private final e(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 2
    iget v1, p0, Lcom/vkontakte/android/upload/l/p;->p:F
    ...
    invoke-static {v3, v1}, Lcom/vkontakte/android/upload/k;->a(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Z

    move-result v3

    .line 5
    iget v4, p0, Lcom/vkontakte/android/upload/l/p;->p:F
    ...
    .line 6
    iget v5, p0, Lcom/vkontakte/android/upload/l/p;->q:F
    ...
    .line 7
    iget v6, p0, Lcom/vkontakte/android/upload/l/p;->r:F
    ...
    .line 8
    iget v7, p0, Lcom/vkontakte/android/upload/l/p;->s:F
...
.method public static final synthetic f(Lcom/vkontakte/android/upload/l/p;)F
    .locals 0

    .line 1
    iget p0, p0, Lcom/vkontakte/android/upload/l/p;->q:F
...
.method public bridge synthetic a(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/upload/l/p;->a(Lcom/vk/dto/photo/Photo;)V
...
.method public a(Lcom/vk/dto/photo/Photo;)V
    ...
    iget v0, p0, Lcom/vkontakte/android/upload/l/p;->n:I
    ...
    :goto_1
    iget v1, p0, Lcom/vkontakte/android/upload/l/p;->n:I
    ...
    .line 10
    iget v2, p0, Lcom/vkontakte/android/upload/l/p;->n:I
...
.method protected c(Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lcom/vkontakte/android/upload/l/p;->m:Lcom/vkontakte/android/upload/k$h;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public p()Lcom/vk/dto/common/data/i;
    ...
    invoke-direct {p0, v2}, Lcom/vkontakte/android/upload/l/p;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/vkontakte/android/upload/l/p;->e(Ljava/lang/String;)Ljava/lang/String;
...
.method public s()Z
    ...
    .line 1
    iget-boolean v0, p0, Lcom/vkontakte/android/upload/l/p;->o:Z
...
.method public bridge synthetic u()Landroid/os/Parcelable;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/vkontakte/android/upload/l/p;->u()Lcom/vk/dto/photo/Photo;
...
.method public u()Lcom/vk/dto/photo/Photo;
    ...
    .line 2
    iget-object v0, p0, Lcom/vkontakte/android/upload/l/p;->m:Lcom/vkontakte/android/upload/k$h;
    ...
    iget v3, p0, Lcom/vkontakte/android/upload/l/p;->n:I

    if-eqz v0, :cond_2

    iget-object v4, v0, Lcom/vkontakte/android/upload/k$h;->a:Ljava/lang/String;

    if-eqz v0, :cond_1

    iget-object v5, v0, Lcom/vkontakte/android/upload/k$h;->b:Ljava/lang/String;

    if-eqz v0, :cond_0

    iget-object v0, v0, Lcom/vkontakte/android/upload/k$h;->c:Ljava/lang/String;
