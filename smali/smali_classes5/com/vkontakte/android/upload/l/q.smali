.class public final Lcom/vkontakte/android/upload/l/q;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/upload/l/q$b;,
        Lcom/vkontakte/android/upload/l/q$a;
    }
.end annotation
...
.field private u:Lcom/vkontakte/android/upload/l/q$a;
...
.method public constructor <init>(Ljava/lang/String;ILcom/vk/stories/StoriesController$i;)V
    ...
    iput p2, p0, Lcom/vkontakte/android/upload/l/q;->w:I

    iput-object p3, p0, Lcom/vkontakte/android/upload/l/q;->x:Lcom/vk/stories/StoriesController$i;
    ...
    iput-object p1, p0, Lcom/vkontakte/android/upload/l/q;->s:Ljava/lang/Object;
...
.method private final C()V
    ...
    .line 1
    iget-object v0, p0, Lcom/vkontakte/android/upload/l/q;->s:Ljava/lang/Object;

    monitor-enter v0

    .line 2
    :try_start_0
    iget-object v1, p0, Lcom/vkontakte/android/upload/l/q;->s:Ljava/lang/Object;
...
.method private final D()V
    ...
    .line 2
    iget-object v2, p0, Lcom/vkontakte/android/upload/l/q;->t:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p0, Lcom/vkontakte/android/upload/l/j;->f:Ljava/lang/String;

    .line 3
    :goto_0
    iget-object v3, p0, Lcom/vkontakte/android/upload/l/q;->x:Lcom/vk/stories/StoriesController$i;
...
.method public static final synthetic a(Lcom/vkontakte/android/upload/l/q;)Lcom/vk/stories/StoriesController$i;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/vkontakte/android/upload/l/q;->x:Lcom/vk/stories/StoriesController$i;

    return-object p0
.end method

.method public static final synthetic b(Lcom/vkontakte/android/upload/l/q;)I
    .locals 0

    .line 1
    iget p0, p0, Lcom/vkontakte/android/upload/l/q;->w:I
...
.method private final c(Z)V
    ...
    .line 3
    iget-object v0, p0, Lcom/vkontakte/android/upload/l/q;->u:Lcom/vkontakte/android/upload/l/q$a;

    if-nez v0, :cond_2

    iget-object v0, p0, Lcom/vkontakte/android/upload/l/q;->t:Ljava/lang/String;
    ...
    .line 4
    invoke-virtual {p0, v0}, Lcom/vkontakte/android/upload/l/j;->b(Z)V

    .line 5
    new-instance v0, Lcom/vkontakte/android/upload/l/q$a;

    invoke-direct {v0, p0}, Lcom/vkontakte/android/upload/l/q$a;-><init>(Lcom/vkontakte/android/upload/l/q;)V

    .line 6
    iget-object v1, p0, Lcom/vkontakte/android/upload/l/q;->x:Lcom/vk/stories/StoriesController$i;
    ...
    invoke-virtual {v0, v1}, Lcom/vkontakte/android/upload/l/q$a;->a(Lcom/vk/stories/util/CameraVideoEncoder$d;)V

    .line 7
    invoke-virtual {v0}, Lcom/vkontakte/android/upload/l/q$a;->d()Lcom/vk/stories/util/CameraVideoEncoder$d;
    ...
    :goto_0
    iput-object v1, p0, Lcom/vkontakte/android/upload/l/q;->t:Ljava/lang/String;

    .line 8
    iput-object v0, p0, Lcom/vkontakte/android/upload/l/q;->u:Lcom/vkontakte/android/upload/l/q$a;
    ...
    .line 10
    invoke-direct {p0}, Lcom/vkontakte/android/upload/l/q;->C()V
...
.method public a(IIZ)V
    ...
    .line 7
    iget-object p2, p0, Lcom/vkontakte/android/upload/l/q;->u:Lcom/vkontakte/android/upload/l/q$a;

    if-eqz p2, :cond_0

    invoke-virtual {p2}, Lcom/vkontakte/android/upload/l/q$a;->c()F
    ...
    .line 10
    invoke-super {p0, p1, v0, p3}, Lcom/vkontakte/android/upload/j;->a(IIZ)V
...
.method public bridge synthetic a(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/upload/l/q;->a(Lcom/vk/dto/stories/model/StoryEntry;)V
...
.method public a(Lcom/vk/dto/stories/model/StoryEntry;)V
    ...
    .line 5
    invoke-virtual {p0}, Lcom/vkontakte/android/upload/l/j;->v()Ljava/lang/String;
...
.method protected b(J)V
    ...
    invoke-virtual {v0}, Lcom/vkontakte/android/upload/l/q$a;->e()Z
    ...
    .line 3
    iget-object p1, p0, Lcom/vkontakte/android/upload/l/q;->u:Lcom/vkontakte/android/upload/l/q$a;

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lcom/vkontakte/android/upload/l/q$a;->b()Ljava/lang/Exception;
    ...
    .line 5
    :cond_3
    invoke-super {p0, p1, p2}, Lcom/vkontakte/android/upload/l/j;->b(J)V
...
.method protected c(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/vkontakte/android/upload/l/q;->v:Ljava/lang/String;
    :try_end_0
...
.method public d(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0}, Lcom/vkontakte/android/upload/l/q$a;->a()V
...
.method public l()V
    ...
    .line 1
    invoke-super {p0}, Lcom/vkontakte/android/upload/j;->l()V

    const/4 v0, 0x1

    .line 2
    invoke-direct {p0, v0}, Lcom/vkontakte/android/upload/l/q;->c(Z)V

    .line 3
    invoke-direct {p0}, Lcom/vkontakte/android/upload/l/q;->D()V
...
.method public p()Lcom/vk/dto/common/data/i;
    ...
    .line 3
    iget-object v2, p0, Lcom/vkontakte/android/upload/l/q;->x:Lcom/vk/stories/StoriesController$i;
    ...
    iget-object v4, p0, Lcom/vkontakte/android/upload/l/q;->x:Lcom/vk/stories/StoriesController$i;
...
.method public s()Z
    ...
    .line 1
    iget-object v0, p0, Lcom/vkontakte/android/upload/l/q;->x:Lcom/vk/stories/StoriesController$i;
...
.method public bridge synthetic u()Landroid/os/Parcelable;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/vkontakte/android/upload/l/q;->u()Lcom/vk/dto/stories/model/StoryEntry;
...
.method public u()Lcom/vk/dto/stories/model/StoryEntry;
    ...
    .line 2
    iget-object v0, p0, Lcom/vkontakte/android/upload/l/q;->v:Ljava/lang/String;
