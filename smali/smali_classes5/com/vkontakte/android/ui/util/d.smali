...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/ui/util/d$e;,
        Lcom/vkontakte/android/ui/util/d$c;,
        Lcom/vkontakte/android/ui/util/d$d;
    }
.end annotation
...
# instance fields
.field final a:Lcom/vkontakte/android/ui/util/d$c;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/vkontakte/android/ui/util/d$c<",
            "+TT;>;"
...
.field final b:Lcom/vkontakte/android/ui/util/d$d;
...
.field f:Lcom/vkontakte/android/b0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field p:Lcom/vkontakte/android/ui/util/d$e;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/vkontakte/android/ui/util/d$e<",
            "TT;>;"
...
# direct methods
.method public constructor <init>(Lcom/vkontakte/android/ui/util/d$c;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    new-instance v0, Lcom/vkontakte/android/ui/util/d$d;

    invoke-direct {v0}, Lcom/vkontakte/android/ui/util/d$d;-><init>()V

    iput-object v0, p0, Lcom/vkontakte/android/ui/util/d;->b:Lcom/vkontakte/android/ui/util/d$d;
    ...
    iput-object v0, p0, Lcom/vkontakte/android/ui/util/d;->f:Lcom/vkontakte/android/b0;

    .line 8
    iput-object p1, p0, Lcom/vkontakte/android/ui/util/d;->a:Lcom/vkontakte/android/ui/util/d$c;
...
.method private f()V
    ...
    .line 1
    iget-object v0, p0, Lcom/vkontakte/android/ui/util/d;->b:Lcom/vkontakte/android/ui/util/d$d;

    new-instance v1, Lcom/vkontakte/android/ui/util/d$b;

    invoke-direct {v1, p0}, Lcom/vkontakte/android/ui/util/d$b;-><init>(Lcom/vkontakte/android/ui/util/d;)V
...
.method a(II)V
    ...
    iget-object v1, v0, Lcom/vkontakte/android/ui/util/Segmenter$Footer;->a:Lcom/vkontakte/android/ui/util/Segmenter$Footer$State;

    sget-object v2, Lcom/vkontakte/android/ui/util/Segmenter$Footer$State;->Loading:Lcom/vkontakte/android/ui/util/Segmenter$Footer$State;

    if-eq v1, v2, :cond_1

    .line 6
    iput-object v2, v0, Lcom/vkontakte/android/ui/util/Segmenter$Footer;->a:Lcom/vkontakte/android/ui/util/Segmenter$Footer$State;
    ...
    .line 9
    iget-object v0, p0, Lcom/vkontakte/android/ui/util/d;->a:Lcom/vkontakte/android/ui/util/d$c;

    iget-object v1, p0, Lcom/vkontakte/android/ui/util/d;->i:Ljava/lang/String;

    invoke-interface {v0, v1, p1, p2}, Lcom/vkontakte/android/ui/util/d$c;->a(Ljava/lang/String;II)Lcom/vk/api/base/d;

    move-result-object v0

    new-instance v1, Lcom/vkontakte/android/ui/util/d$a;

    invoke-direct {v1, p0, p1, p2}, Lcom/vkontakte/android/ui/util/d$a;-><init>(Lcom/vkontakte/android/ui/util/d;II)V
...
.method public a(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Lcom/vkontakte/android/ui/util/d;->n:Landroidx/recyclerview/widget/RecyclerView$Adapter;
...
.method public a(Ljava/lang/String;)V
    ...
    .line 27
    invoke-virtual {p0, p1, v0}, Lcom/vkontakte/android/ui/util/d;->a(Ljava/lang/String;Z)V
...
.method public a(Ljava/lang/String;Z)V
    ...
    .line 16
    iget-object v0, p0, Lcom/vkontakte/android/ui/util/d;->f:Lcom/vkontakte/android/b0;

    invoke-virtual {v0, p1}, Lcom/vkontakte/android/b0;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 23
    iget-object p1, p0, Lcom/vkontakte/android/ui/util/d;->b:Lcom/vkontakte/android/ui/util/d$d;
    ...
    .line 26
    iget-object p2, p0, Lcom/vkontakte/android/ui/util/d;->b:Lcom/vkontakte/android/ui/util/d$d;
...
.method public a(Ljava/util/List;)V
    ...
    .line 13
    iget-object p1, p0, Lcom/vkontakte/android/ui/util/d;->f:Lcom/vkontakte/android/b0;

    iget-object v0, p0, Lcom/vkontakte/android/ui/util/d;->e:Ljava/util/List;

    invoke-virtual {p1, v0}, Lcom/vkontakte/android/b0;->a(Ljava/util/List;)V
...
.method public d()V
    ...
    .line 7
    invoke-virtual {v0}, Lcom/vkontakte/android/b0;->a()V
...
.method public e()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lcom/vkontakte/android/ui/util/d;->i:Ljava/lang/String;
...
.method public getItem(I)Ljava/lang/Object;
    ...
    .line 3
    invoke-virtual {p0, v1}, Lcom/vkontakte/android/ui/util/d;->d(I)Ljava/lang/CharSequence;
