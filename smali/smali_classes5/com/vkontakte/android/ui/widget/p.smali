.class public Lcom/vkontakte/android/ui/widget/p;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/vkontakte/android/ui/widget/o;",
        ">;"
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lcom/vkontakte/android/ui/widget/p;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, v0}, Lcom/vkontakte/android/ui/widget/p;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lcom/vkontakte/android/ui/widget/p;->d:Landroid/view/View;

    .line 6
    iget-object p1, p0, Lcom/vkontakte/android/ui/widget/p;->d:Landroid/view/View;
    ...
    iput-object p1, p0, Lcom/vkontakte/android/ui/widget/p;->e:Landroid/widget/TextView;
    ...
    iput-object p1, p0, Lcom/vkontakte/android/ui/widget/p;->f:Lcom/vk/imageloader/view/VKImageView;
...
.method private a(Ljava/util/List;Lcom/vk/api/widget/WidgetBranding;)V
    ...
    .line 12
    iget-object v6, p0, Lcom/vkontakte/android/ui/widget/k;->c:Ljava/util/List;

    invoke-interface {v6, v1}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lcom/vkontakte/android/ui/widget/o;

    .line 13
    invoke-virtual {v6, v5}, Lcom/vkontakte/android/ui/widget/o;->a(Lcom/vk/dto/newsfeed/entries/widget/Match;)V

    .line 14
    invoke-virtual {v6}, Lcom/vkontakte/android/ui/widget/o;->a()I
    ...
    check-cast v1, Lcom/vkontakte/android/ui/widget/o;
    ...
    :cond_2
    :goto_2
    invoke-virtual {v1, v5, v2, v3, v4}, Lcom/vkontakte/android/ui/widget/o;->a(ZZZI)V
    ...
    .line 21
    iget-object p2, p0, Lcom/vkontakte/android/ui/widget/p;->d:Landroid/view/View;
    ...
    .line 23
    iget-object v1, p0, Lcom/vkontakte/android/ui/widget/p;->d:Landroid/view/View;

    invoke-virtual {v1, v0}, Landroid/view/View;->setVisibility(I)V

    .line 24
    iget-object v1, p0, Lcom/vkontakte/android/ui/widget/p;->e:Landroid/widget/TextView;
    ...
    .line 26
    iget-object p2, p0, Lcom/vkontakte/android/ui/widget/p;->f:Lcom/vk/imageloader/view/VKImageView;
    ...
    .line 27
    :cond_5
    iget-object p1, p0, Lcom/vkontakte/android/ui/widget/p;->f:Lcom/vk/imageloader/view/VKImageView;
    ...
    iget-object v0, p0, Lcom/vkontakte/android/ui/widget/p;->f:Lcom/vk/imageloader/view/VKImageView;
...
.method protected bridge synthetic a(Landroid/content/Context;)Landroid/view/View;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/ui/widget/p;->a(Landroid/content/Context;)Lcom/vkontakte/android/ui/widget/o;
...
.method protected a(Landroid/content/Context;)Lcom/vkontakte/android/ui/widget/o;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    .line 2
    new-instance v0, Lcom/vkontakte/android/ui/widget/o;

    invoke-direct {v0, p1}, Lcom/vkontakte/android/ui/widget/o;-><init>(Landroid/content/Context;)V
...
.method public a(Lcom/vk/dto/newsfeed/entries/widget/Widget;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/vkontakte/android/ui/widget/p;->a(Ljava/util/List;Lcom/vk/api/widget/WidgetBranding;)V
