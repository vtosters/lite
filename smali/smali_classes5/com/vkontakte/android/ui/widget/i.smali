.class public Lcom/vkontakte/android/ui/widget/i;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/vkontakte/android/ui/widget/h;",
        ">;"
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lcom/vkontakte/android/ui/widget/i;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, v0}, Lcom/vkontakte/android/ui/widget/i;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private a(Ljava/util/List;)V
    ...
    check-cast v2, Lcom/vkontakte/android/ui/widget/h;
    ...
    :goto_1
    invoke-virtual {v2, v3, v4}, Lcom/vkontakte/android/ui/widget/h;->a(Lcom/vk/dto/newsfeed/entries/widget/WidgetCoverList$Item;Z)V
...
.method protected bridge synthetic a(Landroid/content/Context;)Landroid/view/View;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/ui/widget/i;->a(Landroid/content/Context;)Lcom/vkontakte/android/ui/widget/h;
...
.method protected a(Landroid/content/Context;)Lcom/vkontakte/android/ui/widget/h;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    .line 2
    new-instance v0, Lcom/vkontakte/android/ui/widget/h;

    invoke-direct {v0, p1}, Lcom/vkontakte/android/ui/widget/h;-><init>(Landroid/content/Context;)V
...
.method public a(Lcom/vk/dto/newsfeed/entries/widget/Widget;)V
    ...
    invoke-direct {p0, p1}, Lcom/vkontakte/android/ui/widget/i;->a(Ljava/util/List;)V
