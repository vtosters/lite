.class public Lcom/vkontakte/android/ui/widget/t;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/vkontakte/android/ui/widget/s;",
        ">;"
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lcom/vkontakte/android/ui/widget/t;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, v0}, Lcom/vkontakte/android/ui/widget/t;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v0, Lcom/vkontakte/android/ui/widget/s;->f:I
    ...
    iput-object v0, p0, Lcom/vkontakte/android/ui/widget/t;->d:Landroid/widget/LinearLayout;

    .line 7
    iget-object v0, p0, Lcom/vkontakte/android/ui/widget/t;->d:Landroid/widget/LinearLayout;
    ...
    .line 12
    iget-object p1, p0, Lcom/vkontakte/android/ui/widget/t;->d:Landroid/widget/LinearLayout;
...
.method private a(Ljava/util/List;)V
    ...
    check-cast v1, Lcom/vkontakte/android/ui/widget/s;
    ...
    invoke-virtual {v1, v2}, Lcom/vkontakte/android/ui/widget/s;->a(Lcom/vk/dto/newsfeed/entries/widget/WidgetTiles$Item;)V
...
.method protected bridge synthetic a(Landroid/content/Context;)Landroid/view/View;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/vkontakte/android/ui/widget/t;->a(Landroid/content/Context;)Lcom/vkontakte/android/ui/widget/s;
...
.method protected a(Landroid/content/Context;)Lcom/vkontakte/android/ui/widget/s;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    .line 2
    new-instance v0, Lcom/vkontakte/android/ui/widget/s;

    invoke-direct {v0, p1}, Lcom/vkontakte/android/ui/widget/s;-><init>(Landroid/content/Context;)V
...
.method public a(Lcom/vk/dto/newsfeed/entries/widget/Widget;)V
    ...
    invoke-direct {p0, p1}, Lcom/vkontakte/android/ui/widget/t;->a(Ljava/util/List;)V
